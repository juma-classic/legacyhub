(self.webpackChunkderiv_charts = self.webpackChunkderiv_charts || []).push([
    [96], {
        358: function(e, t, n) {
            var r = n(692),
                i = function() {
            ...
            function o(e, t) {
                ...
                e = r, t = function() {
                    var e = function() {
                        ...
                        return i(e, null, [{
                            ...
                            value: function(e) {
                                var t, n, r, i;
                                for (i in t = e[0], n = this.transitions)
                                    if (r = n[i], null != t.style[i]) return r
                            }
                        }]), e
                    }();
                    ...
                    var n = function() {
                        function n() {
                            ...
                            o(this, n), this.render = this.render.bind(this), this.bind = this.bind.bind(this), this.unbind = this.unbind.bind(this), this.mouseEnter = this.mouseEnter.bind(this), this.mouseLeave = this.mouseLeave.bind(this), this.click = this.click.bind(this), this.close = this.close.bind(this), this.cycle = this.cycle.bind(this), this.waitAndDismiss = this.waitAndDismiss.bind(this), this.present = this.present.bind(this), this.dismiss = this.dismiss.bind(this), this.remove = this.remove.bind(this), this.animate = this.animate.bind(this), this.$growls = this.$growls.bind(this), this.$growl = this.$growl.bind(this), this.html = this.html.bind(this), this.content = this.content.bind(this), this.container = this.container.bind(this), this.settings = e.extend({}, n.settings, t), this.initialize(this.settings.location), this.render()
                        }
                        return i(n, null, [{
                            key: "growl",
                            value: function() {
                            ...
                            value: function(t) {
                                var n;
                                return e("body:not(:has(#" + (n = "growls-" + t) + "))").append('<div id="' + n + '" />')
                            }
                        }, {
                            key: "render",
                            value: function() {
                                var e;
                                e = this.$growl(), this.$growls(this.settings.location).append(e), this.settings.fixed ? this.present() : this.cycle()
                            }
                        }, {
                            key: "bind",
                            value: function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.$growl();
                                return e.on("click", this.click), this.settings.delayOnHover && (e.on("mouseenter", this.mouseEnter), e.on("mouseleave", this.mouseLeave)), e.on("contextmenu", this.close).find("." + this.settings.namespace + "-close").on("click", this.close)
                            }
                        }, {
                            key: "unbind",
                            value: function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.$growl();
                                return e.off("click", this.click), this.settings.delayOnHover && (e.off("mouseenter", this.mouseEnter), e.off("mouseleave", this.mouseLeave)), e.off("contextmenu", this.close).find("." + this.settings.namespace + "-close").off("click", this.close)
                            }
                        }, {
                            key: "mouseEnter",
                            value: function(e) {
                            ...
                            key: "click",
                            value: function(e) {
                                if (null != this.settings.url) return e.preventDefault(), e.stopPropagation(), window.open(this.settings.url)
                            }
                        }, {
                            key: "close",
                            value: function(e) {
                                return e.preventDefault(), e.stopPropagation(), this.$growl().stop().queue(this.dismiss).queue(this.remove)
                            }
                        }, {
                            key: "cycle",
                            value: function() {
                            ...
                            value: function(e) {
                                var t;
                                return t = this.$growl(), this.bind(t), this.animate(t, this.settings.namespace + "-incoming", "out", e)
                            }
                        }, {
                            key: "dismiss",
                            value: function(e) {
                                var t;
                                return t = this.$growl(), this.unbind(t), this.animate(t, this.settings.namespace + "-outgoing", "in", e)
                            }
                        }, {
                            key: "remove",
                            value: function(e) {
                                return this.$growl().remove(), "function" == typeof e ? e() : void 0
                            }
                        }, {
                            key: "animate",
                            value: function(e, n) {
                                var r, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "in",
                                    o = arguments[3];
                                r = t.transition(e), e["in" === i ? "removeClass" : "addClass"](n), e.offset().position, e["in" === i ? "addClass" : "removeClass"](n), null != o && (null != r ? e.one(r, o) : o())
                            }
                        }, {
                            key: "$growls",
                            value: function(t) {
                                var n;
                                return null == this.$_growls && (this.$_growls = []), null != (n = this.$_growls)[t] ? n[t] : n[t] = e("#growls-" + t)
                            }
                        }, {
                            key: "$growl",
                            value: function() {
                                return null != this.$_growl ? this.$_growl : this.$_growl = e(this.html())
                            }
                        }, {
                            key: "html",
                            value: function() {
                ...
                }(), this.Growl = n, e.growl = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return n.growl(e)
                }, e.growl.error = function() {
                    var t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return t = {
                        title: "Error!",
                        style: "error"
                    }, e.growl(e.extend(t, n))
                }, e.growl.notice = function() {
                    var t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return t = {
                        title: "Notice!",
                        style: "notice"
                    }, e.growl(e.extend(t, n))
                }, e.growl.warning = function() {
                    var t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return t = {
                        title: "Warning!",
                        style: "warning"
        ...
        415: (e, t, n) => {
            ...
            ! function() {
                ...
                if ("function" != typeof t.parse || "function" != typeof t.stringify) throw new Error("No JSON support found, include //cdnjs.cloudflare.com/ajax/libs/json2/20110223/json2.js to page");
                var n, i = {
                        __jstorage_meta: {
                            CRC32: {}
                        }
                ...
                function g() {
                    ...
                    if ("userDataBehavior" == u) {
                        a.load("jStorage");
                        try {
                            e = a.getAttribute("jStorage")
                        } catch (e) {}
                        try {
                            f = a.getAttribute("jStorage_update")
                        } catch (e) {}
                        o.jStorage = e
                    }
                    b(), T(), S()
                ...
                function v() {
                    ...
                    clearTimeout(c), c = setTimeout((function() {
                        if ("localStorage" == u || "globalStorage" == u) e = o.jStorage_update;
                        else if ("userDataBehavior" == u) {
                            a.load("jStorage");
                            try {
                                e = a.getAttribute("jStorage_update")
                            } catch (e) {}
                        }
                        e && e != f && (f = e, function() {
                            var e, n = t.parse(t.stringify(i.__jstorage_meta.CRC32));
                            g(), e = t.parse(t.stringify(i.__jstorage_meta.CRC32));
                            var r, o = [],
                                a = [];
                            for (r in n)
                                if (n.hasOwnProperty(r)) {
                                    ...
                                    n[r] != e[r] && "2." == String(n[r]).substr(0, 2) && o.push(r)
                                }
                            for (r in e) e.hasOwnProperty(r) && (n[r] || o.push(r));
                            m(o, "updated"), m(a, "deleted")
                        }())
                    }), 25)
                }
                ...
                function m(e, t) {
                    ...
                    if (e = [].concat(e || []), "flushed" == t) {
                        for (var a in e = [], l) l.hasOwnProperty(a) && e.push(a);
                        t = "deleted"
                    }
                    for (n = 0, i = e.length; n < i; n++) {
                        if (l[e[n]])
                            for (r = 0, o = l[e[n]].length; r < o; r++) l[e[n]][r](e[n], t);
                        if (l["*"])
                            for (r = 0, o = l["*"].length; r < o; r++) l["*"][r](e[n], t)
                    }
                }

                function y() {
                    var e = (+new Date).toString();
                    if ("localStorage" == u || "globalStorage" == u) try {
                        o.jStorage_update = e
                    } catch (e) {
                        u = !1
                    } else "userDataBehavior" == u && (a.setAttribute("jStorage_update", e), a.save("jStorage"));
                    v()
                }

                function b() {
                    if (o.jStorage) try {
                        i = t.parse(String(o.jStorage))
                    } catch (e) {
                        o.jStorage = "{}"
                    } else o.jStorage = "{}";
                    s = o.jStorage ? String(o.jStorage).length : 0, i.__jstorage_meta || (i.__jstorage_meta = {}), i.__jstorage_meta.CRC32 || (i.__jstorage_meta.CRC32 = {})
                }

                function x() {
                    ! function() {
                        if (!i.__jstorage_meta.PubSub) return;
                        for (var e = +new Date - 2e3, t = 0, n = i.__jstorage_meta.PubSub.length; t < n; t++)
                            if (i.__jstorage_meta.PubSub[t][0] <= e) {
                                i.__jstorage_meta.PubSub.splice(t, i.__jstorage_meta.PubSub.length - t);
                                break
                            }
                        i.__jstorage_meta.PubSub.length || delete i.__jstorage_meta.PubSub
                    }();
                    try {
                        o.jStorage = t.stringify(i), a && (a.setAttribute("jStorage", o.jStorage), a.save("jStorage")), s = o.jStorage ? String(o.jStorage).length : 0
                    } catch (e) {}
                }
                ...
                function T() {
                    var e, t, r, o, a = 1 / 0,
                        s = !1,
                        u = [];
                    if (clearTimeout(n), i.__jstorage_meta && "object" == typeof i.__jstorage_meta.TTL) {
                        for (t in e = +new Date, r = i.__jstorage_meta.TTL, o = i.__jstorage_meta.CRC32, r) r.hasOwnProperty(t) && (r[t] <= e ? (delete r[t], delete o[t], delete i[t], s = !0, u.push(t)) : r[t] < a && (a = r[t]));
                        a != 1 / 0 && (n = setTimeout(T, Math.min(a - e, 2147483647))), s && (x(), y(), m(u, "deleted"))
                    }
                }

                function S() {
                    var e;
                    if (i.__jstorage_meta.PubSub) {
                        var t, n = p,
                            r = [];
                        for (e = i.__jstorage_meta.PubSub.length - 1; e >= 0; e--)(t = i.__jstorage_meta.PubSub[e])[0] > p && (n = t[0], r.unshift(t));
                        for (e = r.length - 1; e >= 0; e--) j(r[e][1], r[e][2]);
                        p = n
                    }
                }
                ...
                function j(e, n) {
                    if (d[e])
                        for (var r = 0, i = d[e].length; r < i; r++) try {
                            d[e][r](e, t.parse(t.stringify(n)))
                        } catch (e) {}
                }
                e.jStorage = {
                        version: "0.4.12",
                        set: function(e, n, r) {
                            if (w(e), r = r || {}, void 0 === n) return this.deleteKey(e), n;
                            if (h.isXML(n)) n = {
                                _is_xml: !0,
                                xml: h.encode(n)
                            };
                                ...
                                n && "object" == typeof n && (n = t.parse(t.stringify(n)))
                            }
                            return i[e] = n, i.__jstorage_meta.CRC32[e] = "2." + function(e, t) {
                            ...
                            }(t.stringify(n), 2538058380), this.setTTL(e, r.TTL || 0), m(e, "updated"), n
                        },
                        get: function(e, t) {
                            return w(e), e in i ? i[e] && "object" == typeof i[e] && i[e]._is_xml ? h.decode(i[e].xml) : i[e] : void 0 === t ? null : t
                        },
                        deleteKey: function(e) {
                            return w(e), e in i && (delete i[e], "object" == typeof i.__jstorage_meta.TTL && e in i.__jstorage_meta.TTL && delete i.__jstorage_meta.TTL[e], delete i.__jstorage_meta.CRC32[e], x(), y(), m(e, "deleted"), !0)
                        },
                        setTTL: function(e, t) {
                            var n = +new Date;
                            return w(e), t = Number(t) || 0, e in i && (i.__jstorage_meta.TTL || (i.__jstorage_meta.TTL = {}), t > 0 ? i.__jstorage_meta.TTL[e] = n + t : delete i.__jstorage_meta.TTL[e], x(), T(), y(), !0)
                        },
                        getTTL: function(e) {
                            var t = +new Date;
                            return w(e), e in i && i.__jstorage_meta.TTL && i.__jstorage_meta.TTL[e] && i.__jstorage_meta.TTL[e] - t || 0
                        },
                        flush: function() {
                            return i = {
                                __jstorage_meta: {
                        ...
                        index: function() {
                            var e, t = [];
                            for (e in i) i.hasOwnProperty(e) && "__jstorage_meta" != e && t.push(e);
                            return t
                        },
                        ...
                        listenKeyChange: function(e, t) {
                            w(e), l[e] || (l[e] = []), l[e].push(t)
                        },
                        stopListening: function(e, t) {
                            if (w(e), l[e])
                                if (t)
                                    for (var n = l[e].length - 1; n >= 0; n--) l[e][n] == t && l[e].splice(n, 1);
                                else delete l[e]
                        },
                        ...
                        publish: function(e, t) {
                            if (!(e = (e || "").toString())) throw new TypeError("Channel not defined");
                            ! function(e, t) {
                                i.__jstorage_meta || (i.__jstorage_meta = {}), i.__jstorage_meta.PubSub || (i.__jstorage_meta.PubSub = []), i.__jstorage_meta.PubSub.unshift([+new Date, e, t]), x(), y()
                            }(e, t)
                        },
                        reInit: function() {
                            g()
                    ...
                    function() {
                        ...
                        if (e) try {
                            window.localStorage && (o = window.localStorage, u = "localStorage", f = o.jStorage_update)
                        } catch (e) {} else if ("globalStorage" in window) try {
                            window.globalStorage && (o = "localhost" == window.location.hostname ? window.globalStorage["localhost.localdomain"] : window.globalStorage[window.location.hostname], u = "globalStorage", f = o.jStorage_update)
                        } catch (e) {} else {
                            if (!(a = document.createElement("link")).addBehavior) return void(a = null);
                            a.style.behavior = "url(#default#userData)", document.getElementsByTagName("head")[0].appendChild(a);
                            try {
                                a.load("jStorage")
                            } catch (e) {
                                a.setAttribute("jStorage", "{}"), a.save("jStorage"), a.load("jStorage")
                            }
                            var t = "{}";
                            try {
                                t = a.getAttribute("jStorage")
                            } catch (e) {}
                            try {
                                f = a.getAttribute("jStorage_update")
                            } catch (e) {}
                            o.jStorage = t, u = "userDataBehavior"
                        }
                        b(), T(), "localStorage" == u || "globalStorage" == u ? "addEventListener" in window ? window.addEventListener("storage", v, !1) : document.attachEvent("onstorage", v) : "userDataBehavior" == u && setInterval(v, 1e3), S(), "addEventListener" in window && window.addEventListener("pageshow", (function(e) {
                            e.persisted && v()
                        }), !1)
                    }()
            }()
        ...
        692: function(e, t) {
            ...
            ! function(t, n) {
                ...
                ! function() {
                    ...
                    function Z(e, t, n, r) {
                        ...
                        if (!r && (ue(t), t = t || u, f)) {
                            ...
                            if (!(S[e + " "] || d && d.test(e))) {
                                if (p = e, h = t, 1 === y && (W.test(e) || I.test(e))) {
                                    for ((h = V.test(e) && se(t.parentNode) || t) == t && v.scope || ((s = t.getAttribute("id")) ? s = C.escapeSelector(s) : t.setAttribute("id", s = m)), o = (c = ce(e)).length; o--;) c[o] = (s ? "#" + s : ":scope") + " " + fe(c[o]);
                                    p = c.join(",")
                                }
                                try {
                    ...
                    function ue(e) {
                        ...
                        return r != u && 9 === r.nodeType && r.documentElement ? (l = (u = r).documentElement, f = !C.isXMLDoc(u), h = l.matches || l.webkitMatchesSelector || l.msMatchesSelector, l.msMatchesSelector && P != u && (n = u.defaultView) && n.top !== n && n.addEventListener("unload", K), v.getById = ne((function(e) {
                    ...
                    for (e in Z.matches = function(e, t) {
                            ...
                            var t, n = [],
                                r = 0,
                                o = 0;
                            if (a = !v.sortStable, i = !v.sortStable && s.call(e, 0), A.call(e, j), a) {
                            ...
                            preFilter: {
                                ...
                                PSEUDO: function(e) {
                                    var t, n = !e[6] && e[2];
                                    return z.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && F.test(n) && (t = ce(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                                }
                            },
                            filter: {
                                TAG: function(e) {
                                    ...
                                    return 1 === r && 0 === i ? function(e) {
                                        ...
                                        if (g) {
                                            ...
                                            if (p = [a ? g.firstChild : g.lastChild], a && b) {
                                                for (x = (d = (l = (c = g[m] || (g[m] = {}))[e] || [])[0] === y && l[1]) && l[2], f = d && g.childNodes[d]; f = ++d && f && f[h] || (x = d = 0) || p.pop();)
                                                    if (1 === f.nodeType && ++x && f === t) {
                                                        c[e] = [y, d, x];
                                                        break
                                                    }
                                            } else if (b && (x = d = (l = (c = t[m] || (t[m] = {}))[e] || [])[0] === y && l[1]), !1 === x)
                                                for (;
                                                    (f = ++d && f && f[h] || (x = d = 0) || p.pop()) && (!(s ? E(f, v) : 1 === f.nodeType) || !++x || (b && ((c = f[m] || (f[m] = {}))[e] = [y, x]), f !== t)););
                    ...
                    function ce(e, n) {
                        ...
                        for (s = e, u = [], l = t.preFilter; s;) {
                            for (a in r && !(i = $.exec(s)) || (i && (s = s.slice(i[0].length) || s), u.push(o = [])), r = !1, (i = I.exec(s)) && (r = i.shift(), o.push({
                                    value: r,
                                    type: i[0].replace(L, " ")
                    ...
                    function ge(e, t, n, r, i, o) {
                        return r && !r[m] && (r = ge(r)), i && !i[m] && (i = ge(i, o)), te((function(o, a, s, u) {
                            var l, f, d, p, h = [],
                                v = [],
                                m = a.length,
                                y = o || function(e, t, n) {
                            ...
                            if (n ? n(b, p = i || (o ? e : m || r) ? [] : a, s, u) : p = b, r)
                            ...
                            } else p = he(p === a ? p.splice(m, p.length) : p), i ? i(null, a, p, u) : g.apply(a, p)
                        }))
                    }
                        ...
                        for (var r, i, o, a = e.length, s = t.relative[e[0].type], u = s || t.relative[" "], l = s ? 1 : 0, f = de((function(e) {
                            ...
                            if (i = t.relative[e[l].type]) p = [de(pe(p), i)];
                                ...
                                if ((i = t.filter[e[l].type].apply(null, e[l].matches))[m]) {
                                    ...
                                    return ge(l > 1 && pe(p), l > 1 && fe(e.slice(0, l - 1).concat({
                                        value: " " === e[l - 2].type ? "*" : ""
                    ...
                    function me(e, r) {
                        var i, o = [],
                            ...
                            s = T[e + " "];
                        if (!s) {
                            for (r || (r = ce(e)), i = r.length; i--;)(s = ve(r[i]))[m] ? o.push(s) : a.push(s);
                            s = T(e, function(e, r) {
                                var i = r.length > 0,
                                    o = e.length > 0,
                                    a = function(a, s, l, c, d) {
                                        var p, h, v, m = 0,
                                            ...
                                            T = n,
                                            S = a || o && t.find.TAG("*", d),
                                            j = y += null == T ? 1 : Math.random() || .1,
                                            k = S.length;
                                        for (d && (n = s == u || s || d); b !== k && null != (p = S[b]); b++) {
                                            if (o && p) {
                                        ...
                                        if (m += b, i && b !== m) {
                                            ...
                                            g.apply(c, w), d && !a && w.length > 0 && m + r.length > 1 && C.uniqueSort(c)
                                        }
                                        return d && (y = j, n = T), x
                                    };
                                return i ? te(a) : a
                    ...
                    function ye(e, n, r, i) {
                        ...
                        if (r = r || [], 1 === d.length) {
                            if ((a = d[0] = d[0].slice(0)).length > 2 && "ID" === (s = a[0]).type && 9 === n.nodeType && f && t.relative[a[1].type]) {
                                if (!(n = (t.find.ID(s.matches[0].replace(G, Y), n) || [])[0])) return r;
                                c && (n = n.parentNode), e = e.slice(a.shift().value.length)
                            }
                            for (o = z.needsContext.test(e) ? 0 : a.length; o-- && (s = a[o], !t.relative[u = s.type]);)
                                if ((l = t.find[u]) && (i = l(s.matches[0].replace(G, Y), V.test(a[0].type) && se(n.parentNode) || n))) {
                                    if (a.splice(o, 1), !(e = i.length && fe(a))) return g.apply(r, i), r;
                                    break
                                }
                        }
                        return (c || me(e, d))(i, n, !f, r, !n || V.test(e) && se(n.parentNode) || n), r
                    }
                    le.prototype = t.filters = t.pseudos, t.setFilters = new le, v.sortStable = m.split("").sort(j).join("") === m, ue(), v.sortDetached = ne((function(e) {
                        return 1 & e.compareDocumentPosition(u.createElement("fieldset"))
                    })), C.find = Z, C.expr[":"] = C.expr.pseudos, C.unique = C.uniqueSort, Z.compile = me, Z.select = ye, Z.setDocument = ue, Z.tokenize = ce, Z.escape = C.escapeSelector, Z.getText = C.text, Z.isXML = C.isXMLDoc, Z.selectors = C.expr, Z.support = C.support, Z.uniqueSort = C.uniqueSort
                }();
                ...
                C.filter = function(e, t, n) {
                    ...
                    is: function(e) {
                        return !!W(this, "string" == typeof e && $.test(e) ? C(e) : e || [], !1).length
                    }
                });
                var F, B = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                (C.fn.init = function(e, t, n) {
                    ...
                    if (n = n || F, "string" == typeof e) {
                        ...
                        if (r[1]) {
                            if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : b, !0)), I.test(r[1]) && C.isPlainObject(t))
                ...
                C.fn.extend({
                    ...
                    C.fn[e] = function(n, r) {
                        ...
                        return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = C.filter(r, i)), this.length > 1 && (X[e] || C.uniqueSort(i), z.test(e) && i.reverse()), this.pushStack(i)
                    }
                }));
                var J = /[^\x20\t\r\n\f]+/g;
                                            ...
                                            var s = this,
                                                ...
                                                l = function() {
                                                    ...
                                                    if (!(e < o)) {
                                                        ...
                                                        l = r && ("object" == typeof r || "function" == typeof r) && r.then, m(l) ? i ? l.call(r, a(o, t, V, i), a(o, t, G, i)) : (o++, l.call(r, a(o, t, V, i), a(o, t, G, i), a(o, t, V, t.notifyWith))) : (n !== V && (s = void 0, u = [r]), (i || t.resolveWith)(s, u))
                                                    }
                                                },
                                                c = i ? l : function() {
                                                    try {
                                                        ...
                                                        C.Deferred.exceptionHook && C.Deferred.exceptionHook(r, c.error), e + 1 >= o && (n !== G && (s = void 0, u = [r]), t.rejectWith(s, u))
                                                    }
                                                };
                ...
                function be(e, t, n, r) {
                    var i, o, a = 20,
                        ...
                        c = e.nodeType && (C.cssNumber[t] || "px" !== l && +u) && pe.exec(C.css(e, t));
                    if (c && c[3] !== l) {
                ...
                function we(e) {
                    var t, n = e.ownerDocument,
                        r = e.nodeName,
                        i = xe[r];
                    return i || (t = n.body.appendChild(n.createElement(r)), i = C.css(t, "display"), t.parentNode.removeChild(t), "none" === i && (i = "block"), xe[r] = i, i)
                }
                ...
                var Se, je, Ce = /^(?:checkbox|radio)$/i,
                    ke = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
                    Ee = /^$|^module$|\/(?:java|ecma)script/i;
                Se = b.createDocumentFragment().appendChild(b.createElement("div")), (je = b.createElement("input")).setAttribute("type", "radio"), je.setAttribute("checked", "checked"), je.setAttribute("name", "t"), Se.appendChild(je), v.checkClone = Se.cloneNode(!0).cloneNode(!0).lastChild.checked, Se.innerHTML = "<textarea>x</textarea>", v.noCloneChecked = !!Se.cloneNode(!0).lastChild.defaultValue, Se.innerHTML = "<option></option>", v.option = !!Se.lastChild;
                var _e = {
                    thead: [1, "<table>", "</table>"],
                ...
                function Le(e, t, n, r, i) {
                    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
                        ...
                        for (a = a || f.appendChild(t.createElement("div")), s = (ke.exec(o) || ["", ""])[1].toLowerCase(), u = _e[s] || _e._default, a.innerHTML = u[1] + C.htmlPrefilter(o) + u[2], c = u[0]; c--;) a = a.lastChild;
                        C.merge(d, a.childNodes), (a = f.firstChild).textContent = ""
                    } else d.push(t.createTextNode(o));
                    for (f.textContent = "", p = 0; o = d[p++];)
                        if (r && C.inArray(o, r) > -1) i && i.push(o);
                        else if (l = ve(o), a = Ae(f.appendChild(o), "script"), l && De(a), n)
                ...
                function Me(e, t, n) {
                    n ? (se.set(e, t, !1), C.event.add(e, t, {
                        ...
                        handler: function(e) {
                            ...
                            } else r && (se.set(this, t, C.event.trigger(r[0], r.slice(1), this)), e.stopPropagation(), e.isImmediatePropagationStopped = qe)
                        }
                ...
                C.event = {
                    ...
                    add: function(e, t, n, r, i) {
                        var o, a, s, u, l, c, f, d, p, h, g, v = se.get(e);
                        if (oe(e))
                            for (n.handler && (n = (o = n).handler, i = o.selector), i && C.find.matchesSelector(ge, i), n.guid || (n.guid = C.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function(t) {
                                    return void 0 !== C && C.event.triggered !== t.type ? C.event.dispatch.apply(e, arguments) : void 0
                                }), l = (t = (t || "").match(J) || [""]).length; l--;) p = g = (s = Oe.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = C.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = C.event.special[p] || {}, c = C.extend({
                                type: p,
                                origType: g,
                                data: r,
                                handler: n,
                    ...
                    remove: function(e, t, n, r, i) {
                        var o, a, s, u, l, c, f, d, p, h, g, v = se.hasData(e) && se.get(e);
                        if (v && (u = v.events)) {
                    ...
                    special: {
                        ...
                        click: {
                            ...
                            _default: function(e) {
                                var t = e.target;
                                return Ce.test(t.type) && t.click && E(t, "input") && se.get(t, "click") || E(t, "a")
                            }
                        },
                        beforeunload: {
                    ...
                    e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? qe : Pe, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && C.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[C.expando] = !0
                }, C.Event.prototype = {
                    constructor: C.Event,
                ...
                function ze(e, t) {
                    ...
                    if (1 === t.nodeType) {
                        ...
                        ue.hasData(e) && (o = ue.access(e), a = C.extend({}, o), ue.set(t, a))
                    }
                }
                ...
                function Ue(e, t, n, r) {
                    ...
                    var i, o, a, s, l, c, f = 0,
                        ...
                        h = t[0],
                        g = m(h);
                    if (g || d > 1 && "string" == typeof h && !v.checkClone && $e.test(h)) return e.each((function(i) {
                        var o = e.eq(i);
                        g && (t[0] = h.call(this, i, o.html())), Ue(o, t, n, r)
                    }));
                    if (d && (o = (i = Le(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                        for (s = (a = C.map(Ae(i, "script"), Fe)).length; f < d; f++) l = i, f !== p && (l = C.clone(l, !0, !0), s && C.merge(a, Ae(l, "script"))), n.call(e[f], l, f);
                        if (s)
                            for (c = a[a.length - 1].ownerDocument, C.map(a, Be), f = 0; f < s; f++) l = a[f], Ee.test(l.type || "") && !se.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
                                nonce: l.nonce || l.getAttribute("nonce")
                            }, c) : w(l.textContent.replace(Ie, ""), l, c))
                    }
                    return e
                }

                function Je(e, t, n) {
                    for (var r, i = t ? C.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || C.cleanData(Ae(r)), r.parentNode && (n && ve(r) && De(Ae(r, "script")), r.parentNode.removeChild(r));
                    return e
                }
                C.extend({
                    ...
                    clone: function(e, t, n) {
                        ...
                        if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                            for (a = Ae(s), r = 0, i = (o = Ae(e)).length; r < i; r++) Xe(o[r], a[r]);
                        if (t)
                            if (n)
                                for (o = o || Ae(e), a = a || Ae(s), r = 0, i = o.length; r < i; r++) ze(o[r], a[r]);
                            else ze(e, s);
                    ...
                    html: function(e) {
                        return ee(this, (function(e) {
                            ...
                            if ("string" == typeof e && !Re.test(e) && !_e[(ke.exec(e) || ["", ""])[1].toLowerCase()]) {
                                e = C.htmlPrefilter(e);
                                try {
                ...
                function Ze(e, t, n) {
                    var r, i, o, a, s = Ge.test(t),
                        u = e.style;
                    return (n = n || Ye(e)) && (a = n.getPropertyValue(t) || n[t], s && a && (a = a.replace(L, "$1") || void 0), "" !== a || ve(e) || (a = C.style(e, t)), !v.pixelBoxStyles() && Ve.test(a) && Qe.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = a, a = n.width, u.width = r, u.minWidth = i, u.maxWidth = o)), void 0 !== a ? a + "" : a
                }
                ...
                function lt(e, t, n, r, i, o) {
                    ...
                    for (; a < 4; a += 2) "margin" === n && (l += C.css(e, n + he[a], !0, i)), r ? ("content" === n && (u -= C.css(e, "padding" + he[a], !0, i)), "margin" !== n && (u -= C.css(e, "border" + he[a] + "Width", !0, i))) : (u += C.css(e, "padding" + he[a], !0, i), "padding" !== n ? u += C.css(e, "border" + he[a] + "Width", !0, i) : s += C.css(e, "border" + he[a] + "Width", !0, i));
                ...
                function ct(e, t, n) {
                    ...
                    return (!v.boxSizingReliable() && i || !v.reliableTrDimensions() && E(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === C.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === C.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + lt(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
                }
                    ...
                    style: function(e, t, n, r) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            var i, o, a, s = ie(t),
                                u = Ge.test(t),
                                l = e.style;
                            if (u || (t = it(s)), a = C.cssHooks[t] || C.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                            "string" === (o = typeof n) && (i = pe.exec(n)) && i[1] && (n = be(e, t, i), o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (C.cssNumber[s] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
                        }
                    },
                    css: function(e, t, n, r) {
                        var i, o, a, s = ie(t);
                        return Ge.test(t) || (t = it(s)), (a = C.cssHooks[t] || C.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ze(e, t, r)), "normal" === i && t in st && (i = st[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                    }
                }), C.each(["height", "width"], (function(e, t) {
                    C.cssHooks[t] = {
                        get: function(e, n, r) {
                            if (n) return !ot.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, t, r) : Ke(e, at, (function() {
                                return ct(e, t, r)
                            }))
                        },
                        set: function(e, n, r) {
                            var i, o = Ye(e),
                                ...
                                u = r ? lt(e, t, r, s, o) : 0;
                            return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - lt(e, t, "border", !1, o) - .5)), u && (i = pe.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = C.css(e, t)), ut(0, n, u)
                        }
                    }
                    ...
                    css: function(e, t) {
                        return ee(this, (function(e, t, n) {
                            var r, i, o = {},
                                a = 0;
                            if (Array.isArray(t)) {
                                for (r = Ye(e), i = t.length; a < i; a++) o[t[a]] = C.css(e, t[a], !1, r);
                                return o
                            }
                ...
                function xt(e, t, n) {
                    ...
                    for (! function(e, t) {
                        ...
                        if (r = xt.prefilters[o].call(l, e, c, l.opts)) return m(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
                    return C.map(c, bt, l), m(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), C.fx.timer(C.extend(u, {
                        elem: e,
                        anim: l,
                        queue: l.opts.queue
                    })), l
                ...
                C.Animation = C.extend(xt, {
                        ...
                        prefilters: [function(e, t, n) {
                            ...
                            if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(p))
                                for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = se.get(e, "display")), "none" === (c = C.css(e, "display")) && (l ? c = l : (Te([e], !0), l = e.style.display || l, c = C.css(e, "display"), Te([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === C.css(e, "float") && (u || (d.done((function() {
                                        h.display = l
                                    })), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always((function() {
                                        h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                                    }))), u = !1, p) u || (v ? "hidden" in v && (g = v.hidden) : v = se.access(e, "fxshow", {
                                    display: l
                                }), o && (v.hidden = !g), g && Te([e], !0), d.done((function() {
                                    for (r in g || Te([e]), se.remove(e, "fxshow"), p) C.style(e, r, p[r])
                                }))), u = bt(g ? v[r] : 0, r, d), r in v || (v[r] = u.start, g && (u.end = u.start, u.start = 0))
                        }],
                ...
                C.fn.extend({
                    val: function(e) {
                        ...
                        }))) : i ? (t = C.valHooks[i.type] || C.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof(n = i.value) ? n.replace(_t, "") : null == n ? "" : n : void 0
                    }
                }), C.extend({
                    valHooks: {
                        option: {
                ...
                C.extend(C.event, {
                    trigger: function(e, t, n, i) {
                        ...
                        if (a = d = s = n = n || b, 3 !== n.nodeType && 8 !== n.nodeType && !Lt.test(g + C.event.triggered) && (g.indexOf(".") > -1 && (v = g.split("."), g = v.shift(), v.sort()), l = g.indexOf(":") < 0 && "on" + g, (e = e[C.expando] ? e : new C.Event(g, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), f = C.event.special[g] || {}, i || !f.trigger || !1 !== f.trigger.apply(n, t))) {
                            if (!i && !f.noBubble && !y(n)) {
                            ...
                            for (o = 0;
                                (a = h[o++]) && !e.isPropagationStopped();) d = a, e.type = o > 1 ? u : f.bindType || g, (c = (se.get(a, "events") || Object.create(null))[e.type] && se.get(a, "handle")) && c.apply(a, t), (c = l && a[l]) && c.apply && oe(a) && (e.result = c.apply(a, t), !1 === e.result && e.preventDefault());
                            return e.type = g, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !oe(n) || l && m(n[g]) && !y(n) && ((s = n[l]) && (n[l] = null), C.event.triggered = g, e.isPropagationStopped() && d.addEventListener(g, Ot), n[g](), e.isPropagationStopped() && d.removeEventListener(g, Ot), C.event.triggered = void 0, s && (n[l] = s)), e.result
                        }
                    },
                ...
                function Rt(e, t, n, r) {
                    ...
                    if (Array.isArray(t)) C.each(t, (function(t, i) {
                        n || qt.test(e) ? r(e, i) : Rt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
                    }));
                ...
                C.param = function(e, t) {
                    ...
                    serializeArray: function() {
                        return this.map((function() {
                            ...
                            var e = this.type;
                            return this.name && !C(this).is(":disabled") && Mt.test(this.nodeName) && !Ht.test(e) && (this.checked || !Ce.test(e))
                        })).map((function(e, t) {
                            var n = C(this).val();
                ...
                Vt.href = At.href, C.extend({
                    ...
                    ajax: function(e, t) {
                        ...
                        if (v.promise(S), p.url = ((e || p.url || At.href) + "").replace(zt, At.protocol + "//"), p.type = t.method || t.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(J) || [""], null == p.crossDomain) {
                            u = b.createElement("a");
                            try {
                        ...
                        if (p.data && p.processData && "string" != typeof p.data && (p.data = C.param(p.data, p.traditional)), Yt(Xt, p, t, S), l) return S;
                        for (f in (c = C.event && p.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Bt.test(p.type), i = p.url.replace(It, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace($t, "+")) : (d = p.url.slice(i.length), p.data && (p.processData || "string" == typeof p.data) && (i += (Nt.test(i) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (i = i.replace(Wt, "$1"), d = (Nt.test(i) ? "&" : "?") + "_=" + Dt.guid++ + d), p.url = i + d), p.ifModified && (C.lastModified[i] && S.setRequestHeader("If-Modified-Since", C.lastModified[i]), C.etag[i] && S.setRequestHeader("If-None-Match", C.etag[i])), (p.data && p.hasContent && !1 !== p.contentType || t.contentType) && S.setRequestHeader("Content-Type", p.contentType), S.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Jt + "; q=0.01" : "") : p.accepts["*"]), p.headers) S.setRequestHeader(f, p.headers[f]);
                        if (p.beforeSend && (!1 === p.beforeSend.call(h, S, p) || l)) return S.abort();
                        if (T = "abort", m.add(p.complete), S.done(p.success), S.fail(p.error), n = Yt(Ut, p, t, S)) {
                        ...
                        function j(e, t, a, u) {
                            var f, d, b, x, w, T = t;
                            l || (l = !0, s && r.clearTimeout(s), n = void 0, o = u || "", S.readyState = e > 0 ? 4 : 0, f = e >= 200 && e < 300 || 304 === e, a && (x = function(e, t, n) {
                            ...
                            }(p, S, a)), !f && C.inArray("script", p.dataTypes) > -1 && C.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function() {}), x = function(e, t, n, r) {
                                var i, o, a, s, u, l = {},
                                    c = e.dataTypes.slice();
                                if (c[1])
                            ...
                            }(p, x, S, f), f ? (p.ifModified && ((w = S.getResponseHeader("Last-Modified")) && (C.lastModified[i] = w), (w = S.getResponseHeader("etag")) && (C.etag[i] = w)), 204 === e || "HEAD" === p.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = x.state, d = x.data, f = !(b = x.error))) : (b = T, !e && T || (T = "error", e < 0 && (e = 0))), S.status = e, S.statusText = (t || T) + "", f ? v.resolveWith(h, [d, T, S]) : v.rejectWith(h, [S, T, b]), S.statusCode(y), y = void 0, c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [S, p, f ? d : b]), m.fireWith(h, [S, T]), c && (g.trigger("ajaxComplete", [S, p]), --C.active || C.event.trigger("ajaxStop")))
                        }
                        return S
                    },
                ...
                C.ajaxSetup({
                    ...
                    if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(nn, "$1" + i) : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
                        return a || C.error(i + " was not called"), a[0]
                    }, e.dataTypes[0] = "json", o = r[i], r[i] = function() {
                        a = arguments
                    }, n.always((function() {
                        void 0 === o ? C(r).removeProp(i) : r[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, tn.push(i)), a && m(o) && o(a[0]), a = o = void 0
                    })), "script"
                    ...
                    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((r = (t = b.implementation.createHTMLDocument("")).createElement("base")).href = b.location.href, t.head.appendChild(r)) : t = b), o = !n && [], (i = I.exec(e)) ? [t.createElement(i[1])] : (i = Le([e], t, o), o && o.length && C(o).remove(), C.merge([], i.childNodes)));
                    var r, i, o
                }, C.fn.load = function(e, t, n) {
                    var r, i, o, a = this,
                        s = e.indexOf(" ");
                    return s > -1 && (r = Ct(e.slice(s)), e = e.slice(0, s)), m(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && C.ajax({
                        url: e,
                        type: i || "GET",
                        dataType: "html",
                        data: t
                ...
                }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = E, C.isFunction = m, C.isWindow = y, C.camelCase = ie, C.type = T, C.now = Date.now, C.isNumeric = function(e) {
                    var t = C.type(e);
