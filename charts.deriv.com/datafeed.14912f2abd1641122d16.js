    ...
    o.m = e, r = [], o.O = (e, t, a, n) => {
        if (!t) {
            ...
            for (f = 0; f < r.length; f++) {
                for (var [t, a, n] = r[f], v = !0, l = 0; l < t.length; l++)(!1 & n || i >= n) && Object.keys(o.O).every((r => o.O[r](t[l]))) ? t.splice(l--, 1) : (v = !1, n < i && (i = n));
                if (v) {
                    r.splice(f--, 1);
                    var s = a();
                    void 0 !== s && (e = s)
        ...
        var e = (e, t) => {
                ...
                for (e && e(t); s < i.length; s++) n = i[s], o.o(r, n) && r[n] && r[n][0](), r[n] = 0;
                return o.O(f)
            },
            t = self.webpackChunkderiv_charts = self.webpackChunkderiv_charts || [];
