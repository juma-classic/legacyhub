(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [9418], {
        ...
        53177: (e, t, i) => {
            ...
            const _ = s.forwardRef(((e, t) => s.createElement(n.NavButton, { ...e,
                ref: t,
                icon: m(e.size)
            })))
        },
        64388: (e, t, i) => {
            ...
            function d(e) {
                ...
                return o()(l()["nav-button"], l()[`size-${t}`], i && l()["preserve-paddings"], n && l()["flip-icon"], s && l().link, a)
            }
            ...
            const h = (0, s.forwardRef)(((e, t) => {
                ...
                return s.createElement("button", { ...h,
                    className: d({ ...e,
                        children: l
                    }),
                    ref: t,
            ...
            (0, s.forwardRef)(((e, t) => {
                const {
                    ...
                    "aria-label": o,
                    ...a
                } = e, r = n ? ? u.CustomComponentDefaultLink;
        ...
        79418: (e, t, i) => {
            ...
            function x(e) {
                ...
                }, n), l && s.createElement("div", {
                    className: a()(w.ellipsis, w.subtitle)
                }, l)), p, d && !E && s.createElement(v.CloseButton, {
                    className: w.close,
                    "data-qa-id": "close",
                    "aria-label": x,
                    onClick: c,
            ...
            class F extends s.PureComponent {
                constructor() {
                    super(...arguments), this._controller = null, this._reference = null, this._orientationMediaQuery = null, this._embedResizerOverridesEnabled = D.enabled("embed_resizer_overrides"), this._titleId = `title_${(0,C.randomHash)()}`, this._renderChildren = (e, t) => (this._controller = e, this.props.render({
                        ...
                        void 0 !== this.props.onOpen && this.props.isOpened && this.props.onOpen(this.props.fullScreen || window.matchMedia(u.DialogBreakpoints.TabletSmall).matches)
                        ...
                        if (!e.defaultPrevented) {
                            if (this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, r.hashFromEvent)(e)) {
                                ...
                                if (null !== i) {
                                    ...
                                    if (null !== s && (0, d.isTextEditingField)(i)) return void s.focus();
                                    if (s ? .contains(i)) return this.props.onKeyboardClose && this.props.onKeyboardClose(), void this._handleClose()
                                }
                            }
                            var t, i;
                            (function(e) {
                                return "function" == typeof e ? e() : Boolean(e)
                            })(this.props.disableTabNavigationContainment) || (i = e, [9, r.Modifiers.Shift + 9].includes((0, r.hashFromEvent)(i)) && i.stopPropagation())
                        }
                    }, this._requestResize = () => {
                ...
                render() {
                    const {
                        ...
                        onClick: Z
                    } = this.props, Q = this.props.fixedBody ? ? (!!w || void 0), j = "after" !== v ? y : void 0, J = "after" === v ? y : void 0, ee = "string" == typeof o ? o : W || "", te = (0, E.filterDataProps)(this.props), ie = (0, b.mergeRefs)([this._handleReference, $]);
                    return s.createElement(p.MatchMedia, {
                        rule: u.DialogBreakpoints.SmallHeight
                    }, (v => s.createElement(p.MatchMedia, {
                        rule: u.DialogBreakpoints.TabletSmall
                    }, (u => s.createElement(c.PopupDialog, {
                        rounded: !(u || B) && z,
                        ...
                        containerAriaLabel: X,
                        containerTabIndex: q,
                        calculateDialogPosition: B && V ? this._calculatePositionWithOffsets : void 0,
                        shadowed: G,
                        fixedBody: Q,
                        onClick: Z,
                        ...te
                        ...
                        closeButtonReference: U,
                        onCloseButtonKeyDown: Y
                    }), M && s.createElement(h.Separator, {
                        className: S.separator
                    }), s.createElement(g.PopupContext.Consumer, null, (e => this._renderChildren(e, u || B)))))))))
                }
            }
        },
        95711: (e, t, i) => {
        ...
        9722: (e, t, i) => {
            ...
            class u extends s.PureComponent {
                ...
                render() {
                    ...
                    } = this.props, u = o()(a, h().dialog, e && h().rounded, t && h().shadowed, i && h().fullscreen, n && h().darker), p = (0, d.filterDataProps)(this.props), g = this.props.style ? { ...this._createStyles(),
                        ...this.props.style
                    } : this._createStyles();
                    return s.createElement(s.Fragment, null, s.createElement(r.SlotContext.Provider, {
                        value: this._manager
                    }, l && s.createElement("div", {
                        onClick: this.props.onClickBackdrop,
                        className: h().backdrop
                    }), s.createElement("div", { ...p,
                        className: u,
                        style: g,
                    ...
                    }, this.props.children)), s.createElement(r.Slot, {
            ...
            class b {
                constructor(e, t, i = {
                    ...
                    }, this._dialog = e, this._header = t, this._options = i, this._header.addEventListener("mousedown", this._onMouseDragStart), this._header.addEventListener("touchstart", this._onTouchDragStart), this._header.addEventListener("touchend", this._onTouchDragEnd)
                }
                destroy() {
            ...
            class T {
                ...
                dispatch(e) {
                    ...
                    })), "dialog-close" === e && (this._openSessionId = null)) : M.logError("Empty open dialog session id")
                }
            }
            var N = i(84015),
                B = (i(37103), i(94489)),
            ...
            const z = class {
                ...
                getDialogsTopLeftCoordinates() {
                    const {
                        clientWidth: e,
                        clientHeight: t
                    } = this._getClientDimensions(), i = this._calcDialogHeight(), s = e / 2 - this._dialog.clientWidth / 2, n = t / 2 - i / 2 + this._getTopOffset();
                    return {
                        x: Math.round(s),
                        y: Math.round(n)
                    }
                ...
                recalculateBounds() {
                    const {
                        ...
                        vertical: i
                    } = this._guard, s = this._calculateDialogPosition ? .(this._dialog, {
                        clientWidth: e,
                        clientHeight: t
                    }, {
                        vertical: i
                    ...
                    if (this._isFullscreen) {
                        if (this._dialog.style.top = "0px", this._dialog.style.left = "0px", this._dialog.style.width = "100%", this._dialog.style.height = "100%", this._dialog.style.transform = "none", s) {
                            const {
                                left: e,
                                top: t,
                                width: i,
                            ...
                            this._dialog.style.transform = `translate(${Math.round(e)}px, ${Math.round(t)}px)`, i && (this._dialog.style.width = `${i}px`, this._dialog.style.minWidth = "unset"), n && (this._dialog.style.height = `${n}px`, this._dialog.style.minHeight = "unset")
                        }
                    } else if (s) {
                        const {
                            left: e,
                        ...
                        this._dialog.style.top = "0px", this._dialog.style.left = "0px", this._dialog.style.transform = `translate(${Math.round(o)}px, ${Math.round(a)}px)`, this._dialog.style.height = n < s.height ? n + "px" : this._initialHeight
                    }
                }
                destroy() {
            ...
            class O extends s.PureComponent {
                constructor(e) {
                    super(e), this._dialog = null, this._cleanUpFunctions = [], this._prevActiveElement = null, this._eventDispatcher = new T, this._handleDialogRef = e => {
                        const {
                            reference: t
                        } = this.props;
                ...
                render() {
                    return s.createElement(S.PopupContext.Provider, {
                        value: this
                    }, s.createElement(m.OutsideEvent, {
                        mouseDown: !0,
                        touchStart: !0,
                        ...
                        "data-qa-id": (0, B.dataQaIds)("ui-lib-PopupDialog", this.props.dataQaId)
                    }, s.createElement(u, {
                        style: this._applyAnimationCSSVariables(),
                        ...this.props,
                        reference: this._handleDialogRef,
                        className: n(P.dialog, (0, N.isOnMobileAppPage)("any") && !this.props.noMobileAppShadows && P.mobile, this.props.fullscreen && P.fullscreen, this.props.className)
                ...
                componentDidMount() {
                    const {
                        ...
                        boundByScreen: t,
                        onDragStart: i
                    } = this.props, s = (0, a.ensureNotNull)(this._dialog);
                    ...
                    this.props.autofocus && !s.contains(document.activeElement) && s.focus(), (this._isFullScreen() || this.props.fixedBody) && (0, k.setFixedBodyState)(!0);
                    const {
                        guard: n,
                        calculateDialogPosition: o
                    } = this.props;
                    ...
                    if (!s.contains(document.activeElement)) {
                        const e = function(e) {
                            ...
                            const i = (0, f.getActiveElementSelectors)(),
                                s = Array.from(e.querySelectorAll(i)).filter((0, f.createScopedVisibleElementFilter)(e));
                ...
                componentWillUnmount() {
                    ...
                    (this._isFullScreen() || this.props.fixedBody) && (0, k.setFixedBodyState)(!1), this._isFullScreen() && this._eventDispatcher.dispatch("dialog-fullscreen-off"), this._eventDispatcher.dispatch("dialog-close")
                }
                focus() {
                ...
                _applyAppearanceAnimation(e) {
                    if (this._resize && this._dialog) {
                        ...
                        this._dialog.style.setProperty("--animationTranslateStartX", `${t}px`), this._dialog.style.setProperty("--animationTranslateStartY", `${i}px`), this._dialog.style.setProperty("--animationTranslateEndX", `${s}px`), this._dialog.style.setProperty("--animationTranslateEndY", `${n}px`), this._dialog.classList.add(P.dialogAnimatedAppearance)
                    }
                }
                _handleTooltipFit() {}
                _isFullScreen() {
            ...
            O.contextType = D.PortalContext, O.defaultProps = {
                boundByScreen: !0,
                draggable: !0,
                centeredOnMount: !0,
                shouldReturnFocus: !0
            ...
            function o(e, t) {
                return class extends s.PureComponent {
                    render() {
                        ...
                        if (!i) return null;
                        const a = s.createElement(e, { ...this.props,
                            ref: this.props.componentRef,
                            zIndex: 150
                        });
                        return "parent" === o ? a : s.createElement(n.Portal, {
                            shouldTrapFocus: t
                        }, a)
                    }
                }
