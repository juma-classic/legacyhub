(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [3179], {
        ...
        36383: (e, t, n) => {
            ...
            function r(e) {
                const {
                    ...
                    handler: l,
                    reference: u
                } = e, c = (0, s.useRef)(null), d = (0, s.useRef)("undefined" == typeof window ? 0 : new window.CustomEvent("timestamp").timeStamp);
        ...
        83021: (e, t, n) => {
            ...
            function o(e) {
                const [t, n] = (0, s.useState)(null), o = (0, s.useRef)(null), r = (0, s.useRef)(new Map);
                return (0, s.useEffect)((() => () => {
                    ...
                    value: {
                        ...
                        setCurrent: function(e) {
                            null !== o.current && (clearTimeout(o.current), o.current = null), null === t ? n(e) : o.current = setTimeout((() => {
                                o.current = null, n(e)
                            }), 100)
                        },
        ...
        19250: (e, t, n) => {
            ...
            class u extends s.PureComponent {
                ...
                render() {
                    ...
                    return t && ("string" == typeof t ? e.classList.add(t) : e.classList.add(...t)), this.props.shouldTrapFocus && !e.hasAttribute(a.FOCUS_TRAP_DATA_ATTRIBUTE) && e.setAttribute(a.FOCUS_TRAP_DATA_ATTRIBUTE, "true"), this.props["aria-hidden"] && e.setAttribute("aria-hidden", "true"), i.createPortal(s.createElement(c.Provider, {
                        value: this
        ...
        99054: (e, t, n) => {
            ...
            function l(e) {
                ...
                if (e && 1 == ++r) {
                    ...
                    "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (i(n, "right", `${s()}px`), t.style.paddingRight = `${r+s()}px`, a = !0), t.classList.add("i-no-scroll")
                } else if (!e && r > 0 && 0 == --r && (t.classList.remove("i-no-scroll"), a)) {
                    i(n, "right", "0px");
                    let e = 0;
                    t.scrollHeight <= t.clientHeight && (e -= s()), t.style.paddingRight = (e < 0 ? 0 : e) + "px", a = !1
                }
            }
        },
        90692: (e, t, n) => {
            ...
            class v extends s.PureComponent {
                constructor(e) {
                    super(e), this._containerRef = null, this._scrollWrapRef = null, this._raf = null, this._scrollRaf = null, this._scrollTimeout = void 0, this._manager = new d.OverlapManager, this._hotkeys = null, this._scroll = 0, this._handleContainerRef = e => {
                        ...
                        const {
                            position: n
                        } = this.props, s = (0, r.ensureNotNull)(this._containerRef);
                        ...
                        let c = o - 0 - u;
                        const d = i.height > c;
                        d && ((0, r.ensureNotNull)(this._scrollWrapRef).style.overflowY = "scroll", i = s.getBoundingClientRect());
                        const {
                            width: h,
                            height: p
                        } = i, m = "function" == typeof n ? n({
                            contentWidth: h,
                            contentHeight: p,
                            availableWidth: l,
                            availableHeight: o
                        }) : n, f = m ? .indentFromWindow ? .left ? ? 0, _ = l - (m.overrideWidth ? ? h) - (m ? .indentFromWindow ? .right ? ? 0), g = (0, a.clamp)(m.x, f, Math.max(f, _)), v = (m ? .indentFromWindow ? .top ? ? 0) + u, y = o - (m.overrideHeight ? ? p) - (m ? .indentFromWindow ? .bottom ? ? 0);
                        let w = (0, a.clamp)(m.y, v, Math.max(v, y));
                        if (m.forbidCorrectYCoord && w < m.y && (c -= m.y - w, w = m.y), t && void 0 !== this.props.closeOnScrollOutsideOffset && m.y <= this.props.closeOnScrollOutsideOffset) return void this._handleGlobalClose(!0);
                ...
                componentDidMount() {
                    ...
                    e.subscribe(this, this._handleGlobalClose), t ? .subscribe(null, this._handleCustomRemeasureDelegate), window.addEventListener("resize", this._resize);
                ...
                componentWillUnmount() {
                    ...
                    e.unsubscribe(this, this._handleGlobalClose), t ? .unsubscribe(null, this._handleCustomRemeasureDelegate), window.removeEventListener("resize", this._resize), window.removeEventListener("scroll", this._handleScrollOutside, {
                        capture: !0
            ...
            function y(e) {
                ...
                return s.createElement("div", {
                    ...
                    onMouseOver: function(e) {
                        var s;
                        null !== t.current && e.target instanceof Node && (s = e.target, n.current ? .contains(s)) && (t.isSubmenuNode(e.target) || t.setCurrent(null))
                    },
