(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [6376], {
                    ...
                    if (o) {
                        ...
                        if (e && !i.some((function(t) {
                            ...
                            i = [].concat(t(i), [h]), e.ontouchstart = function(e) {
                                ...
                                var n, s, o, i;
                                1 === t.targetTouches.length && (s = e, i = (n = t).targetTouches[0].clientY - r, !u(n.target) && (s && 0 === s.scrollTop && 0 < i || (o = s) && o.scrollHeight - o.scrollTop <= o.clientHeight && i < 0 ? d(n) : n.stopPropagation()))
        ...
        57418: e => {
            e.exports = {
                accessible: "accessible-rm8yeqY4"
            }
        },
        2277: e => {
            e.exports = {
        ...
        5811: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    hideIcon: m,
                    ...p
                } = e, v = t || !n || m ? "" : l(), b = i()(u().box, u()[`intent-${h}`], !t && u().check, !!t && u().dot, -1 === o && u().noOutline, r, n && u().checked, c && u().disabled, d && u().disableActiveStyles);
                return s.createElement("span", {
                    className: b,
                    ...p
        ...
        74670: (e, t, n) => {
            "use strict";
            n.d(t, {
                useActiveDescendant: () => i
            });
            var s = n(50959),
                o = n(39416);

            function i(e, t = []) {
                const [n, i] = (0, s.useState)(!1), a = (0, o.useFunctionalRefObject)(e);
                return (0, s.useLayoutEffect)((() => {
                    ...
                    return e.addEventListener("active-descendant-focus", t), e.addEventListener("active-descendant-blur", t), () => {
        ...
        10772: (e, t, n) => {
            ...
            function m(e) {
                ...
                return s.createElement(d.ContextMenuItem, {
                    size: t,
                    jsxLabel: s.createElement("div", {
                        className: c()(h.loaderWrap, h[t])
                    }, s.createElement(u.Loader, {
                        className: h.loader
                    })),
                    noInteractive: !0,
            ...
            const f = (0, s.forwardRef)((function(e, t) {
                const {
                    className: n,
                    ...o
                } = e, [i, a] = (0, v.useRovingTabindexElement)(t);
                return s.createElement(d.ContextMenuItem, { ...o,
            ...
            class x extends s.PureComponent {
                    ...
                    super(e), this._itemRef = null, this._menuElementRef = s.createRef(), this._menuRef = null, this._handleClick = e => {
                        ...
                        if (t) {
                            const {
                                ...
                                right: s,
                                top: o
                            } = t.getBoundingClientRect(), i = document.documentElement.clientWidth, a = {
                                x: n - e,
                                y: o
                            }, r = {
                                x: s,
                        ...
                        return n
                    }(e.contentWidth, this._itemRef), this._updateState = e => {
                        this.setState(e.getState())
                    }, this._setItemRef = e => {
                        this._itemRef = e
                    }, this._handleMenuRef = e => {
                        this._menuRef = e
                    }, this._registerSubmenu = () => this.context ? .registerSubmenu(this.props.action.id, (e => (0, o.ensureNotNull)(this._itemRef).contains(e) || null !== this._menuElementRef.current && this._menuElementRef.current.contains(e))), this.state = { ...this.props.action.getState()
                    }
                }
                componentDidMount() {
                ...
                componentDidUpdate(e, t) {
                    t.loading !== this.state.loading && this.props.onRequestUpdate ? .(), 0 === t.subItems.length && this.state.subItems.length > 0 && (this._unsubscribe = this._registerSubmenu()), t.subItems.length > 0 && 0 === this.state.subItems.length && this._unsubscribe ? .(), t.subItems !== this.state.subItems && null !== this._menuRef && this._menuRef.update()
                }
                ...
                render() {
                    ...
                    return this.state.loading ? s.createElement(m, {
                        size: this.state.size
                    }) : s.createElement(f, { ...(0, i.filterDataProps)(this.props),
            ...
            class g extends s.PureComponent {
                ...
                render() {
                    const {
                        ...
                        jsxLabel: v,
                        styledLabel: E
                    } = this.props, g = this.props.checkable && this.props.checkboxInput ? "label" : "div";
                    return s.createElement(s.Fragment, null, s.createElement("tr", { ...(0, m.filterDataProps)(this.props),
                        ...(0, m.filterAriaProps)(this.props),
                        id: this.props.id,
                        className: o(this.props.className, l.item, !this.props.noInteractive && l.interactive, this.props.hovered && l.hovered, this.props.disabled && l.disabled, this.props.active && l.active, this.props.selected && l.selected, l[d]),
                        ...
                        key: n,
                        style: t
                    }, e))) : v ? ? p), this._toolbox(l), e && s.createElement("span", {
                ...
                _renderToolboxContent() {
                    return this.props.toolbox && this.props.toolbox.type === d.ToolboxType.Delete ? s.createElement(l.RemoveButton, {
                        icon: p,
        ...
        91561: (e, t, n) => {
            ...
            function E(e) {
                ...
                }), []), s.createElement(v.ContextMenuItem, { ...n,
                    onClick: function(e) {
                        n.disabled || e.defaultPrevented || (r ? a(!0) : (n.doNotCloseOnClick || (0, f.globalCloseMenu)(), t.execute()))
                    },
                    isLoading: n.loading,
                    isHovered: l
                }, l && s.createElement(b.Drawer, {
                    onClose: c
                }, s.createElement(x, {
                    items: n.subItems,
                    parentAction: t,
            ...
            function x(e) {
                const {
                    ...
                    parentAction: n,
                    closeNested: o
                } = e, i = !Boolean(n) && t.every((e => !Boolean("separator" !== e.type && (e.getState().icon || e.getState().checkable))));
                return s.createElement(w.EmptyIconsContext.Provider, {
                    value: i
                }, s.createElement("ul", null, n && s.createElement(s.Fragment, null, s.createElement(v.ContextMenuItem, {
                    ...
                    icon: g,
                    onClick: o
                }), s.createElement(p, null)), t.map((e => {
                    switch (e.type) {
                        case "action":
            ...
            class y extends s.PureComponent {
                constructor(e) {
                    super(e), this._menuRef = s.createRef(), this._handleRequestUpdate = () => {
                        ...
                        this.props.menuElementReference ? .current && this.props.takeFocus && this.props.menuElementReference ? .current.focus({
                            preventScroll: !0
                        })
                    }, this._handleFocus = e => {
                        this.props.isKeyboardEvent && e.target && (0, _.focusFirstMenuItem)(e.target)
                    }, this.state = {}
                }
                render() {
                    const {
                    ...
                    return e && n.length > 0 ? s.createElement(d.DrawerManager, null, s.createElement(c, {
                        keyCode: 27,
                        eventType: "keyup",
                        handler: this._handleClose
                    }), s.createElement(h.MatchMedia, {
                        rule: "(max-width: 440px)"
                    }, (t => this._isDrawer(t) ? s.createElement(k.Provider, {
                        value: {
                            type: "drawer"
                        }
                    }, s.createElement(b.Drawer, {
                    ...
                    }, (t => s.createElement(r.Menu, { ...v,
                        reference: t,
                        className: i()(C.menu, "context-menu"),
                        onClose: this._handleClose,
                ...
                update() {
                    this._menuRef.current && this._menuRef.current.update(), this.props.isKeyboardEvent && this.props.menuElementReference ? .current && document.activeElement === this.props.menuElementReference.current && (0, _.focusFirstMenuItem)(this.props.menuElementReference.current)
                }
                _isDrawer(e) {
                    return void 0 === this.props.mode ? e : "drawer" === this.props.mode
                }
            }
            const M = (0, a.makeOverlapable)(y)
        },
        25812: (e, t, n) => {
            "use strict";
            var s;
        ...
        23829: (e, t, n) => {
            ...
            function p(e) {
                const {
                    ...
                    jsxLabel: I,
                    size: S = "normal"
                } = e, D = (0, s.useContext)(l.EmptyIconsContext), L = !!k.length;
                return o ? s.createElement("li", {
                    className: i()(t, m.item, m.loading, m[S])
                }, s.createElement(r.Loader, null)) : s.createElement("li", {
                    className: i()(t, m.item, m.interactive, n && m.title, f && m.disabled, p && m.hovered, v && m.active, D && m.emptyIcons, m[S]),
                    onClick: y
                }, s.createElement(a.Icon, {
                    className: i()(m.icon),
                    icon: b && E ? g || w || u : w
                    ...
                    key: n,
                    style: t
                }, e))) : I ? ? _), !!N && s.createElement(a.Icon, {
                    onClick: function() {
                        N && N.action()
                    },
                    className: m.remove,
                    icon: h
                }), !L && x && s.createElement(c.Hint, {
                    className: m.shortcut,
                    text: x
                }), L && s.createElement(a.Icon, {
                    className: m.nested,
                    icon: d
                }), M)
            }
        ...
        36189: (e, t, n) => {
            ...
            function h(e) {
                const {
                    ...
                    title: m,
                    ...p
                } = e, [v, b] = (0, l.useActiveDescendant)(null), f = m ? ? (n ? r.removeTitlesMap[r.RemoveTitleType.Remove] : r.removeTitlesMap[r.RemoveTitleType.Add]);
                return (0, s.useLayoutEffect)((() => {
                    const e = v.current;
                    e instanceof HTMLElement && f && e.dispatchEvent(new CustomEvent("common-tooltip-update"))
                }), [f, v]), s.createElement(a.Icon, { ...p,
                    className: i()(d.favorite, "apply-common-tooltip", n && d.checked, o && d.active, b && d.focused, t),
                    onClick: h,
                    icon: n ? c : u,
                    title: f,
                    ariaLabel: f,
        ...
        96040: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    icon: b,
                    ...f
                } = e, [E, w] = (0, l.useActiveDescendant)(null);
                return o.createElement(r.Icon, { ...f,
                    "data-name": v,
                    className: a()(u.button, "apply-common-tooltip", i && u.active, p && u.hidden, w && u.focused, t),
                    icon: b || c,
                    onClick: d,
                    onMouseDown: h,
        ...
        60004: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><path fill="currentColor" d="M22 9.06 11 20 6 14.7l1.09-1.02 3.94 4.16L20.94 8 22 9.06Z"/></svg>'
        },
        65890: e => {
