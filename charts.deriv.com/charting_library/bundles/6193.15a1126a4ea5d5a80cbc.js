(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [6193], {
        ...
        53885: (e, t, o) => {
            ...
            function l(e, t = 2, o) {
                return r()(a().logo, a()[e], o, 0 === t || 1 === t ? r()(i.skeletonTheme.wrapper, a().skeleton) : a().letter, 1 === t && i.skeletonTheme.animated)
            }
        ...
        39416: (e, t, o) => {
            ...
            function i(e) {
                const t = (0, n.useMemo)((() => function() {
                    ...
                    a = (0, n.useRef)(i);
                return a.current = i, (0, r.useIsomorphicLayoutEffect)((() => {
        ...
        50238: (e, t, o) => {
            ...
            function s(e, t = []) {
                const [o, s] = (0, n.useState)(!1), a = (0, r.useFunctionalRefObject)(e);
                return (0, i.useIsomorphicLayoutEffect)((() => {
                    ...
                    return e.addEventListener("roving-tabindex:main-element", t), e.addEventListener("roving-tabindex:secondary-element", t), () => {
        ...
        59695: (e, t, o) => {
            ...
            function a(e) {
                ...
                return (0, n.useEffect)((() => i(s.current ? .complete ? ? !t ? 2 : 1)), [t]), t && 3 !== o ? n.createElement("img", {
                    ref: s,
                    className: a,
                    crossOrigin: "",
                    src: e.logoUrl,
        ...
        41590: (e, t, o) => {
            ...
            function h(e) {
                const {
                    ...
                    className: h,
                    theme: f = p
                } = e, v = (0, i.ensureNotNull)((0, r.useContext)(c.DrawerContext)), [g] = (0, r.useState)((() => (0, a.randomHash)())), b = (0, r.useRef)(null), x = (0, r.useContext)(d.CloseDelegateContext);
                return (0, r.useLayoutEffect)((() => ((0, i.ensureNotNull)(b.current).focus({
                    preventScroll: !0
                }), x.subscribe(v, o), v.addDrawer(g), () => {
                    v.removeDrawer(g), x.unsubscribe(v, o)
                })), []), r.createElement(l.Portal, null, r.createElement("div", {
                    ref: u,
                    className: s(p.wrap, p[`position${t}`])
                }, g === v.currentDrawer && r.createElement("div", {
                    className: p.backdrop,
                    onClick: o
                }), r.createElement(m, {
                    className: s(f.drawer, p[`position${t}`], h),
                    ref: b,
            ...
            function p(e) {
                const {
                    ...
                    function t(t) {
                        const {
                            reference: o,
                            ...r
                        } = t, i = e ? ? (r.href ? "a" : "div"), s = "a" === i ? r : function(e) {
                            const {
                                download: t,
                                href: o,
                                hrefLang: n,
                ...
                return n.createElement(ee, { ...Z,
                    ...
                    reference: function(e) {
                        X.current = e, "function" == typeof B && B(e), "object" == typeof B && (B.current = e)
                    },
                    onClick: function(e) {
                        E || (K && (0, i.trackEvent)(K.category, K.event, K.label), V && V(q, e), z || (e.currentTarget.dispatchEvent(new CustomEvent("popup-menu-close-event", {
                            bubbles: !0,
                            detail: {
                    ...
                    onMouseUp: function(e) {
                        if (1 === e.button && y && K) {
                            let e = K.label;
                            J && (e += "_mouseWheelClick"), (0, i.trackEvent)(K.category, K.event, e)
                        }
                    },
                    onMouseOver: A,
                    onMouseOut: _,
                    onKeyDown: S,
                    tabIndex: R
                }, j && n.createElement(a.CircleLogo, { ...H,
                    className: c["disclosure-item-circle-logo"],
                    size: "xxxsmall",
                    logoUrl: j.logoUrl,
                    placeholderLetter: "placeholderLetter" in j ? j.placeholderLetter : void 0
                }), $ && n.createElement("span", {
                ...
                }, D)), (void 0 !== v || g) && n.createElement("span", {
                    className: L.shortcut
                }, (te = v) && te.split("+").join(" + ")), void 0 !== F && n.createElement("span", {
                    role: P,
                    onClick: Q ? u : void 0,
        ...
        20520: (e, t, o) => {
            ...
            function p(e) {
                const {
                    ...
                    ...w
                } = e, E = (0, n.useContext)(l.CloseDelegateContext), k = n.useContext(u), C = (0, n.useContext)(c), D = (0, d.useOutsideEvent)({
                    handler: function(e) {
                        if (f && f(e), !h) return;
                ...
                return p ? n.createElement(s.Portal, {
                    top: "0",
                    left: "0",
                    right: "0",
                    bottom: "0",
        ...
        86656: (e, t, o) => {
            ...
            const c = (0, n.forwardRef)(((e, t) => {
                ...
                return (0, n.useImperativeHandle)(t, (() => c.current)), (0, n.useLayoutEffect)((() => {
                    if (s.CheckMobile.iOS()) return l++, null !== c.current && (a ? 1 === l && (document.body.style.overscrollBehavior = "none") : (0, r.disableBodyScroll)(c.current, {
                        allowTouchMove: d(c)
                    })), () => {
                        l--, null !== c.current && (a ? 0 === l && (document.body.style.overscrollBehavior = "") : (0, r.enableBodyScroll)(c.current))
                    }
                }), []), n.createElement("div", {
                    ref: c,
                    ...i
        ...
        73607: (e, t, o) => {
            ...
            function c(e) {
                ...
                const d = m(l),
                    ...
                    v = -1 !== f,
                    g = e => {
                        o && (0, r.becomeSecondaryElement)(o), (0, r.becomeMainElement)(e), e.focus()
                    };
                switch ((0, n.mapKeyCodeToDirection)(t)) {
                    case "inlinePrev":
                        if (!d.length) return;
                        e.preventDefault(), g(0 === f ? s[c] : v ? u(d, f, -1) : d[d.length - 1]);
                        break;
                    case "inlineNext":
                        if (!d.length) return;
                        e.preventDefault(), f === d.length - 1 ? g(s[c]) : g(v ? u(d, f, 1) : d[0]);
                        break;
                    case "blockPrev":
                        {
                            e.preventDefault();
            ...
            function h(e) {
                return Array.from(e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])')).filter((0, s.createScopedVisibleElementFilter)(e))
            }

            function m(e) {
                return Array.from(e.querySelectorAll("[tabindex]:not([disabled]):not([aria-disabled])")).filter((0, s.createScopedVisibleElementFilter)(e))
            }
        },
        33647: (e, t, o) => {
            "use strict";
        ...
        90397: (e, t, o) => {
            ...
            function d(e) {
                const {
                    ...
                    reference: o,
                    ...r
                } = e, [d, u] = (0, a.useRovingTabindexElement)(o ? ? null);
                return n.createElement(l.PopupMenuItem, { ...r,
                    ...
                    onKeyDown: function(e) {
                        ...
                        13 !== t && 32 !== t || (e.preventDefault(), d.current instanceof HTMLElement && d.current.click())
                    },
                    "data-role": "menuitem",
            ...
            function c(e, t) {
                return o => {
                    const {
                        ...
                        contentHeight: d,
                        availableHeight: u
                    } = o, p = (0, a.ensureNotNull)(e).getBoundingClientRect(), {
                    ...
                    b === n.AutoStrict && (u < p.y + p.height + v + d ? (b = n.Top, x = i.FromBottomToTop) : (b = n.Bottom, x = i.FromTopToBottom));
            ...
            const a = s,
                l = n.forwardRef(((e, t) => {
                    const {
                        ...
                        [w.clicked]: f,
                        [w.pressed]: O
                    }), F = a && ("string" == typeof a ? n.createElement(i.Icon, {
                        className: w.icon,
                        icon: a
                    }) : n.cloneElement(a, {
                        className: r(w.icon, a.props.className)
                    }));
                    return "button" === o ? n.createElement("button", { ...T,
                        ref: t,
                        type: "button",
                    ...
                    }, g), F, !b && g && n.createElement("div", {
                        className: r("js-button-text", w.text)
                    }, g), M) : n.createElement("div", { ...T,
                        ref: t,
                        "data-role": "button",
                        className: N,
                        onClick: u ? void 0 : v,
        ...
        54374: (e, t, o) => {
            ...
            class b extends r.PureComponent {
                constructor(e) {
                    super(e), this._wrapperRef = null, this._controller = r.createRef(), this._onPopupCloseOnClick = e => {
                        "keyboard" === e.detail.clickType && this.focus()
                    }, this._handleMenuFocus = e => {
                        e.relatedTarget === this._wrapperRef && this.setState((e => ({ ...e,
                            isOpenedByButton: !0
                        }))), this.props.onMenuFocus ? .(e)
                    }, this._handleWrapperRef = e => {
                        this._wrapperRef = e, this.props.reference && this.props.reference(e)
                    }, this._handleOpen = () => {
                        "div" !== this.props.tag && (this.setState((e => ({ ...e,
                            isOpenedByButton: !1
                        }))), this.props.menuReference ? .current ? .addEventListener("popup-menu-close-event", this._onPopupCloseOnClick), this._controller.current ? .focus())
                    }, this._handleClick = e => {
                        (f.enabled("skip_event_target_check") || e.target instanceof Node) && e.currentTarget.contains(e.target) && (this._handleToggleDropdown(void 0, (0, v.isKeyboardClick)(e)), this.props.onClick && this.props.onClick(e, !this.state.isOpened))
                        ...
                        const {
                            ...
                            isOpened: r
                        } = this.state, i = "boolean" == typeof e ? e : !r;
                        this.setState({
                            isOpened: i,
                        ...
                        const o = (0, a.hashFromEvent)(e);
                        if (e.currentTarget.contains(e.target)) switch (o) {
                            case 40:
                                ...
                                case 27:
                                    {
                                        ...
                                        const {
                                            shouldReturnFocus: t,
                                            isOpenedByButton: o
                                        } = this.state;this._handleToggleDropdown(!1),
                ...
                render() {
                    ...
                    return "button" === e ? r.createElement("button", {
                        type: "button",
                        id: t,
                        className: s()(E, f.accessible),
                        disabled: i,
                        ...
                        tabIndex: g,
                        ...(0, d.filterDataProps)(this.props),
                        ...(0, d.filterAriaProps)(this.props)
                    }, k, o && r.createElement("div", {
                        className: f.arrow
                    }, r.createElement("div", {
                        className: f.arrowWrap
                    }, r.createElement(c.ToolWidgetCaret, {
                        dropped: w
                    }))), this.state.isOpened && (v ? r.createElement(m.MatchMedia, {
                        rule: v
                    }, (e => this._renderContent(e))) : this._renderContent(a))) : r.createElement("div", {
                        id: t,
                        className: E,
                ...
                close() {
                    this.props.menuReference ? .current ? .removeEventListener("popup-menu-close-event", this._onPopupCloseOnClick), this._handleToggleDropdown(!1)
                }
                focus() {
                ...
                _renderContent(e) {
                    ...
                    }, v = Boolean(m && e && a), g = x(c) ? c({
                        isDrawer: v
                    }) : c;
                    return v ? r.createElement(u.DrawerManager, null, r.createElement(p.Drawer, {
                        reference: this.props.drawerReference,
                        onClose: this._handleClose,
                        position: a,
                        "data-name": t
                    }, g)) : r.createElement(l.PopupMenu, {
