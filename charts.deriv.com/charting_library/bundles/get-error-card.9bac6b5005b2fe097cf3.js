    ...
    [139], {
            ...
            const c = o.createContext({
                ...
                d = (t, e, r) => {
                    const i = (0, o.useContext)(n.CustomBehaviourContext),
                        ...
                        k = t[`typography-${((t,e,r)=>{if(r){const t=r.replace(/^\D+/g,"");return e?`semibold${t}`:r}switch(t){case"xsmall":return e?"semibold14px":"regular14px";case"small":case"medium":return e?"semibold16px":"regular16px";default:return""}})(y,u||S,w||void 0)}`],
                        E = (0, o.useContext)(s.ControlGroupContext),
                        {
                            isInButtonGroup: V,
                            isGroupPrimary: H
                        } = (0, o.useContext)(c);
                    return a()(d, t.lightButton, b && t.link, _ && t.active, u && t.selected, (0, l.isIconOnly)(p, v) && t.noContent, !!A && t.withStartSlot, (h || !!W) && t.withEndSlot, r && t.withGrouped, m && t[m], t[H ? "primary" : C], t[H ? "gray" : g], t[y], k, !x && t.disableActiveStateStyles, E.isGrouped && t.grouped, f && t.wrap, V && t.disableActiveOnTouch, S && t.pills)
                }
        },
        66860: (t, e, r) => {
            "use strict";
            r.d(e, {
                LightButtonContent: () => m
            });
            var o = r(50959),
                i = r(97754),
                a = r.n(i),
                ...
                u = r(78457),
                p = r.n(u);
            const h = t => o.createElement(s.Icon, {
            ...
            function m(t) {
                ...
                return [u, e].filter((t => !!t)), o.createElement(o.Fragment, null, m && o.createElement("span", {
                    className: a()(p().slot, p().startSlot)
                }, m), !(0, l.isIconOnly)(d, r) && o.createElement("span", {
                    className: a()(p().content, !s && p().nowrap, "apply-overflow-tooltip", "apply-overflow-tooltip--check-children-recursively", "apply-overflow-tooltip--allow-text"),
                    "data-overflow-tooltip-text": c ? ? (0, n.getTextForTooltip)(d)
                }, s || i ? o.createElement(o.Fragment, null, o.createElement("span", {
                    className: a()(!s && i && p().ellipsisContainer, s && p().textWrapContainer, s && i && p().textWrapWithEllipsis)
                }, d), o.createElement("span", {
                    className: p().visuallyHidden,
                    "aria-hidden": !0
                }, d)) : o.createElement(o.Fragment, null, d, o.createElement("span", {
                    className: p().visuallyHidden,
                    "aria-hidden": !0
                }, d))), u && o.createElement("span", {
        ...
        15893: (t, e, r) => {
            ...
            function u(t) {
                const {
                    isGrouped: e
                } = o.useContext(i.ControlGroupContext), {
                    reference: r,
                    className: l,
                    isSelected: c,
                    children: u,
                    ...
                    "--ui-lib-light-button-content-max-lines": O
                } : A;
                return o.createElement("button", { ...H,
                    className: (0, a.useLightButtonClasses)({ ...d(),
                        ...s()
                    }, {
                        className: l,
                        isSelected: c,
                    ...
                    style: L,
                    role: V
                }, o.createElement(n.LightButtonContent, {
                    showCaret: m,
        ...
        17946: (t, e, r) => {
            ...
            const o = (0, r(50959).createContext)({
        ...
        34094: (t, e, r) => {
            ...
            const i = t => (0, o.isValidElement)(t) && Boolean(t.props.children),
                a = (t, e = !0) => null == t || "boolean" == typeof t || "{}" === JSON.stringify(t) ? "" : t.toString() + (e ? " " : ""),
                n = t => Array.isArray(t) || (0, o.isValidElement)(t) ? o.Children.toArray(t).reduce(((t, e) => {
                    let r = "";
                    return r = (0, o.isValidElement)(e) && i(e) ? n(e.props.children) : (0, o.isValidElement)(e) && !i(e) ? "" : a(e), t.concat(r)
                }), "").trim() : a(t, !1)
        },
        81200: (t, e, r) => {
            "use strict";
            ...
            const x = a.forwardRef(((t, e) => {
                const {
                    ...
                    solutionId: s,
                    buttons: p
                } = t, h = a.useMemo((() => r && function(t, e) {
                    if (0 !== e) return y[t][e]
                }(r, i)), [r, i]), m = 2 === i ? "medium" : "xsmall", v = p ? p.map((t => a.createElement(u.LightButton, {
                    onClick: t.onClick,
                ...
                return a.createElement("div", {
                    ref: e,
                    className: c()(C.errorCard, 2 === i && C.errorCard_size_big, !l && C.errorCard_limitWidth),
                    "data-name": "error-card"
                }, h && a.createElement(d.Icon, {
                    icon: h,
                    className: C.errorCard__icon
            ...
            function w(t) {
                const {
                    ...
                    solutionId: u,
                    buttons: p
                } = t, h = a.useRef(null), [m, v] = a.useState(1);
                return a.useEffect((() => {
                    const t = h.current;
                    if (t) {
        ...
        2948: t => {
            t.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" width="18" height="18"><path fill="currentColor" d="M3.92 7.83 9 12.29l5.08-4.46-1-1.13L9 10.29l-4.09-3.6-.99 1.14Z"/></svg>'
        },
        79035: t => {
            t.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" width="120" height="120"><path fill="currentColor" d="m60 14-50 87h100L60 14Zm0 8.02L103.55 97h-87.1L60 22.02ZM58 75V51h4v24h-4Zm5 9a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/></svg>'
        },
        78080: t => {
            t.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" width="72" height="72"><path fill="currentColor" d="M36 10 7 58h58L36 10Zm0 3.9L61.2 56H10.8L36 13.9ZM35 44V30h2v14h-2Zm2.5 4.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/></svg>'
        },
        11425: t => {
