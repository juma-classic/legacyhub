(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [1727], {
        ...
        74670: (e, o, l) => {
            "use strict";
            l.d(o, {
                useActiveDescendant: () => n
            });
            var t = l(50959),
                i = l(39416);

            function n(e, o = []) {
                const [l, n] = (0, t.useState)(!1), a = (0, i.useFunctionalRefObject)(e);
                return (0, t.useLayoutEffect)((() => {
                    ...
                    return e.addEventListener("active-descendant-focus", o), e.addEventListener("active-descendant-blur", o), () => {
                        e.removeEventListener("active-descendant-focus", o), e.removeEventListener("active-descendant-blur", o)
                    }
                }), o), [a, l]
            }
        },
        ...
        36189: (e, o, l) => {
            ...
            function d(e) {
                const {
                    ...
                    title: m,
                    ...u
                } = e, [g, L] = (0, s.useActiveDescendant)(null), T = m ? ? (l ? r.removeTitlesMap[r.RemoveTitleType.Remove] : r.removeTitlesMap[r.RemoveTitleType.Add]);
                return (0, t.useLayoutEffect)((() => {
                    const e = g.current;
                    e instanceof HTMLElement && T && e.dispatchEvent(new CustomEvent("common-tooltip-update"))
                }), [T, g]), t.createElement(a.Icon, { ...u,
                    className: n()(h.favorite, "apply-common-tooltip", l && h.checked, i && h.active, L && h.focused, o),
                    onClick: d,
                    icon: l ? c : v,
                    title: T,
                    ariaLabel: T,
        ...
        73607: (e, o, l) => {
            ...
            function c(e) {
                ...
                const s = document.activeElement.closest('[data-role="menuitem"]') || document.activeElement.parentElement ? .querySelector('[data-role="menuitem"]');
                ...
                const v = u(s),
                    ...
                    L = -1 !== g,
                    T = e => {
                        l && (0, i.becomeSecondaryElement)(l), (0, i.becomeMainElement)(e), e.focus()
                    };
                switch ((0, t.mapKeyCodeToDirection)(o)) {
                    case "inlinePrev":
                        if (!v.length) return;
                        e.preventDefault(), T(0 === g ? a[c] : L ? h(v, g, -1) : v[v.length - 1]);
                        break;
                    case "inlineNext":
                        if (!v.length) return;
                        e.preventDefault(), g === v.length - 1 ? T(a[c]) : T(L ? h(v, g, 1) : v[0]);
                        break;
                    case "blockPrev":
                        {
                            e.preventDefault();
            ...
            function m(e) {
                return Array.from(e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])')).filter((0, a.createScopedVisibleElementFilter)(e))
            }

            function u(e) {
                return Array.from(e.querySelectorAll("[tabindex]:not([disabled]):not([aria-disabled])")).filter((0, a.createScopedVisibleElementFilter)(e))
            }
        },
        70173: (e, o, l) => {
            "use strict";
        ...
        84902: (e, o, l) => {
                ...
                c = [{
                    ...
                    sections: [{
                        items: [{
                            ...
                            name: "demonstration"
                        }, null].filter(r.isExistent)
                    }, {
                        items: [{
                            name: "eraser"
                        }, i.CheckMobile.any() ? null : {
                            type: "switcher",
                    ...
                    sections: [{
                        ...
                        items: [s ? {
                            name: "LineToolImage"
                        } : null, null, null].filter(r.isExistent)
                    }],
                    trackLabel: null
                }];
            ...
            const u = c.map((function(e) {
                return v(e) ? e.sections.map((e => e.items.filter(h))).flat() : e.items.filter(h)
            })).flat()
        },
        18117: (e, o, l) => {
            "use strict";
            ...
            const d = (0, v.humanReadableModifiers)(v.Modifiers.Shift, !1).trim(),
                ...
                g = {
                    keys: [d],
                    text: i.t(null, void 0, l(23369))
                },
                L = {
                    keys: [d],
                    text: i.t(null, void 0, l(13798))
                },
                T = {
                    keys: [d],
                ...
                w = {
                    ...
                    LineToolTable: {},
                    SyncDrawing: {
                        iconActive: r.drawingToolsIcons.SyncDrawingActive
                    },
                    arrow: {},
                    cursor: {},
                    dot: {},
                    ...
                    drawginmode: {
                        iconActive: r.drawingToolsIcons.drawginmodeActive
                    },
                    eraser: {},
                    group: {},
                    hideAllDrawings: {
            ...
            Object.entries(w).map((([e, o]) => {
                ...
                return (0, t.assert)(!!i, `Localized name is not defined for drawing "${e}"`), { ...o,
                    name: e,
                    icon: l,
                    localizedName: i,
        ...
        6519: (e, o, l) => {
            "use strict";
            l.d(o, {
                LinetoolsFavoritesStore: () => s
            });
            var t = l(48096),
                i = l(87465),
                n = l(1765);
            const a = ["LineToolBalloon", "LineToolNoteAbsolute", null, null].filter(i.isExistent);
            var r, s;
            ! function(e) {
                function o() {
                    e.favorites = [];
                    let o = !1;
                    const t = Boolean(void 0 === (0, n.getValue)("chart.favoriteDrawings")),
                        r = (0, n.getJSON)("chart.favoriteDrawings", []);
                    if (0 === r.length && t && "undefined" != typeof window) {
                        const e = JSON.parse(window.urlParams ? .favorites ? ? "{}").drawingTools;
                        e && Array.isArray(e) && r.push(...e)
                    }
                    r.forEach(((t, i) => {
                        const n = t.tool || t;
                        l(n) && (a.includes(n) ? o = !0 : e.favorites.push(n))
                    })), o && i(), e.favoritesSynced.fire()
                }
                ...
                e.favorites = [], e.favoritesSynced = new t.Delegate, e.hiddenToolsPositions = new Map, e.favoriteIndex = function(o) {
                    return e.favorites.indexOf(o)
                }, e.isValidLineToolName = l, e.saveFavorites = i, o(), n.onSync.subscribe(null, o)
            }(r || (r = {})),
            function(e) {
                function o(e) {
                ...
                e.favoriteAdded = new t.Delegate, e.favoriteRemoved = new t.Delegate, e.favoriteMoved = new t.Delegate, e.favoritesSynced = r.favoritesSynced, e.favorites = function() {
                    return r.favorites.slice()
                }, e.isValidLineToolName = o, e.favoritesCount = l, e.favorite = function(e) {
                    return e < 0 || e >= l() ? "" : r.favorites[e]
                }, e.addFavorite = function(l, t) {
                    return !(i(l) || !o(l) || "performance" === l || (r.favorites.push(l), r.saveFavorites(t), e.favoriteAdded.fire(l), 0))
                }, e.removeFavorite = function(o, l) {
                    const t = r.favoriteIndex(o);
                    if (-1 === t) return !1;
                    r.favorites.splice(t, 1);
                    const i = r.hiddenToolsPositions;
                    return i.forEach(((e, o) => {
                        e > t && i.set(o, e - 1)
                    })), r.saveFavorites(l), e.favoriteRemoved.fire(o), !0
                }, e.isFavorite = i, e.moveFavorite = function(t, i, n) {
                    if (i < 0 || i >= l() || !o(t)) return !1;
                    const a = r.favoriteIndex(t);
                    if (-1 === a || i === a) return !1;
                    const s = r.hiddenToolsPositions;
                    return s.forEach(((e, o) => {
                        a < e && i > e ? e-- : i < e && a > e && e++, s.set(o, e)
                    })), r.favorites.splice(a, 1), r.favorites.splice(i, 0, t), r.saveFavorites(n), e.favoriteMoved.fire(t, a, i), !0
                }
            }(s || (s = {}))
        },
        54780: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="currentColor"><path d="m11.26 21 3.65-4.78 6.09-.66L10 8zm3.09-5.71-2.33 3.05-.8-8.3 7.02 4.82z"/><path fill-rule="evenodd" d="M25 14a11 11 0 1 1-22 0 11 11 0 0 1 22 0m-1 0a10 10 0 1 1-20 0 10 10 0 0 1 20 0"/></svg>'
        },
        52459: e => {
