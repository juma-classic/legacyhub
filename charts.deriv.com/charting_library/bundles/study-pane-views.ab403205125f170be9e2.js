    ...
    [507], {
        17773: (t, e, i) => {
            ...
            class f extends h.MediaCoordinatesPaneRenderer {
                constructor(t) {
                    super(), this._data = null, this._backHittest = new o.HitTestResult(o.HitTarget.MovePointBackground), this._points = [], this._hittest = t ? ? new o.HitTestResult(o.HitTarget.MovePoint)
                }
                setData(t) {
                ...
                hitTest(t) {
                    ...
                    if (1 === i) return (0, s.pointInCircle)(t, this._points[0], e) ? this._hittest : null;
                    for (let s = 1; s < i; s++) {
                ...
                _drawImpl(t) {
                    ...
                    try {
                        if (void 0 !== this._data.globalAlpha && (e.globalAlpha = this._data.globalAlpha), 1 === i) return void this._drawPoint(e, this._points[0], this._data.linewidth / 2, this._data.color);
                        e.beginPath();
                        const t = this._data.linestyle === u.LINESTYLE_SOLID ? "round" : "butt",
                            s = this._data.linecap ? ? t;
                        e.lineCap = s, e.strokeStyle = this._data.color, e.lineWidth = this._data.linewidth, e.lineJoin = this._data.linejoin ? ? "round", (0, c.setLineStyle)(e, this._data.linestyle);
                        const r = this._points[0];
                        e.moveTo(r.x, r.y);
                        for (const t of this._points) e.lineTo(t.x, t.y);
                        if (this._data.filled && this._data.fillBackground && (e.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency), e.fill()), this._data.filled && !this._data.skipClosePath && e.closePath(), i > 1) {
                ...
                _updateViewInternal() {
                    ...
                    i.forEach(((t, i) => {
                        ...
                        t.forEach((t => {
                            ...
                            h === i - 1 && (d = l || d), l = c, h = o, d < 0 && c < 0 || d > e.width() && c > e.width() || this._data.push({
                                x1: d,
                                x2: c,
                                color: r.color.value(),
        ...
        70588: (t, e, i) => {
            ...
            class f {
                    ...
                    for (const s of i.histograms) {
                        ...
                        for (const a of s.bars) {
                            ...
                            for (let e = 0; e < a.subBarValues.length; e++) {
                                ...
                                if (f = o, (t.x >= n && t.x <= o || t.x >= o && t.x <= n) && t.y >= i && t.y <= s) return new h.HitTestResult(h.HitTarget.Regular)
                            }
                        }
                    }
                    return null
                ...
                draw(t, e) {
                    ...
                    t.save(), i.histograms.forEach((a => {
                        ...
                        if (p >= 7.5)
                            for (const i of u) i.fontSize = p, m(t, e, i)
                    })), t.restore()
                }
            }
            ...
            function v(t, e, i, s, r, a) {
                const {
                    ...
                    return {
                        fontSize: Math.min(Math.round(1.7 * t / i.length), Math.round(.6 * e)),
                        verticalOffset: .7 * e
                    }
                }(t, i, a), d = r.direction === n.HHistDirection.LeftToRight ? "left" : "right", {
                    xBasePoint: c,
                    sign: u
                } = s, p = c + 3 * u, f = e + h;
                return {
            ...
            function m(t, e, i) {
                ...
                t.font = `${n}px ${c.CHART_FONT_FAMILY}`, t.fillStyle = r, t.textAlign = a, (0, l.drawScaled)(t, e.horizontalPixelRatio, e.verticalPixelRatio, (() => t.fillText(s, o.x, o.y)))
            }
            var y, x = i(52859);
            ! function(t) {
            ...
            class w {
                constructor(t, e, i, s, r = !1, n = () => null, a = !1) {
                    this._invalidated = !0, this._histBoxBgStyle = null, this._provider = t, this._model = e, this._histBoxBgStyle = s ? ? null, this._alternateLeftIndex = n, this._extendToBarsEndings = r, this._alwaysVisible = a, this._rendererData = {
                        histograms: [],
                        styles: {}
                ...
                _resetRenderersData() {
                    this._rendererData.histograms = [], this._rendererData.styles = {}, this._rendererData.histBoxBgColor = void 0
                }
                _prepareStyles() {
                    ...
                    for (const n of e) {
                        ...
                        if (s) this._rendererData.styles[n + "UpDominate"] = {
                ...
                _updateViewInternal() {
                    ...
                    const n = s.firstBar(),
                        a = s.lastBar();
                    this._prepareStyles(), (0, r.ensureDefined)(i).forEach((i => {
                        let s = 1 / 0,
                            r = -1 / 0;
                        for (const t of i) {
                ...
                _updateDataForRenderers(t, e, i) {
                    ...
                    })), d.sort(((t, e) => t.y - e.y)), this._rendererData.histograms.push({
                        xRange: l,
        ...
        65212: (t, e, i) => {
            ...
            class o {
                constructor(t, e, i, s = !1, n = () => null) {
                    this._data = [], this._invalidated = !0, this._provider = t, this._model = e, this._extendToBarsEndings = s, this._alternateStartIndex = n, this._hitTestResult = void 0 !== i ? new r.HitTestResult(r.HitTarget.Custom, i) : new r.HitTestResult(r.HitTarget.Regular)
                }
                update(t) {
                    "hover-change" !== t.type && (this._invalidated = !0)
                }
