! function() {
    ...
    const qe = (e, t) => t,
        ...
        He = je([(e, t) => We(e, t).events.orderedIds, (e, t) => We(e, t).events.byIds], (e, t) => e.map(e => t[e]))(qe),
        Ve = je([We, He], (e, t) => T({}, e, {
            events: t
        }))(qe),
    ...
    Ne.createSelector([He, e => Ge(e).id], (e, t) => {
        ...
        var n
    }), je([(e, t) => We(e, t).participants, Re], (e, t) => e.map(e => t[e]))(qe);
    ...
    const St = () => {
        ...
        qt = (e, t) => Xe(e, "visibility").state === t;
    ...
    const Jt = T({}, Yt, {
            ...
            errorContrast: Ut[0],
            errorSurface: "#FFFAFA",
            subtleFeedback: Ht[50],
            subtleFeedbackContrast: Ut[900],
            caution: "#FFAE21",
            cautionDimmed: "#FFF3D6",
            cautionContrast: Ut[900],
            cautionDesaturated: Ht[25],
            chatBackground: "#F6F6F7",
            success: Rt[500],
            successContrast: Ut[0],
            successSurface: Ut[0],
            primaryTextColor: Ut[900],
            secondaryTextColor: Ut[550],
            tertiaryTextColor: Ut[400],
            surface: Ut[0],
            surfaceVariant: Ut[25],
            surfaceVariantHover: "#E6E6E6",
            surfaceInteractive: Ut[50],
            surfaceInteractivePressed: Ut[600],
            surfaceDecorative: Ut[100],
            surfaceDimmed: "#E6E4E1",
            surfaceFade: Ut[15],
            hintSurface: Ut[800],
            floatSurface: Ut[0],
            pressedElement: Ut[300],
            notification: Gt[500],
            notificationContrast: Ut[0],
            widgetBackground: Ut[50],
            disabled: Ut[100],
            disabledContrast: Ut[600],
            inactiveElement: Ut[450],
            formIconColor: Ut[50],
            trademarkFooterText: Ut[600],
            itemHover: Ut[625],
            successHover: "#2FA763",
            inactiveElementHover: Ut[425],
            secondaryButtonBackground: Ut[100],
            secondaryButtonBackgroundHover: Ut[200],
            primaryTimelineSurface: Ut[0],
            decorations: {
                decorOne: "#FFDAB9",
                decorTwo: "#D9CCFA",
                decorThree: "#FACCCC",
        ...
        Xt = T({}, Yt, {
            ...
            divider: Ut[700],
            error: Vt[100],
            errorContrast: Ut[900],
            errorSurface: "#570404",
            subtleFeedback: Ht[800],
            subtleFeedbackContrast: Ht[100],
            caution: Ht[100],
            cautionDimmed: "#322B24",
            cautionContrast: Ut[900],
            cautionDesaturated: Ht[700],
            chatBackground: "#1A1A1A",
            success: Rt[100],
            successContrast: Ut[900],
            successSurface: "#042602",
            primaryTextColor: Ut[0],
            secondaryTextColor: Ut[400],
            tertiaryTextColor: Ut[600],
            surface: Ut[800],
            surfaceVariant: Ut[700],
            surfaceVariantHover: "#333333",
            surfaceInteractive: Ut[700],
            surfaceInteractivePressed: Ut[400],
            surfaceDecorative: Ut[700],
            surfaceDimmed: "#1F1E1D",
            surfaceFade: Ut[700],
            hintSurface: Ut[550],
            floatSurface: Ut[700],
            pressedElement: Ut[600],
            notification: Gt[100],
            notificationContrast: Ut[900],
            widgetBackground: Ut[900],
            disabled: Ut[700],
            disabledContrast: Ut[400],
            inactiveElement: Ut[600],
            formIconColor: Ut[900],
            trademarkFooterText: Ut[400],
            itemHover: Ut[525],
            successHover: "#99DBB5",
            inactiveElementHover: Ut[800],
            secondaryButtonBackground: Ut[650],
            secondaryButtonBackgroundHover: Ut[625],
            primaryTimelineSurface: Ut[800],
            decorations: {
                decorOne: "#D7650F",
                decorTwo: "#400CC6",
                decorThree: "#AF3C3C",
    ...
    const en = ["group_id"],
        ...
        rn = e => ({
            id: e.id,
            fields: !("id" in e.fields[0]) ? on(e.fields) : nn(e.fields)
        }),
        an = {};
    ...
    function sn(e, t) {
        ...
        return new Promise((t, r) => {
            et().then(a => {
                ...
                const l = "__" + c;
                window[l] = e => {
                    delete an[c], delete window[l], tt(s), t(e)
                }, s.src = e + "?" + U(T({}, n, {
                    [i]: l
    ...
    const cn = ["buttons", "allowed_domains", "prechat_form", "ticket_form", "__priv", "properties"],
        ln = ["staticConfig", "localization"],
        dn = /\.([a-z]{1,})$/i,
        un = e => {
            let {
                __priv: t
        ...
        fn = (e, t) => pn(t) + "/v3.6/customer/action/" + e,
        gn = function(e, t) {
            let {
                validateDefaultWidget: n = !0
            } = void 0 === t ? {} : t;
            return sn(fn("get_dynamic_configuration", e), {
                query: T({}, mn(e), e.organizationId ? {
                    organization_id: e.organizationId
                } : {}, e.licenseId ? {
                    license_id: e.licenseId
                } : {}, {
                    client_id: null != "c5e4f61e1a6c3b1521b541bc5c5a2ac5" ? "c5e4f61e1a6c3b1521b541bc5c5a2ac5" : "",
                    url: ce(e.url, ["cw_configurator", "dev_language", "dev_enable_textapp", "dev_theme_variant", "dev_theme_name", "dev_minimized_type", "dev_screen_position", "dev_offset_x", "dev_offset_y", "dev_show_logo", "dev_show_avatar", "dev_sounds_enabled", "dev_rating_enabled", "dev_transcript_enabled", "dev_company_logo_url", "dev_agent_avatar_url"])
            ...
            return T({}, s, i && {
                ...
                __unsafeProperties: T({}, r.s && {
                    ...
                    group: {
                        ...
                        eyeCatcher: "1" === r.group["embedded_chat.display_eye_catcher"] ? un(e) : {
                            enabled: !1
                        },
                        hasAgentAvatarsEnabled: f,
                        ...
                        ratingEnabled: h,
                        screenPosition: b,
                        screenPositionOnMobile: vn(r.group["chat_window.mobile_screen_position"], ["right", "left"]),
                        transcriptButtonEnabled: v,
                        theme: {
                            name: d,
                            variant: u,
                    ...
                    helpdeskIntegrationEnabled: I,
                    ticketFormMode: (L = e, hn(L) ? "helpdesk" : "0" === L.__priv.group.tickets_enabled ? "offline_message" : "livechat")
                })
            });
            var L
        },
    ...
    function Tn(e, t, n, i) {
        ...
        const s = r.documentElement,
            c = O(s.querySelectorAll("[" + xn + "]"));
        for (const e of c) {
            const t = e.getAttribute(xn);
            if ("string" == typeof t)
                for (const n of t.split(";")) {
                    const [t, o] = n.split(":");
                    t && o && (e.removeAttribute(xn), e.addEventListener(t, n => {
                        ...
                        if ("click" === t && "copy" === e.getAttribute(En)) return h = e.getAttribute(In), navigator.clipboard ? navigator.clipboard.writeText(h).catch(bn) : bn(h), void(e.innerHTML = e.getAttribute(An));
                        var h;
                        i.call("crossFrameEvent", o, JSON.stringify(g))
                    }))
                }
        }
        const l = s.querySelector("[" + kn + "]");
        if (l && (l.removeAttribute(kn), l.focus(), "INPUT" === l.nodeName)) {
            l.setSelectionRange(l.value.length, l.value.length)
        }
        const d = [],
            u = O(s.querySelectorAll("[" + Cn + "]"));
        for (const e of u) {
        ...
        d.forEach(e => e(i.state)), i.off("state_diff", Ln), Ln = e => {
            var t;
    ...
    const Pn = e => {
        ...
        zn = e => e.replace(/\?+$/, ""),
        Sn = "cubic-bezier(0.25, 1, 0.5, 1)",
        On = "width 300ms " + Sn + ", height 300ms " + Sn,
        Mn = F ? 100 : 2e3;
    let Fn = null;
    const Dn = () => {
            if (Fn) throw Error("Title notification service already initialized");
            Fn = (() => {
                try {
        ...
        Nn = () => {
            if (!Fn) throw Error("Title notification service not initialized");
            return Fn
        },
        Bn = e => {
            var t, n;
        ...
        qn = e => {
            ye(function(e, t) {
                ...
                childList: !0,
                subtree: !0
            }), ke(jn), fe((e, t) => e.url === t.url), Fe(we(e, "unbind")), he(t => {
                e.call("storeMethod", ["setApplicationState", {
                    page: t
                }])
            }))
        };
    var Wn = "application/x-postmate-v1+json",
        Hn = 0,
        Vn = {
            handshake: 1,
            "handshake-reply": 1,
        ...
        Rn = function(e, t) {
            return ("string" != typeof t || e.origin === t) && (!!e.data && ("object" == typeof e.data && ("postmate" in e.data && (e.data.type === Wn && !!Vn[e.data.postmate]))))
        },
        Gn = function() {
            function e(e) {
                var t = this;
                this.parent = e.parent, this.frame = e.frame, this.child = e.child, this.childOrigin = e.childOrigin, this.events = {}, this.listener = function(e) {
                    if (!Rn(e, t.childOrigin)) return !1;
                    var n = ((e || {}).data || {}).value || {},
                        i = n.name;
            ...
            return t.get = function(e) {
                var t = this;
                return new Yn.Promise(function(n) {
                    var i = ++Hn,
                        o = function(e) {
        ...
        Yn = function() {
            ...
            return e.prototype.sendHandshake = function(t) {
                ...
                return new e.Promise(function(e, a) {
                    var s = function(t) {
                        return !!Rn(t, o) && ("handshake-reply" === t.data.postmate ? (clearInterval(n), i.parent.removeEventListener("message", s, !1), i.childOrigin = t.origin, e(new Gn(i))) : a("Failed handshake"))
                    };
    ...
    Yn.debug = !1, Yn.Promise = function() {
        try {
        ...
        return e.prototype.sendHandshakeReply = function() {
            var e = this;
            return new Yn.Promise(function(t, n) {
                var i = function(o) {
                    if (o.data.postmate) {
    ...
    const ni = (e, t) => ye(ti(e, t), ze(1));

    function ii(e) {
        return ye(ti(e, e => Xe(e, "availability")), ge(b))
    }
    const oi = "liveChatChatId";

    function ri(e) {
        return ye(ti(e, e => Ve(e, oi).active), ze(1), xe(t => t ? ye(ti(e, e => Ve(e, oi).properties.currentAgent), ge(Boolean), ke(() => t), Oe(1)) : Ie(t)))
    }
    ...
    function si(e, t) {
        return ye(ai(e, N), xe(t))
    }

    function ci(e, t) {
        return ye(ai(e, B), xe(t))
    }

    function li(e, t) {
        return ye(ti(e, e => Xe(e, "invitation")), ke(e => e[t]), ge(b), Ae, ge(e => {
            let [t, n] = e;
    ...
    const di = () => window.GoogleAnalyticsObject || "ga",
        ui = e => {
            let {
                event: t,
                label: n,
        ...
        pi = e => {
            ...
            if (t && "function" == typeof mi[t]) return i && "ga" === t ? "gaAll" : t;
        ...
        gi = () => window.mixpanel && "function" == typeof window.mixpanel.track && "function" == typeof window.mixpanel.register,
        hi = {
            googleAnalytics: e => {
                let {
                    trackerName: t
            ...
            mixpanel: () => {
                ...
                return e => {
                    ...
                    i && (o.register(i), !gi()) || t in fi && o.track(fi[t], n)
                }
            }
        };
    var vi = (e, t) => {
        ...
        ye(ti(e, e => Xe(e, "readyState")), ge(e => e === N), Oe(1), xe(() => ri(e)), ge(Boolean), he(() => {
            const {
                email: t,
                name: n
            } = Ge(e.state);
            ...
            ye(_e(we(e, "set_default_view"), we(e, "set_current_view")), ge(e => e.viewInfo && "Chat" === e.viewInfo.view && e.viewInfo.default === t), Fe(we(e, "unbind")), (n = () => {
                ...
                }(Ie(i), Ee), (o = ye(ti(e, e => qt(e, "maximized")), ge(Boolean)), s = void 0 === (a = (void 0 === r ? {} : r).size) ? 100 : a, function(e) {
                    return function(t, n) {
                        var i = [];
                        if (0 === t) {
                            var r, a, c = !1;
    ...
    const _i = e => {
        ...
        yi = () => {
            ...
            const i = () => {
                const n = k(t);
                return n ? (i = n, wi() - i.startTime + i.duration) : wi() - e;
                var i
            };
            return {
        ...
        xi = (e, t) => e && t ? Math.abs(t.startTime - e.startTime) : null,
        Ci = e => {
            if (!e) return null;
        ...
        Ei = () => {
            ...
            const e = bi().then(e => e ? S(e.filter(e => _(".livechatinc.com", e.attribution[0].containerSrc)).map(e => e.duration)) : null);
            return {
                getLogs: () => e.then(e => {
                    const t = (() => {
                        ...
                        n = ki("lc_bridge_init"),
                        i = ki("lc_bridge_ready");
                    return s(e => e && Number(e.toFixed(2)), {
                        timeFromTrackingStart: xi(t, i),
                        timeFromBridgeInit: xi(n, i),
                        timeFromDomContentLoaded: Ci(i),
    ...
    const Li = ["America/", "Europe/"],
        ...
        Pi = (e, t, n) => {
            ...
            if (i || !n.__unsafeProperties.s || !(() => {
                    ...
                    return Li.some(t => e.startsWith(t))
                })()) return;
            const o = t => Ti(t, e);
        ...
        Si = (e, t) => {
            ...
            return zi(e, t) ? n.screenPositionOnMobile : n.screenPosition
        },
        Oi = (e, t) => {
            const n = e.__unsafeProperties.group;
            return zi(e, t) ? {
        ...
        Mi = (e, t) => Object.keys(e.properties.license).some(n => e.properties.license[n][t]),
        Fi = (e, t, n) => {
            ...
            o.src = e, o.allow = Pn({
                allowAutoplay: !0,
                allowVideoConferencing: Mi(n, "microphone"),
                allowClipboardWrite: Mi(n, "clipboard_write"),
            ...
            const s = new BroadcastChannel(e.organizationId + (e.uniqueGroups && "number" == typeof e.group ? ":" + e.group : "") + ":detached_widget_visibility_broadcast_channel"),
                c = d(300, async function() {
                    ...
                    window.documentPictureInPicture.requestWindow(l).then(e => {
                        ...
                        e.document.body.style.backgroundColor = Kt[s.theme.variant].widgetBackground, e.document.body.style.color = Kt[s.theme.variant].primaryTextColor, n.addEventListener("pagehide", () => {
                            ...
                            d.textContent = i("cancel"), d.style.backgroundColor = Kt[o.theme.variant].secondaryButtonBackground, d.style.color = Kt[o.theme.variant].primaryTextColor, a.append(s, c, l, d), e.document.body.append(a), e.document.body.addEventListener("click", e => {
                                e.target === l && (t(), a.remove()), e.target === d && n()
                            })
                        })(e, () => {
                            i = "allow", t.call("setPipConsent", "allow"), e && Fi(r, e, s), a("picture_in_picture_consent_allowed")
                        }, () => {
                        ...
                        })(t.state, e, n), s, c), "allow" === i && Fi(r, e, s)
                    }).catch(A)
                });
            let u = !0;
    ...
    var Bi = (e, t, n) => {
            ...
            if (!i.enabled || ((e, t) => {
                    const n = e.__unsafeProperties.group;
                    return zi(e, t) ? n.disabledMinimizedOnMobile : n.disabledMinimized
                })(t)) return;
            let o, r;
            const a = e => {
                    const {
                ...
                c = () => {
                    ...
                    }), u.addEventListener("error", s), o.appendChild(c), o.appendChild(l), Ni(o, () => a(e.state)), document.body.appendChild(o), (() => {
        ...
        Hi = (e, t, n) => {
            ...
            return {
                ...
                hidden: !(e.actingAsDirectLink || i) && ((e => {
                    ...
                    return qi && t.hasCustomMobileSettings ? t.initiallyHiddenOnMobile : t.initiallyHidden
                })(n) || e.isMinimizedForcefullyDisabled),
                uniqueGroups: e.uniqueGroups,
                analytics: {
                    googleAnalytics: {
                        enabled: !!n.integrations.analytics,
                        trackerName: pi(e.gaParams)
                    },
                    kissmetrics: {
                ...
                iframeAddress: Wi(e, n)
            }
        },
        Vi = "chat-widget-exit-intent-overlay";
    let Ri;
    const Gi = e => {
        const t = document.getElementById(Vi);
        if (!t) return;
        t.style.opacity = "0";
        const n = () => {
        ...
        }]), window.removeEventListener("mouseover", Ri)
    };
    let Ui;
    const Yi = "liveChatChatId",
        Ji = {
            livechat: {
        ...
        Xi = (e, t) => {
            ...
            ye(ti(e, e => e.application.readyState), ge(e => e === N), Oe(1), he(() => {
    ...
    const Qi = function(e) {
        ...
        eo = "always visible",
        to = "always hide",
        no = "hide until it gets activated";
    ...
    function io(e, t, n) {
        return function(i) {
            ...
            const {
                trackerName: l
            } = t.analytics.googleAnalytics, d = !Ki(n.allowedDomains, document.location.href), u = [
                ...
                return s = r ? t ? to : no : eo, c = i ? o ? to : a ? n ? to : no : eo : s, {
                    desktopVisibility: s,
                    mobileVisibility: c
                }
                ...
                msg: "call history: " + (Zi.length > 0 ? Zi.map(e => {
                    let {
                        name: t,
                        args: n
                    } = e;
    ...
    function ro(e, t, n) {
        return ye(we(e, n), he(e => Qn(oo(t[n], e))))
    }
    ...
    const uo = "liveChatChatId",
        mo = function(e) {
            for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), i = 1; t > i; i++) n[i - 1] = arguments[i];
            return Qn(oo.apply(void 0, [e].concat(n)))
        };
    ...
    function po(e, t, n) {
        ...
        ye(function(e) {
            return ye(ti(e, e => qt(e, "maximized")), ge(b))
        }(e), he(() => mo(i.on_chat_window_opened))), ye(ci(e, () => function(e) {
            return ye(ti(e, e => qt(e, "minimized")), ze(1), ge(b))
        }(e)), he(() => mo(i.on_chat_window_minimized))), ye(function(e) {
            return ye(ti(e, e => qt(e, "hidden")), ge(b))
        }(e), he(() => mo(i.on_chat_window_hidden))), ye(ii(e), he(e => mo(i.on_chat_state_changed, {
            state: "online" === e ? "online_for_chat" : "offline"
        }))), ye(ci(e, () => ri(e)), ge(b), he(() => mo(i.on_chat_started, {
            agent_name: Ue(e.state, Ve(e.state, uo).properties.currentAgent).name
        }))), ye(ci(e, () => ri(e)), ge(y), he(() => mo(i.on_chat_ended))), ye(ci(e, () => we(e, "on_message")), he(e => mo(i.on_message, e))), ye(we(e, "widget_resize"), he(e => {
            let {
                size: t
            } = e;
            return mo(i.on_widget_resize, t)
        })), ye(function(e) {
        ...
        })), ro(e, i, "on_postchat_survey_submitted"), ro(e, i, "on_prechat_survey_submitted"), ro(e, i, "on_rating_comment_submitted"), ro(e, i, "on_rating_submitted"), ro(e, i, "on_ticket_created"), i.set_custom_variables = t => {
            Qi("LC_API.set_custom_variables", t), co(e, ao(t))
        }, i.update_custom_variables = t => {
            Qi("LC_API.update_custom_variables", t), so(e, {
                properties: ao(t)
            })
        }, i.set_visitor_name = t => {
            Qi("LC_API.set_visitor_name", t), so(e, {
                name: lo(t)
            })
        }, i.set_visitor_email = t => {
            Qi("LC_API.set_visitor_email", t), so(e, {
                email: lo(t)
            })
        }, i.open_chat_window = i.show_full_view = i.open_mobile_window = () => {
            Qi("LC_API.open_chat_window"), e.maximize()
        }, i.minimize_chat_window = () => {
            Qi("LC_API.minimize_chat_window"), _i(t) || e.minimize()
        }, i.hide_eye_catcher = () => {
            Qi("LC_API.hide_eye_catcher"), e.call("hideEyeCatcher")
        }, i.hide_chat_window = () => {
            Qi("LC_API.hide_chat_window"), _i(t) || e.hide()
        }, i.agents_are_available = () => (Qi("LC_API.agents_are_available"), "online" === Xe(e.state, "availability")), i.chat_window_maximized = () => (Qi("LC_API.chat_window_maximized"), qt(e.state, "maximized")), i.chat_window_minimized = () => (Qi("LC_API.chat_window_minimized"), qt(e.state, "minimized")), i.chat_window_hidden = () => (Qi("LC_API.chat_window_hidden"), qt(e.state, "hidden")), i.visitor_queued = () => (Qi("LC_API.visitor_queued"), Ve(e.state, uo).properties.queued), i.chat_running = () => (Qi("LC_API.chat_running"), Ve(e.state, uo).active), i.visitor_engaged = () => (Qi("LC_API.visitor_engaged"), i.visitor_queued() || i.chat_running() || !!Ve(e.state, uo).properties.fakeAgentMessageId), i.get_window_type = () => (Qi("LC_API.get_window_type"), "embedded"), i.close_chat = () => {
            Qi("LC_API.close_chat"), e.call("storeMethod", ["requestUpdateChat", uo, {
                active: !1
            }])
        }, i.diagnose = io(e, t, n), i.get_last_visit_timestamp = () => Xe(e.state).clientLastVisitTimestamp, i.get_visits_number = () => Xe(e.state).clientVisitNumber, i.get_page_views_number = () => Xe(e.state).clientPageViewsCount, i.get_chats_number = () => Xe(e.state).clientChatNumber, i.get_visitor_id = () => Ge(e.state).serverId, i.get_chat_id = () => Ve(e.state, uo).serverId, i.trigger_sales_tracker = (e, t) => {
            const n = o(t) ? t : [];
    ...
    const fo = {
        ...
        go = ["trackerId", "orderId", "orderPrice"],
        ho = "liveChatChatId",
        vo = e => {
            let {
                trackerId: t,
            ...
            return w(Wt(e, go)) || console.warn("When using trigger_sales_tracker, you can only pass 'trackerId', 'orderId' and 'orderPrice' as keys"), s(String, l({
    ...
    function bo(e, t, n) {
        ...
        function f(e, t) {
            Qi("LiveChatWidget.on", "'" + e + "'", t), p("on", e, t)
        }

        function g(e, t) {
            Qi("LiveChatWidget.once", "'" + e + "'", t), p("once", e, t)
        }
        ...
        function v(e) {
            return Qi("LiveChatWidget.get", "'" + e + "'"), h(e)
        }

        function w(n, i) {
            switch (Qi.apply(void 0, ["LiveChatWidget.call", "'" + n + "'"].concat(i)), n) {
                case "hide":
                case "maximize":
                case "minimize":
                    if (_i(t)) return;
        ...
        void 0 === (m = d.other) && (m = []), m.forEach(e => {
            ...
            const {
                ...
                switch (n) {
                    ...
                    case "trigger_sales_tracker":
                        return e.mode = "set", e.properties = vo(i), e;
                    case "update_session_variables":
        ...
        })(d.fields), o._q = [], o._h = r, o.scriptTagVersion = () => o._v, o.diagnose = io(e, t, n), ye(ai(e, B), he(() => {
            ! function() {
        ...
        })), ye(ci(e, () => ii(e)), he(e => a("availability_changed", {
            availability: e
        }))), ye(ci(e, () => ni(e, () => h("state").visibility)), he(e => {
            a("visibility_changed", {
                visibility: e
            })
        })), ye(ci(e, () => ni(e, () => h("customer_data").status)), he(e => a("customer_status_changed", {
            status: e
        }))), ye(ci(e, () => li(e, "hiddenIds")), ke(t => wo(e, t)), ge(b), he(e => a("greeting_hidden", _o(e)))), ye(ci(e, () => li(e, "displayedIds")), ke(t => wo(e, t)), ge(b), he(e => a("greeting_displayed", _o(e)))), ye(we(e, "on_rating_submitted"), he(e => a("rating_submitted", e))), ye(_e(we(e, "add_event"), we(e, "send_event")), ge(e => {
            let {
                event: t
            } = e;
    ...
    var xo = e => {
            ...
            const i = () => {
                const e = t.content,
                    i = (o = document.body, Object.keys(ko).reduce((e, t) => (e[t] = o.style[t], e), {}));
                var o;
                const {
                    scrollTop: r
                } = document.documentElement;
                return t.content = "width=device-width, initial-scale=1.0, maximum-scale=1.0", Ke(ko, document.body), () => {
                    n = null, Ke(i, document.body), t.content = e, document.documentElement.scrollTop = r
                }
            };
            qt(e.state, "maximized") && (n = i()), ye(ti(e, e => qt(e, "maximized")), Ae, Se({
                next: e => {
                    let [, t] = e;
                    t ? n = i() : n()
                },
    ...
    function Ao(e, t) {
        return null != t && null != e && "object" == typeof t && "object" == typeof e ? Lo(t, e) : e
    }
    ...
    function Lo(e, t) {
        ...
        if (Array.isArray(e)) {
            ...
            for (let e = 0; t.length > e; e++) void 0 !== t[e] && (i[e] = Ao(t[e], i[e]))
        } else {
            i = T({}, e);
            for (const e in t) n(e, t) && (void 0 === t[e] ? delete i[e] : i[e] = Ao(t[e], i[e]))
        }
        return i
    }
    ...
    const Po = F ? 0 : 300,
        ...
        Fo = e => {
            ...
            const i = null == e || null == (t = e.__unsafeProperties) || null == (t = t.group) || null == (t = t.theme) ? void 0 : t.name;
            let o = "default";
            return (null == e || null == (n = e.__unsafeProperties) ? void 0 : n.enableTextApp) || !1 ? o = "ta-default" : "modern" === i && (o = "modern"), (e => {
                switch (e) {
                    case "ta-large":
                        return {
                            width: "640px",
        ...
        No = e => e.style.setProperty("transition", "none", "important"),
        Bo = e => {
        ...
        qo = (e, t, n, i, o, r, a, s, c) => {
            var d, m;
            let p = U(l(T({}, t.license && {
            ...
            const f = {
                    ...
                    resize(t) {
                        ...
                        const c = {
                            ...
                            l = Do(r, n, a);
                        e.element.style.transition = s ? On : "none", Ke(T({}, c, l), e.element);
                        const d = Qe(["width", "height"], e.element);
                        this._emit("widget_resize", {
                            size: c,
                            computedSize: d
                        })
                    ...
                    unbind() {
                        this.hide(), this.destroy(), this._emit("unbind"), this.off(), this.call = A, Object.keys(f).forEach(e => {
                            this[e] = A
                        })
                    },
                    ...
                    renderCrossFrameMarkup(t) {
                        ...
                        }), o), e.element.appendChild(o), e.element.appendChild(Bo("polite")), e.element.appendChild(Bo("assertive")), o.contentDocument.fonts.ready.then(() => this.emit("minimized_frame_fonts_ready")).catch(A)), Tn(n, i, o, this)
                    },
                    renderLightboxMarkup(e) {
                        ...
                        } : i.contentDocument.addEventListener("keydown", this.handleLightboxKeydown)), Tn(t, n, i, this)
                    },
                ...
                h = new MutationObserver(t => t.forEach(t => {
                    const n = u(e => "IFRAME" === e.tagName && e.getAttribute("src") === g, t.addedNodes);
                    n && ((e, t, n) => {
                        $e(T({}, ht, {
            ...
            if ("openwidget" === a) {
                var _;
                v = !!(null == (_ = n.features.find(e => "forms" === e.name)) || null == (_ = _.properties) || null == (_ = _.templates) ? void 0 : _.bugreport)
            }
            return new Xn({
                container: e.element,
                url: g,
                methods: f,
                iframeAllowedProperties: Pn({
                    allowAutoplay: !0,
                    allowVideoConferencing: Mi(n, "microphone"),
                    allowClipboardWrite: Mi(n, "clipboard_write"),
                    allowDisplayCapture: v
                }),
                model: T({}, t, {
                    fullWidth: null == (d = e.size) ? void 0 : d.width,
                    fullHeight: null == (m = e.size) ? void 0 : m.height,
                    serverConfig: n,
            ...
            }).then(e => Promise.all([e, To(e)])).then(e => {
                let [t] = e;
                return h.disconnect(), t
            })
        },
        Wo = (e, t, n, i, o, r) => {
            e.call("storeMethod", ["setLocalization", i]), (e => {
                ...
                })(e), n.custom || Ni(n.element, () => qt(e.state, "hidden")), Mo || "wix" === t.integrationName || Bi(e, o, i), No(e.frame),
                function(e, t, n) {
                    po(e, t, n), ("LiveChatWidget" in window || "OpenWidget" in window) && bo(e, t, n)
                }(e, t, o), vi(e, t), ye(si(e, () => ((e => {
                    St().then(t => {
                    ...
                    Kn.addEventListener(Kn.Events.PAGE_NAVIGATION, () => {
                        $n().then(t => e.call("storeMethod", ["setApplicationState", {
                            page: t
                        }]))
                    })
                })(e) : (Co(e), "openwidget" === r && qn(e), Xi(e, r)), ji(e), "livechat" === r && ("documentPictureInPicture" in window && (e => {
                    var t;
                    return !!(null == (t = e.properties.license.bb9e5b2f1ab480e4a715977b7b1b4279) ? void 0 : t.detached_mode_enabled)
                })(o) && Di(t, e), (e => {
                    ye(ti(e, e => Xe(e).showTextSelectionTracking), ge(Boolean), Oe(1), he(() => {
                        Oo(e)
                    }))
                })(e), (e => {
                    const {
                    ...
                    ye(a, Fe(we(e, "unbind")), he(t => {
                        !t && Ve(e.state, Yi).active ? o = Date.now() : o && (r = Date.now() - o)
                    ...
                    }), ge(() => !!r && Ve(e.state, Yi).properties.ended), Oe(1), he(() => {
            ...
            t.actingAsDirectLink || n.custom || function(e) {
                    ye(ti(e, e => qt(e, "hidden")), ze(1), he(t => {
                ...
                function(e) {
                    ...
                    e.on("unbind", n)
                }(e), Ai(e, o), Mo && !n.custom && xo(e), Io(e), e.on("rich_greeting_button_clicked", e => {
                    let {
                        button: t
                    } = e;
                    "url" === t.type && fo.navigate(t.value, "current" === t.target ? "_parent" : "_blank")
                    ...
                    const t = ((e, t) => {
                        ...
                        return window && (Ui && window.removeEventListener("mouseout", Ui), window.addEventListener("mouseout", n), Ui = n), () => {
                    ...
                    ((e, t) => {
                        ...
                        n.id = Vi, Ke((e => ({
                            ...
                            n.style.opacity = "1"
                        }, 0), Ri && window.removeEventListener("mouseover", Ri), Ri = () => Gi(t), window.addEventListener("mouseover", Ri)
                    })(Si(o, !1), e)
        ...
        Ho = e => (e => {
            ...
            return sn("https://api.livechatinc.com/global-mapper/" + (t ? "lc_license_id/" + t : "organization_id/" + n) + "/region", {
            ...
            }, sn(fn("get_configuration", n), {
                callbackName: "lc_static_config",
                query: T({
                    organization_id: n.organizationId,
                    version: n.version
                }, mn(n), "number" == typeof n.groupId && {
                    group_id: n.groupId
                })
            }).then(e => wn(e)))]).then(e => {
                let [t, n] = e;
    ...
    var Vo = (e, t) => {
        ...
        const {
            ...
            url: zn(document.location + "")
        }, "number" == typeof s && {
            groupId: s
        }, "string" == typeof o && {
            region: o
        }), h = "livechat" === i ? Ho(g).catch(e => {
            if ("DEFAULT_WIDGET_NOT_LIVECHAT" === e.code && "openwidget" === e.defaultWidget) return i = e.defaultWidget, window.__ow = window.__ow || {}, window.__ow.organizationId = e.organizationId, window.OpenWidget = T({}, window.LiveChatWidget), yn(e.organizationId, u, null, d);
            throw e
        }) : yn(a, u, f, d, g.url);
        Promise.all([h, "wix" === u ? $n() : jn(), et()]).then(e => {
            let [o, r, a] = e;
            if (!Ki(o.allowedDomains, window.top === window ? window.location.hostname : document.referrer)) return void console.log("[LiveChat] Current domain is not added to the allowed domains. LiveChat has been disabled.");
            if ("openwidget" === i && !1 === o.isWidgetEnabled) return;
            if (Mo && o.__unsafeProperties.group.disabledOnMobile && !t.actingAsDirectLink) return;
            const s = Ei(),
                c = (e => {
                ...
                m = ((e, t) => e.customContainer ? {
                    ...
                    custom: !1,
                    element: jo(t, e.actingAsDirectLink),
                    size: Fo(t)
                })(t, o),
                f = "true" === te("new_minimized_layout", window.location.search),
                g = "true" === te("new_predicted_agent", window.location.search),
                h = {};
            let v = !1;
            const _ = $i("on_before_load"),
                w = $i("on_after_load");
            _(e => {
                e.disable_sounds = A, e.mobile_is_detected = () => Mo, e.chat_running = () => !1, e.visitor_engaged = () => !1, e.agents_are_available = () => -1 !== o.onlineGroupIds.indexOf(o.groupId), e.get_window_type = () => "embedded", e.hide_chat_window = _i(u) ? A : () => v = !0, e.set_visitor_name = e => h.name = lo(e), e.set_visitor_email = e => h.email = lo(e), e.set_custom_variables = e => h.properties = e ? ao(e) : {}, e.update_custom_variables = e => {
                    e && (h.properties = T({}, h.properties, ao(e)))
                }
            });
            const y = T({}, u, o.licenseId && {
                license: o.licenseId
            }, {
                customer: T({}, u.customer, h),
                hidden: u.hidden || v,
                organizationId: o.organizationId
            });
            var b;
            m.custom || a.appendChild(m.element), window.performance && "function" == typeof window.performance.mark && window.performance.mark("lc_bind_child"), Promise.all([qo(m, y, o, c, d, null, i, f, g), "openwidget" === i ? Promise.resolve(o.localization) : (b = {
            ...
            }, sn(fn("get_localization", b), {
                callbackName: "lc_localization",
                query: T({
                    organization_id: b.organizationId,
                    version: b.version,
                    language: b.language
                }, mn(b), "number" == typeof b.groupId && {
                    group_id: b.groupId
                })
            }).then(e => x(e => e.toLowerCase(), e)))]).then(e => {
                let [t, n] = e;
                return m.custom || No(m.element), Wo(t, y, m, n, o, i), ye(ti(t, e => Xe(e, "readyState")), ge(e => e === N), Oe(1), ke(() => t), De)
            }).then(e => {
    ...
    function Ro() {
        et().then(e => {
            ["https://cdn.livechatinc.com/widget/static/js/configurator.VVwe8T5n.js"].forEach(t => {
                ((e, t) => {
    ...
    const Go = (e, t) => {
            ...
            return Array.isArray(t) && (n.properties = ao(t)), n
        },
        Uo = e => {
            if (e.wix) return "wix";
        ...
        Yo = () => {
            ...
            const e = {
                ...
                iframeAddress: null,
                region: _(t.region, (n = q, a(n).map(e => n[e]))) ? t.region + "" : null
            };
            var t, n;
            e.actingAsDirectLink || !(te(de, window.location.search) || R("session") && window.sessionStorage.getItem(de)) ? Vo("livechat", e) : Ro()
        };
    window.__lc_inited || Yo()
}();