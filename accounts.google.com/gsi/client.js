...
(function(_) {
    ...
    try {
        ...
        (0, _._F_toggles_initialize)([0x20000000, 0x15b00, ]);
        ...
        _.v.prototype.Z = function() {
            return this.g
        };
        _.v.prototype.getNextAddress = _.v.prototype.Z;
        _.v.prototype.V = function() {
            return this.i
        };
        _.v.prototype.getYieldResult = _.v.prototype.V;
        ...
        _.v.prototype.ca = function(a) {
            this.j = {
                X: a
            };
            this.g = this.o
        };
        _.v.prototype.jumpThroughFinallyBlocks = _.v.prototype.ca;
        ...
        _.v.prototype.ra = function(a, b) {
            a = _.u(a);
            var c = a.next();
            _.na(c);
            if (c.done) this.i = c.value, this.g = b;
            else return this.v = a, this.h(c.value, b)
        };
        _.v.prototype.yieldAll = _.v.prototype.ra;
        ...
        _.v.prototype.ka = function(a) {
            this.B = 0;
            this.o = a || 0
        };
        _.v.prototype.setFinallyBlock = _.v.prototype.ka;
        _.v.prototype.I = function(a, b) {
            this.g = a;
            this.B = b || 0
        };
        _.v.prototype.leaveTryBlock = _.v.prototype.I;
        ...
        _.v.prototype.K = function(a, b, c) {
            c ? this.H[c] = this.j : this.H = [this.j];
            this.B = a || 0;
            this.o = b || 0
        };
        ...
        _.v.prototype.S = function(a, b) {
            ...
            (b = this.j = this.j || b) ? b.Zc ? this.g = this.B || this.o : b.X != void 0 && this.o < b.X ? (this.g = b.X, this.j = null) : this.g = this.o: this.g = a
        };
        ...
        t("Promise", function(a) {
            ...
            e.prototype.D = function(g) {
                if (g === this) this.l(new TypeError("i"));
            ...
            e.prototype.then = function(g, h) {
                function k(q, r) {
                    return typeof q == "function" ? function(x) {
                        try {
                            n(q(x))
                        } catch (A) {
                            m(A)
            ...
            e.race = function(g) {
                return new e(function(h, k) {
                    for (var n = _.u(g), m = n.next(); !m.done; m = n.next()) c(m.value).ob(h, k)
                })
            };
            e.all = function(g) {
                var h = _.u(g),
                ...
                return k.done ? c([]) : new e(function(n, m) {
                    ...
                    var q = [],
                        r = 0;
                    do q.push(void 0), r++, c(k.value).ob(p(q.length - 1), m), k = h.next(); while (!k.done)
                })
            };
            return e
        });
        ...
        t("WeakMap", function(a) {
            ...
            h.prototype.delete = function(k) {
                return c(k) &&
                    la(k, f) && la(k[f], this.g) ? delete k[f][this.g] : !1
            };
            return h
        });
        t("Map", function(a) {
            ...
            c.prototype.set = function(h, k) {
                ...
                n.entry ? n.entry.value = k : (n.entry = {
                    ...
                    key: h,
                    value: k
                }, n.list.push(n.entry), this[1].qa.next = n.entry, this[1].qa = n.entry, this.size++);
                return this
            };
            c.prototype.delete = function(h) {
                h = d(this, h);
                return h.entry && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this[0][h.id], h.entry.qa.next =
                    h.entry.next, h.entry.next.qa = h.entry.qa, h.entry.head = null, this.size--, !0) : !1
            };
        ...
        t("String.prototype.codePointAt", function(a) {
            return a ? a : function(b) {
                var c = ra(this, null, "codePointAt"),
                    d = c.length;
                b = Number(b) || 0;
                if (b >= 0 && b < d) {
                    b |= 0;
        ...
        t("String.fromCodePoint", function(a) {
            return a ? a : function(b) {
                for (var c = "", d = 0; d < arguments.length; d++) {
                    ...
                    if (e < 0 || e > 1114111 || e !== Math.floor(e)) throw new RangeError("q`" + e);
    ...
    try {
        ...
        */
        _.ta = _.ta || {};
        _.w = this || self;
        _.ua = _.w._F_toggles_default_gsi || [];
    } catch (e) {
        _._DumpException(e)
    }
    try {
        /*
         ...
         SPDX-License-Identifier: Apache-2.0
        */
        var Aa, La, Pa, hb, nb, xb, Cb, Gb, Ib, Nb, Ob, Rb, Wb, bc, cc, hc, dc, uc, vc, zc, Hc, Jc, Mc, Vc, Xc, Yc, pd, qd, sd, vd, td, ud, wd, xd, Ad, Bd, Cd;
        _.va = function(a) {
        ...
        Aa = function(a) {
            if (!xa || !_.za) return !1;
            for (var b = 0; b < _.za.brands.length; b++) {
                var c = _.za.brands[b].brand;
        ...
        _.Da = function() {
            return _.Ca() ? !1 : _.y("Opera")
        };
        _.Ea = function() {
            return _.Ca() ? !1 : _.y("Trident") || _.y("MSIE")
        };
        _.Fa = function() {
            return _.Ca() ? !1 : _.y("Edge")
        };
        _.Ga = function() {
            return _.Ca() ? Aa("Microsoft Edge") : _.y("Edg/")
        };
        _.Ha = function() {
            return _.y("Firefox") || _.y("FxiOS")
        };
        _.Ja = function() {
            return _.y("Safari") && !(_.Ia() || (_.Ca() ? 0 : _.y("Coast")) || _.Da() || _.Fa() || _.Ga() || (_.Ca() ? Aa("Opera") : _.y("OPR")) || _.Ha() || _.y("Silk") || _.y("Android"))
        };
        _.Ia = function() {
            return _.Ca() ? Aa("Chromium") : (_.y("Chrome") || _.y("CriOS")) && !_.Fa() || _.y("Silk")
        };
        _.Ka = function(a) {
            var b = {};
        ...
        La = function() {
            var a = _.Ba(_.wa());
            a = _.Ka(a);
            return _.Ia() ? a(["Chrome", "CriOS", "HeadlessChrome"]) : ""
        };
        _.Ma = function() {
            if (_.Ca()) {
                var a = _.za.brands.find(function(b) {
        ...
        _.Oa = function() {
            return _.Na() ? _.za.platform === "Android" : _.y("Android")
        };
        Pa = function() {
            return _.y("iPhone") && !_.y("iPod") && !_.y("iPad")
        };
        _.Qa = function() {
            return Pa() || _.y("iPad") || _.y("iPod")
        };
        _.Ra = function() {
            return _.Na() ? _.za.platform === "macOS" : _.y("Macintosh")
        };
        _.Sa = function() {
            return _.Na() ? _.za.platform === "Chrome OS" : _.y("CrOS")
        };
        _.Ua = function(a, b) {
            b = (0, _.Ta)(a, b);
            var c;
        ...
        _.Ya = function(a, b) {
            if (a != null) {
                ...
                c = d[a] || 0;
                c >= b || (d[a] = c + 1, a = Error(), _.Wa(a, "incident"), _.va(a))
            }
        };
        _.Za = function(a, b, c) {
        ...
        _.fb = function(a, b) {
            return b === void 0 ? a.g !== eb && !!(2 & (a.A[_.z] | 0)) : !!(2 & b) && a.g !== eb
        };
        _.gb = function(a, b, c) {
            var d = b & 128 ? 0 : -1,
                e = a.length,
        ...
        _.mb = function(a) {
            ...
            return kb ? BigInt(a) : a = lb(a) ? a ? "1" : "0" : ib(a) ? a.trim() || "0" : String(a)
        };
        nb = function(a, b) {
        ...
        Gb = function(a, b, c, d) {
            ...
            if (!(b & 1)) {
                var p = h && a[h - 1];
                p != null && typeof p === "object" && p.constructor === Object ? (h--, g = h) : p = void 0;
                if (n && !(b & 128) && !e) {
                    k = !0;
                    var q;
                    g = ((q = Eb) != null ? q : xb)(g - m, m, a, p, void 0) + m
                }
            }
            b = void 0;
            for (q = 0; q < h; q++) {
            ...
            if (p)
                for (var C in p) h = p[C],
                    h != null && (h = c(h, d)) != null && (q = +C, r = void 0, n && !Number.isNaN(q) && (r = q + m) < g ? f[r] = h : (q = void 0, ((q = b) != null ? q : b = {})[C] = h));
            b && (k ? f.push(b) : f[g] = b);
            e && _.yb(_.zb) && (a = _.Ab(a)) && "function" == typeof _.Fb && a instanceof _.Fb && (f[_.zb] = a.g());
            return f
        };
        Ib = function(a) {
            switch (typeof a) {
                ...
                case "bigint":
                    return (0, _.Hb)(a) ? Number(a) : "" + a;
                case "boolean":
                    return a ? 1 : 0;
                case "object":
                    if (Array.isArray(a)) {
                        var b = a[_.z] | 0;
                        return a.length === 0 && b & 1 ? void 0 : Gb(a, b, Ib)
                    }
                    if (a != null && a[ub] === vb) return _.Jb(a);
                    if ("function" == typeof _.Kb && a instanceof _.Kb) return a.i();
                    return
            }
            return a
        };
        _.Jb = function(a) {
            a = a.A;
            return Gb(a, a[_.z] | 0, Ib)
        };
        Nb = function(a) {
            switch (typeof a) {
                case "boolean":
                    return Lb || (Lb = [0, void 0, !0]);
                case "number":
                    return a > 0 ? void 0 : a === 0 ? Mb || (Mb = [0, void 0]) : [-a, void 0];
                case "string":
                    return [0, a];
                case "object":
                    return a
        ...
        Ob = function(a, b, c, d) {
            ...
            if (a == null) {
                ...
                if (!Array.isArray(a)) throw Error("y");
                e = a[_.z] | 0;
                if (Qb && 1 & e) throw Error("z");
                2048 & e && !(2 & e) && Rb();
                if (e & 256) throw Error("A");
                if (e & 64) return (e | d) !== e && _.db(a, e | d), a;
                if (c && (e |= 128, c !== a[0])) throw Error("B");
                a: {
                    c = a;e |= 64;
                    var f = c.length;
                    if (f) {
                        ...
                        if (h != null && typeof h === "object" && h.constructor === Object) {
                            b = e & 128 ? 0 : -1;
                            g -= b;
                            if (g >= 1024) throw Error("D");
                            for (var k in h) f = +k, f < g &&
                                (c[f + b] = h[k], delete h[k]);
        ...
        Wb = function(a, b) {
            ...
            if (Array.isArray(a)) {
                var c = a[_.z] | 0;
                a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = _.Tb(a, c, !1, b && !(c & 16)) : (_.cb(a, 34), c & 4 && Object.freeze(a)));
                return a
            }
            if (a != null && a[ub] === vb) return b = a.A, c = b[_.z] | 0, _.fb(a, c) ? a : _.Ub(a, b, c) ? _.Vb(a, b) : _.Tb(b, c);
            if ("function" == typeof _.Kb && a instanceof _.Kb) return a
        };
        _.Vb = function(a, b, c) {
        ...
        _.Xb = function(a) {
            var b = a.A,
                c = b[_.z] | 0;
            return _.fb(a, c) ? _.Ub(a, b, c) ? _.Vb(a, b, !0) : new a.constructor(_.Tb(b, c, !1)) : a
        };
        _.Yb = function(a) {
            if (a.g !== eb) return !1;
            var b = a.A;
        ...
        _.Zb = function(a, b) {
            b === void 0 && (b = a[_.z] | 0);
            b & 32 && !(b & 4096) && _.db(a, b | 4096)
        };
        _.Ub = function(a, b, c) {
            return c & 2 ? !0 : c & 32 && !(c & 4096) ? (_.db(b, c | 2), a.g = eb, !0) : !1
        };
        _.$b = function(a, b, c, d, e) {
            ...
            if (d !== void 0) {
                var k;
                g = ((k = b) != null ? k : b = a[_.z] | 0) >> 14 & 1023 || 536870912;
        ...
        bc = function(a, b, c, d, e) {
            var f = !1;
            d = _.ac(a, d, e, function(g) {
                var h = _.wb(g, c, b);
                f = h !== g && h != null;
                return h
            });
            if (d != null) return f && !_.fb(d) && _.Zb(a, b), d
        };
        cc = function() {
            var a = function() {
                throw Error();
        ...
        hc = function(a) {
            var b = dc;
            var c = c === void 0 ? _.ec : c;
            return new _.fc(a, b, c)
        };
        ...
        _.mc = function(a, b, c, d) {
            ...
            var f = d[1],
                g = 1;
            f && f.constructor === Object && (e.Ob = f, f = d[++g], typeof f === "function" && (e.ad = !0, _.jc != null || (_.jc = f), _.kc != null || (_.kc = d[g + 1]), f = d[g += 2]));
            ...
            for (k = 1; f !== void 0;) {
                ...
                for (; k < p; k++) {
                    var q = h[k];
                    n ? c(e, k, m, n, q) : b(e, k, m, q)
                }
            }
            return d[a] = e
        };
        _.oc = function(a) {
            return Array.isArray(a) ? a[0] instanceof _.fc ? a : [nc, a] : [a, void 0]
        };
        _.ic = function(a, b) {
            if (a instanceof _.D) return a.A;
        ...
        _.rc = function(a, b, c) {
            _.$b(a, a[_.z] | 0, b, c, (a[_.z] | 0) & 128 ? _.qc : void 0)
        };
        uc = function(a) {
            a = sc.get(a);
            var b = sc.get(_.tc);
        ...
        _.E = function(a, b) {
            try {
                uc("debug") && window.console && window.console.log && window.console.log(vc(b) + a)
            } catch (c) {}
        };
        _.F = function(a, b) {
            try {
                uc("info") && window.console && window.console.info && window.console.info(vc(b) + a)
            } catch (c) {}
        };
        _.G = function(a, b) {
            try {
                uc("warn") && window.console && window.console.warn && window.console.warn(vc(b) + a)
            } catch (c) {}
        };
        _.H = function(a, b) {
            try {
                uc("error") && window.console && window.console.error && window.console.error(vc(b) + a)
            } catch (c) {}
        };
        _.xc = function(a) {
            if (a instanceof _.wc) return a.g;
            throw Error("G");
        };
        zc = function(a) {
            return new _.yc(function(b) {
                return b.substr(0, a.length + 1).toLowerCase() === a + ":"
            })
        };
        _.Bc = function(a) {
            a instanceof _.wc ? a = _.xc(a) : a = Ac.test(a) ? a : void 0;
            return a
        };
        _.Cc = function(a) {
        ...
        _.I = function(a) {
            return !!_.Ec.g[a] || _.Fc.includes(a) && _.Gc.get("ge_" + a) === "1"
        };
        Hc = function(a, b, c) {
        ...
        _.$c = function() {
            ...
            (window.crypto || _.Zc.msCrypto).getRandomValues(a);
            return a[0].toString(16) + a[1].toString(16)
        };
        _.bd = function() {
            return xa && _.za ? _.za.mobile : !_.ad() && (_.y("iPod") || _.y("iPhone") || _.y("Android") || _.y("IEMobile"))
        };
        _.ad = function() {
            return xa && _.za ? !_.za.mobile && (_.y("iPad") || _.y("Android") || _.y("Silk")) : _.y("iPad") || _.y("Android") && !_.y("Mobile") || _.y("Silk")
        };
        _.cd = function() {
            return _.I("disable_fedcm_on_samsung_browsers") && navigator.userAgent.includes("SamsungBrowser") ? !1 : _.Ia() && !_.Ga() && !(_.Ca() ? Aa("Opera") : _.y("OPR"))
        };
        _.dd = function() {
            var a = window;
        ...
        _.gd = function(a, b) {
            if (!b.client_id) throw new _.fd("Missing required parameter client_id.", "missing_required_parameter");
            if (!b.scope) throw new _.fd("Missing required parameter scope.", "missing_required_parameter");
            var c = {
            ...
            a === "code" ? (c.select_account = b.select_account, c.ux_mode = b.ux_mode, b.claims !== void 0 && (c.claims = b.claims), c.ux_mode === "redirect" && (c.redirect_uri = b.redirect_uri || [location.protocol, "//", location.host, location.pathname].join(""))) : a === "token" && (c.prompt = b.prompt);
            return c
        };
        _.id = function(a) {
            _.hd.call(this);
        ...
        _.od = function(a, b, c) {
            ...
            if (!c || c.closed || typeof c.closed === "undefined") return _.H("Failed to open popup window on url: " + a + ". Maybe blocked by the browser?"), null;
            c.focus();
            return c
        };
        pd = function(a) {
            if (a.C) throw new TypeError("f");
            a.C = !0
        };
        qd = function(a, b) {
            a.j = {
        ...
        _.J = function(a, b) {
            a.prototype = (0, _.aa)(b.prototype);
        ...
        vd = function(a, b) {
            pd(a.g);
            var c = a.g.v;
            if (c) return td(a, "return" in c ? c["return"] : function(d) {
                return {
                    value: d,
                    done: !0
                }
        ...
        td = function(a, b, c, d) {
            try {
                ...
                _.na(e);
                if (!e.done) return a.g.C = !1, e;
                var f = e.value
            } catch (g) {
                return a.g.v = null, qd(a.g, g), ud(a)
            }
            a.g.v = null;
            d.call(a.g, f);
            return ud(a)
        ...
        wd = function(a) {
            this.next = function(b) {
                pd(a.g);
                a.g.v ? b = td(a, a.g.v.next, b, a.g.D) : (a.g.D(b), b = ud(a));
                return b
            };
            this.throw = function(b) {
                pd(a.g);
                a.g.v ? b = td(a, a.g.v["throw"], b, a.g.D) : (qd(a.g, b), b = ud(a));
                return b
            };
        ...
        _.kd = function(a, b, c) {
            _.kd = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ? Bd : Cd;
            return _.kd.apply(null, arguments)
        };
        _.K = function(a, b) {
            a = a.split(".");
            for (var c = _.w, d; a.length && (d = a.shift());) a.length || b === void 0 ? c[d] && c[d] !== Object.prototype[d] ? c = c[d] : c = c[d] = {} : c[d] = b
        };
        _.yb = function(a) {
            return a
        };
        ...
        _.fd = function(a, b) {
            ...
            Object.setPrototypeOf(this, _.fd.prototype);
            this.type = b || "unknown"
        };
        _.J(_.fd, Error);
        _.Ed = typeof TextDecoder !== "undefined";
        _.Fd = typeof String.prototype.isWellFormed === "function";
        _.Gd = typeof TextEncoder !== "undefined";
        _.Hd = String.prototype.trim ? function(a) {
            return a.trim()
        } : function(a) {
        ...
        var Nd, xa, Qb;
        Nd = Ad(1, !0);
        xa = Id ? Kd : Ad(610401301, !1);
        Qb = Id ? Jd || !Ld : Ad(748402147, !0);
        _.Od = Id ? Jd || !Md : Ad(824656860, Nd);
        var Pd;
        Pd = _.w.navigator;
        _.za = Pd ? Pd.userAgentData || null : null;
        ...
        _.Sd = Array.prototype.every ? function(a, b) {
        ...
        _.Vd = _.Ea();
        Wd = _.y("Edge");
        _.Xd = _.y("Gecko") && !(_.wa().toLowerCase().indexOf("webkit") != -1 && !_.y("Edge")) && !(_.y("Trident") || _.y("MSIE")) && !_.y("Edge");
        _.Yd = _.wa().toLowerCase().indexOf("webkit") != -1 && !_.y("Edge");
        a: {
            var $d = "",
                ae = function() {
                    var a = _.wa();
                    if (_.Xd) return /rv:([^\);]+)(\)|;)/.exec(a);
                    if (Wd) return /Edge\/([\d\.]+)/.exec(a);
                    if (_.Vd) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
                    if (_.Yd) return /WebKit\/(\S+)/.exec(a);
                    if (Ud) return /(?:Version)[ \/]?(\S+)/.exec(a)
                }();ae && ($d = ae ? ae[1] : "");
            if (_.Vd) {
                var be, ce = _.w.document;
                be = ce ? ce.documentMode : void 0;
                if (be != null && be > parseFloat($d)) {
                    Zd = String(be);
                    break a
                }
            }
        ...
        var ee = _.Ha(),
            fe = Pa() || _.y("iPod"),
            ge = _.y("iPad"),
            he = _.y("Android") && !(_.Ia() || _.Ha() || _.Da() || _.y("Silk")),
            ie = _.Ia(),
            je = _.Ja() && !_.Qa();
        _.ke = typeof Uint8Array !== "undefined";
        _.le = !_.Vd && typeof btoa === "function";
        var Xa = void 0;
        var me, Bb, Sb, ub;
        _.$a = typeof Symbol === "function" && typeof Symbol() === "symbol";
        me = _.Za("jas", void 0, !0);
        _.zb = _.Za(void 0, Symbol());
        _.ne = _.Za(void 0, "0ub");
        Bb = _.Za(void 0, "0ubs");
        _.oe = _.Za(void 0, "0ubsb");
        Sb = _.Za(void 0, "0actk");
        ub = _.Za("m_m", "Xe", !0);
        _.pe = _.Za();
        var bb, ab, re;
        bb = {
        ...
        re = [];
        _.db(re, 7);
        _.qe = Object.freeze(re);
        var vb, eb;
        vb = {};
        eb = {};
        _.se = Object.freeze({});
        _.qc = {};
        var jb = hb(function(a) {
        ...
        var kb = typeof _.w.BigInt === "function" && typeof _.w.BigInt(0) === "bigint";
        var ve, te, we, ue;
        _.Hb = hb(function(a) {
            return kb ? a >= te && a <= ue : a[0] === "-" ? nb(a, ve) : nb(a, we)
        });
        ve = Number.MIN_SAFE_INTEGER.toString();
        te = kb ? BigInt(Number.MIN_SAFE_INTEGER) : void 0;
        we = Number.MAX_SAFE_INTEGER.toString();
        ue = kb ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
        _.xe = typeof Uint8Array.prototype.slice === "function";
        _.ye = typeof BigInt === "function" ? BigInt.asIntN : void 0;
        ...
        _.De = function(a, b, c) {
            a = a.A;
            return bc(a, a[_.z] | 0, b, c) !== void 0
        };
        Ee = function(a, b, c) {
            var d = a[_.z] | 0,
                e = d & 128 ? _.qc : void 0,
        ...
        _.M = function(a, b, c, d) {
            ...
            if (!_.fb(a, f)) {
                var g = _.Xb(b);
                g !== b && (_.Yb(a) && (e = a.A, f = e[_.z] | 0), b = g, f = _.$b(e, f, c, b, d), _.Zb(e, f))
            }
            return b
        };
        _.Fe = function(a, b) {
            var c = c === void 0 ? "" : c;
            var d;
            return (d = _.tb(_.L(a, b))) != null ? d : c
        };
        _.N = function(a, b) {
            return _.tb(_.L(a, b, void 0, _.Ce))
        };
        _.O = function(a, b) {
            return _.rb(_.L(a, b, void 0, _.Ce))
        };
        var Ge, Je;
        _.ec = cc();
        Ge = cc();
        ...
        lc = hc(function(a, b, c, d, e) {
            if (a.h !== 2) return !1;
            a.l(Ee(b, d, c), e);
            return !0
        });
        nc = hc(function(a, b, c, d, e) {
            if (a.h !== 2) return !1;
            a.l(Ee(b, d, c), e);
            return !0
        });
        _.Ke = Symbol();
        _.Le = _.pc(function(a, b, c) {
            if (a.h !== 0) return !1;
            _.rc(b, c, a.u());
            return !0
        }, function(a, b, c) {
        ...
        _.Pe = new _.wc("about:invalid#zClosurez");
        var Ac;
        _.yc = function(a) {
            this.Zd = a
        };
        _.Qe = [zc("data"), zc("http"), zc("https"), zc("mailto"), zc("ftp"), new _.yc(function(a) {
            return /^[^:]*([/?#]|$)/.test(a)
        })];
        Ac = /^\s*(?!javascript:)(?:[\w+.-]+:|[^:/?#]*(?:[/?#]|$))/i;
        _.Re = String.prototype.repeat ? function(a, b) {
            return a.repeat(b)
        } : function(a, b) {
        ...
        _.l.set = function(a, b, c) {
            ...
            if (/[;=\s]/.test(a)) throw Error("J`" + a);
            if (/[;\r\n]/.test(b)) throw Error("K`" + b);
            h === void 0 && (h = -1);
        ...
        _.l.clear = function() {
            for (var a = Se(this).keys, b = a.length - 1; b >= 0; b--) this.remove(a[b])
        };
        Se = function(a) {
            a = (a.g.cookie || "").split(";");
            for (var b = [], c = [], d, e, f = 0; f < a.length; f++) e = _.Hd(a[f]), d = e.indexOf("="), d == -1 ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
            return {
                keys: b,
                values: c
            }
        };
        _.Gc = new _.Dc(typeof document == "undefined" ? null : document);
        _.Fc = ["test_only", "enable_warm_welcome_page_type", "enable_itp_optimization", "enable_itp_support_in_oauth", "disable_fedcm_opt_out"];
        _.P = function(a) {
            _.Ec.g[a] = !0;
        ...
        _.Kc = RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");
        var Sc, Xe, ef, Ye, $e, Ze, cf, af, ff;
        _.Nc.prototype.toString = function() {
            var a = [],
                b = this.h;
            b && a.push(Xe(b, Ye, !0), ":");
            var c = this.g;
            if (c || b == "file") a.push("//"), (b = this.getUserInfo()) && a.push(Xe(b, Ye, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.u, c != null && a.push(":", String(c));
            if (c = this.i) this.g && c.charAt(0) != "/" && a.push("/"), a.push(Xe(c, c.charAt(0) == "/" ? Ze : $e, !0));
            (c = this.j.toString()) && a.push("?", c);
            (c = this.o) && a.push("#", Xe(c, af));
            return a.join("")
        };
        _.Nc.prototype.resolve = function(a) {
            var b = new _.Nc(this),
                c = !!a.h;
            c ? _.Oc(b, a.h) : c = !!a.v;
            if (c) {
        ...
        _.Nc.prototype.getUserInfo = function() {
            return this.v
        };
        _.Pc = function(a, b) {
            if (b) {
        ...
        _.Qc = function(a, b, c) {
            b instanceof _.Tc ? (a.j = b, bf(a.j, a.l)) : (c || (b = Xe(b, cf)), a.j = new _.Tc(b, a.l))
        };
        _.df = function(a) {
            return a instanceof _.Nc ? new _.Nc(a) : new _.Nc(a)
        };
        Sc = function(a, b) {
            return a ? b ? decodeURI(a.replace(/%25/g, "%2525")) : decodeURIComponent(a) : ""
        };
        Xe = function(a, b, c) {
            return typeof a === "string" ? (a = encodeURI(a).replace(b, ef), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
        };
        ef = function(a) {
            a = a.charCodeAt(0);
        ...
        _.Tc.prototype.add = function(a, b) {
            ff(this);
            this.i = null;
            a = gf(this, a);
            var c = this.g.get(a);
        ...
        _.l.oa = function(a) {
            ff(this);
            var b = [];
            if (typeof a === "string") hf(this, a) && (b = b.concat(this.g.get(gf(this, a))));
            else {
        ...
        _.jf = function(a, b, c) {
            a.remove(b);
            c.length > 0 && (a.i = null, a.g.set(gf(a, b), _.Va(c)), a.h += c.length)
        };
        ...
        var Rc = function(a) {
            ...
            bf = function(a, b) {
                b && !a.j && (ff(a), a.i = null, a.g.forEach(function(c, d) {
                    var e = d.toLowerCase();
                    d != e && (this.remove(d), _.jf(this, e, c))
                }, a));
                a.j = b
            };
        _.kf = typeof AsyncContext !== "undefined" && typeof AsyncContext.Snapshot === "function" ? function(a) {
        ...
        _.hd.prototype.u = !1;
        _.hd.prototype.Yc = function() {
            return this.u
        };
        _.hd.prototype.dispose = function() {
            this.u || (this.u = !0, this.ia())
        };
        _.hd.prototype[Symbol.dispose] = function() {
            this.dispose()
        };
        _.hd.prototype.ia = function() {
            if (this.o)
        ...
        Uc.prototype.stopPropagation = function() {
            this.i = !0
        };
        ...
        _.Dd(Vc, Uc);
        Vc.prototype.init = function(a, b) {
            ...
            d ? (this.clientX = d.clientX !== void 0 ? d.clientX : d.pageX, this.clientY = d.clientY !== void 0 ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY || 0) : (this.j = _.Yd || a.offsetX !== void 0 ? a.offsetX : a.layerX, this.l = _.Yd || a.offsetY !==
                void 0 ? a.offsetY : a.layerY, this.clientX = a.clientX !== void 0 ? a.clientX : a.pageX, this.clientY = a.clientY !== void 0 ? a.clientY : a.pageY, this.screenX = a.screenX || 0, this.screenY = a.screenY || 0);
            ...
            this.state = a.state;
            this.g = a;
            a.defaultPrevented && Vc.wa.preventDefault.call(this)
        };
        Vc.prototype.stopPropagation = function() {
            Vc.wa.stopPropagation.call(this);
            this.g.stopPropagation ? this.g.stopPropagation() : this.g.cancelBubble = !0
        };
        Vc.prototype.preventDefault = function() {
            Vc.wa.preventDefault.call(this);
            var a = this.g;
        ...
        var mf;
        mf = "closure_listenable_" + (Math.random() * 1E6 | 0);
        _.nf = function(a) {
            return !(!a || !a[mf])
        };
        var Wc = 0;
        ...
        Yc.prototype.add = function(a, b, c, d, e) {
            ...
            a || (a = this.g[f] = [], this.h++);
            var g = pf(a, b, d, e);
            g > -1 ? (b = a[g], c || (b.nb = !1)) : (b = new Xc(b, this.src, f, !!d, e), b.nb = c, a.push(b));
            return b
        };
        ...
        qf = function(a, b) {
            ...
            var d = _.Ua(a.g[c], b);
            d && ( of (b), a.g[c].length == 0 && (delete a.g[c], a.h--));
            return d
        };
        _.rf = function(a, b) {
            b = b && b.toString();
            ...
            for (d in a.g)
                if (!b || d == b) {
                    for (var e = a.g[d], f = 0; f < e.length; f++) ++c, of (e[f]);
                    delete a.g[d];
                    a.h--
                }
        };
        Yc.prototype.Ua = function(a, b, c, d) {
            a = this.g[a.toString()];
            var e = -1;
            a && (e = pf(a, b, c, d));
            return e > -1 ? a[e] : null
        ...
        var pf = function(a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.Za && f.listener == b && f.capture == !!c && f.ya == d) return e
            }
            return -1
        };
        var sf, tf, uf, yf, Af, Df, Bf, Cf, Ff, xf;
        sf = "closure_lm_" + (Math.random() * 1E6 | 0);
        tf = {};
        uf = 0;
        ...
        yf = function(a, b, c, d, e, f) {
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener) lf || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(), d, e);
        ...
        _.vf = function(a, b, c, d, e) {
            ...
            c = xf(c);
            return _.nf(a) ? a.Vb(b, c, _.zd(d) ? !!d.capture : !!d, e) : yf(a, b, c, !0, d, e)
        };
        Df = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++) Df(a, b[f], c, d, e);
            else d = _.zd(d) ? !!d.capture : !!d, c = xf(c), _.nf(a) ? a.Ea(b, c, d, e) : a && (a = _.zf(a)) && (b = a.Ua(b, c, d, e)) && _.Ef(b)
        };
        _.Ef = function(a) {
            if (typeof a === "number" || !a || a.Za) return !1;
            var b = a.src;
            if (_.nf(b)) return qf(b.ja, a);
            var c = a.type,
                d = a.proxy;
            ...
            uf--;
            (c = _.zf(b)) ? (qf(c, a), c.h == 0 && (c.src = null, b[sf] = null)) : of (a);
            return !0
        };
        Bf = function(a) {
        ...
        _.l.dispatchEvent = function(a) {
            ...
            c = this.C;
            var d = a.type || a;
            if (typeof a === "string") a = new Uc(a, c);
            else if (a instanceof Uc) a.target = a.target || c;
            else {
                var e = a;
                a = new Uc(d, c);
                Jc(a, e)
            ...
            a.i || (g = a.h = c, e = Gf(g, d, !0, a) && e, a.i || (e = Gf(g, d, !1, a) && e));
            if (b)
                for (f = 0; !a.i && f < b.length; f++) g = a.h = b[f], e = Gf(g, d, !1, a) && e;
            return e
        };
        _.l.ia = function() {
            _.jd.wa.ia.call(this);
            this.ja && _.rf(this.ja);
            this.l = null
        };
        ...
        _.Hf = Math.floor(Math.random() * 100);
        for (var If = [], Jf = 0; Jf < 63; Jf++) If[Jf] = 0;
        _.Kf = [].concat(128, If);
        var Lf;
        Lf = function(a) {
            return (a = a.exec(_.wa())) ? a[1] : ""
        };
        _.Mf = function() {
            if (ee) return Lf(/Firefox\/([0-9.]+)/);
            if (_.Vd || Wd || Ud) return de;
            if (ie) {
                if (_.Qa() || _.Ra()) {
                    var a = Lf(/CriOS\/([0-9.]+)/);
                    if (a) return a
                }
                return Lf(/Chrome\/([0-9.]+)/)
            }
            if (je && !_.Qa()) return Lf(/Version\/([0-9.]+)/);
            if (fe || ge) {
                if (a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.wa())) return a[1] + "." + a[2]
            } else if (he) return (a = Lf(/Android\s+([0-9.]+)/)) ? a : Lf(/Version\/([0-9.]+)/);
            return ""
        }();
        _.Zc = window;
        _.Dd(_.id, _.hd);
        var Nf = [];
        _.id.prototype.M = function(a, b, c, d) {
            Array.isArray(b) || (b && (Nf[0] = b.toString()), b = Nf);
            for (var e = 0; e < b.length; e++) {
                var f = _.wf(a, b[e], c || this.handleEvent, d || !1, this.h || this);
                if (!f) break;
                this.g[f.key] = f
            }
            return this
        };
        _.id.prototype.Vb = function(a, b, c, d) {
        ...
        var Of = function(a, b, c, d, e, f) {
            if (Array.isArray(c))
                ...
                b = _.vf(b, c, d || a.handleEvent, e, f || a.h || a);
                if (!b) return a;
                a.g[b.key] = b
            }
            return a
        };
        _.id.prototype.Ea = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++) this.Ea(a, b[f], c, d, e);
            else c = c || this.handleEvent, d = _.zd(d) ? !!d.capture : !!d, e = e || this.h || this, c = xf(c), d = !!d, b = _.nf(a) ? a.Ua(b, c, d, e) : a ? (a = _.zf(a)) ? a.Ua(b, c, d, e) : null : null, b && (_.Ef(b), delete this.g[b.key])
        };
        var Pf = function(a) {
            Hc(a.g, function(b, c) {
                this.g.hasOwnProperty(c) && _.Ef(b)
            }, a);
            a.g = {}
        };
        _.id.prototype.ia = function() {
            _.id.wa.ia.call(this);
            Pf(this)
        };
        _.id.prototype.handleEvent = function() {
            throw Error("U");
        };
        _.Dd(_.ld, _.jd);
        _.ld.prototype.h = !1;
        _.ld.prototype.g = null;
        _.ld.prototype.I = function() {
            if (this.h) {
                var a = Date.now() - this.B;
                a > 0 && a < this.j * .8 ? this.g = this.i.setTimeout(this.v, this.j - a) : (this.g && (this.i.clearTimeout(this.g), this.g = null), this.dispatchEvent("tick"), this.h && (_.Qf(this), this.start()))
            }
        };
        _.ld.prototype.start = function() {
            this.h = !0;
            this.g || (this.g = this.i.setTimeout(this.v, this.j), this.B = Date.now())
        };
        _.Qf = function(a) {
            a.h = !1;
            a.g && (a.i.clearTimeout(a.g), a.g = null)
        };
        _.ld.prototype.ia = function() {
            _.ld.wa.ia.call(this);
            _.Qf(this);
            delete this.i
        };
        _.Rf = function(a, b) {
        ...
        _.Rf.prototype.i = function() {
            this.h && (_.Qf(this.h), _.E("Popup timer stopped.", "OAUTH2_CLIENT"), this.h = void 0, this.B = !0)
        };
        _.Sf = function(a) {
            a.v || (a.v = !0, window.addEventListener("message", function(b) {
                try {
                    if (b.data)
                        if (b.origin !== _.Lc(a.l)) _.F("Message ignored. Different origin.", "OAUTH2_CLIENT");
                        else {
                            var c = JSON.parse(b.data).params;
                            c ? a.o && c.id === a.o ? c.clientId !== a.u.client_id ? _.F("Message ignored. Client id does not match.", "OAUTH2_CLIENT") : c.type !== "authResult" ? _.F("Message ignored. Invalid event type.", "OAUTH2_CLIENT") : (a.o = void 0, a.i(c.authResult)) : _.F("Message ignored. Request id does not match.", "OAUTH2_CLIENT") : _.F("Message ignored. No params in message.",
                                "OAUTH2_CLIENT")
                        }
                    else _.F("Message ignored. No event data.", "OAUTH2_CLIENT")
                } catch (d) {
        ...
        _.Uf = function(a) {
            a.error_callback && a.g && !a.h && (_.F("Starting popup timer.", "OAUTH2_CLIENT"), a.B = !1, a.h = new _.ld(500), (new _.id(a)).M(a.h, "tick", a.C), a.h.start())
        };
        _.Rf.prototype.C = function() {
            _.E("Checking popup closed.", "OAUTH2_CLIENT");
            !this.h || this.B || this.g && !this.g.closed || (_.F("Popup window closed.", "OAUTH2_CLIENT"), this.error_callback && this.error_callback(new _.fd("Popup window closed", "popup_closed")), _.Qf(this.h), this.g = this.h = void 0)
        };
        var nd = _.$c();
    ...
    try {
        var oh, th, vh, wh, yh, zh, Dh, Gh, Ih, Oh, Rh, Uh, Ah, uh, xh, Eh, Fh;
        _.mh = function(a) {
            a = Error(a);
            _.Wa(a, "warning");
            return a
        ...
        _.nh = function(a) {
            if (!_.Yb(a) && _.fb(a, a.A[_.z] | 0)) throw Error();
        };
        oh = function(a) {
        ...
        vh = function(a, b, c, d) {
            var e, f, g = c.h;
            a[b] = function(h, k, n) {
                return g(h, k, n, f || (f = _.mc(uh, th, vh, d).Xa), e || (e = wh(d)))
            }
        };
        wh = function(a) {
            var b = a[xh];
            if (!b) {
                var c = _.mc(uh, th, vh, a);
                b = function(d, e) {
                    return yh(d, e, c)
                };
                a[xh] = b
        ...
        yh = function(a, b, c) {
            _.gb(a, a[_.z] | 0, function(d, e) {
                if (e != null) {
                    var f = zh(c, d);
                    f ? f(b, e, d) : d < 500 || _.Ya(_.oe, 3)
                }
            });
            (a = _.Ab(a)) && a.qb(function(d, e, f) {
                Ah(b, b.g.end());
                for (d = 0; d < f.length; d++) Ah(b, f[d].h() || new Uint8Array(0))
            })
        };
        zh = function(a, b) {
            var c = a[b];
            ...
            if (c = a.Ob)
                if (c = c[b]) {
                    ...
                    if (c = c[1]) {
                        var e = wh(c),
                            f = _.mc(uh, th, vh, c).Xa;
                        c = a.ad ? (0, _.kc)(f, e) : function(g, h, k) {
                            return d(g, h, k, f, e)
                        }
                    } else c = d;
                    return a[b] = c
        ...
        _.Bh = function(a) {
            return function(b) {
                if (b == null || b == "") b = new a;
                    ...
                    b = JSON.parse(b);
                    if (!Array.isArray(b)) throw Error("F");
                    _.cb(b, 32);
                    b = new a(b)
                }
                return b
        ...
        Gh = function(a, b) {
            ...
            Eh === void 0 && (_.w.Int32Array ? Eh = new Int32Array(Fh) : Eh = Fh);
            this.reset()
        };
        Ih = function() {
            Gh.call(this, 8, Hh)
        ...
        _.Ph = function(a, b) {
            var c = c === void 0 ? 0 : c;
            var d;
            return (d = _.rb(_.L(a, b))) != null ? d : c
        };
        _.Qh = function(a, b, c) {
            if (c != null) {
                if (typeof c !== "number") throw _.mh("int32");
                if (!(0, _.qb)(c)) throw _.mh("int32");
                c |= 0
            }
            return _.Nh(a, b, c)
        };
        ...
        Rh.prototype.length = function() {
            return this.g.length
        };
        Rh.prototype.end = function() {
            var a = this.g;
            this.g = [];
            return a
        };
        ...
        Uh.prototype.o = function(a, b) {
            b != null && (_.Sh(this.g, a * 8), this.g.g.push(b ? 1 : 0))
        };
        Uh.prototype.u = function(a, b) {
            b != null && (b = parseInt(b, 10), _.Sh(this.g, a * 8), _.Th(this.g, b))
        };
        Uh.prototype.l = function(a, b) {
            if (b != null) {
                var c = !1;
                c = c === void 0 ? !1 : c;
                if (_.Gd) {
                    if (c && (_.Fd ? !b.isWellFormed() : /(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])/.test(b))) throw Error("s");
                    b = (Oh || (Oh = new TextEncoder)).encode(b)
                } else {
                ...
                _.Sh(this.g, a * 8 + 2);
                _.Sh(this.g, b.length);
                Ah(this, this.g.end());
                Ah(this, b)
            }
        };
        Uh.prototype.j = function(a, b, c) {
            if (b != null) {
                _.Sh(this.g, a * 8 + 2);
                a = this.g.end();
                Ah(this, a);
        ...
        uh = Symbol();
        xh = Symbol();
        _.Vh = [0, _.Me, -1, _.Ne, _.Me, -2, _.Ne, _.Me, 1, _.Me, -2];
        _.Wh = function(a) {
            this.A = _.B(a)
        };
        _.J(_.Wh, _.D);
        ...
        _.Wh.prototype.h = function(a) {
            return function() {
                var b = new Uh;
                yh(this.A, b, _.mc(uh, th, vh, a));
                Ah(b, b.g.end());
        ...
        _.Yh = function(a, b) {
            if (a)
                if (_.nf(a)) a.ja && _.rf(a.ja, b);
                else if (a = _.zf(a)) {
                var c = 0;
                b = b && b.toString();
                for (var d in a.g)
                    if (!b || d == b)
                        for (var e = a.g[d].concat(), f = 0; f < e.length; ++f) _.Ef(e[f]) && ++c
            }
        };
        ...
        Gh.prototype.reset = function() {
            this.j = this.h = 0;
            this.g = _.w.Int32Array ? new Int32Array(this.l) : _.Va(this.l)
        };
        var Zh = function(a) {
            for (var b = a.i, c = a.u, d = 0, e = 0; e < b.length;) c[d++] = b[e] << 24 | b[e + 1] << 16 | b[e + 2] << 8 | b[e + 3], e = d * 4;
            for (b = 16; b < 64; b++) d = c[b - 15] | 0, e = c[b - 2] | 0, c[b] = ((c[b - 16] | 0) + ((d >>> 7 | d << 25) ^ (d >>> 18 | d << 14) ^ d >>> 3) | 0) + ((c[b - 7] | 0) + ((e >>> 17 | e << 15) ^ (e >>> 19 | e << 13) ^ e >>> 10) | 0) | 0;
            b = a.g[0] | 0;
            d = a.g[1] | 0;
            e = a.g[2] | 0;
            for (var f = a.g[3] | 0, g = a.g[4] | 0, h = a.g[5] | 0, k = a.g[6] | 0, n = a.g[7] | 0, m = 0; m < 64; m++) {
                var p = ((b >>> 2 | b << 30) ^ (b >>> 13 | b << 19) ^ (b >>> 22 | b << 10)) + (b & d ^ b & e ^ d & e) | 0,
                    q = (n + ((g >>> 6 | g << 26) ^ (g >>> 11 | g << 21) ^ (g >>> 25 | g << 7)) | 0) + (((g & h ^
                        ~g & k) + (Eh[m] | 0) | 0) + (c[m] | 0) | 0) | 0;
                n = k;
                k = h;
                h = g;
                g = f + q | 0;
        ...
        Gh.prototype.update = function(a, b) {
            ...
            var c = 0,
                d = this.h;
            if (typeof a === "string")
                for (; c < b;) this.i[d++] = a.charCodeAt(c++), d == this.blockSize && (Zh(this), d = 0);
            else if (_.Mh(a))
                for (; c < b;) {
                    var e = a[c++];
                    if (!("number" == typeof e && 0 <= e && 255 >= e && e == (e | 0))) throw Error("S");
                    this.i[d++] = e;
                    d == this.blockSize && (Zh(this), d = 0)
                } else throw Error("T");
            this.h = d;
            this.j += b
        };
        Gh.prototype.digest = function() {
            var a = [],
                b = this.j * 8;
            this.h < 56 ? this.update(_.Kf, 56 - this.h) : this.update(_.Kf, this.blockSize - (this.h - 56));
        ...
        var Hh = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225];
        _.Dd(Ih, Gh);
        _.$h = function() {
            var a = this;
            this.g = this.h = null;
        ...
        _.$h.prototype.resolve = function(a) {
            if (!this.h) throw Error("na");
            this.h(a);
            this.dispose()
        };
        _.$h.prototype.reject = function(a) {
            if (!this.g) throw Error("na");
            this.g(a);
            this.dispose()
        };
        _.$h.prototype.dispose = function() {
            this.g = this.h = null
        };
    } catch (e) {
        _._DumpException(e)
    ...
    try {
        var Xj, ik, jk, kk, lk, mk, nk, ok, pk, qk, rk, sk, tk, Ck, Dk;
        _.Wj = function(a) {
            if (!a.startsWith(")]}'\n")) throw console.error("malformed JSON response:", a), Error("oa");
            a = a.substring(5);
            return JSON.parse(a)
        };
        Xj = function(a, b) {
        ...
        _.Yj = function(a, b) {
            ...
            for (var d = Math.max(a.length, b.length), e = 0; c == 0 && e < d; e++) {
                ...
                do {
                    ...
                    c = Xj(f[1].length == 0 ? 0 : parseInt(f[1], 10), g[1].length == 0 ? 0 : parseInt(g[1], 10)) || Xj(f[2].length == 0, g[2].length == 0) || Xj(f[2], g[2]);
                    f = f[3];
                    g = g[3]
                } while (c == 0)
            }
        ...
        _.Zj = function() {
            ...
            a = _.Ba(a);
            b = _.Ka(a);
            return _.Da() ? b(["Version", "Opera"]) : _.Fa() ? b(["Edge"]) : _.Ga() ? b(["Edg"]) : _.y("Silk") ? b(["Silk"]) : _.Ia() ? b(["Chrome", "CriOS", "HeadlessChrome"]) :
                (a = a[2]) && a[1] || ""
        };
        _.ak = function(a, b, c) {
            if (b & 2) throw Error();
            var d = b & 128 ? _.qc : void 0,
                e = _.rh(a, c, d),
                f = e === _.qe ? 7 : e[_.z] | 0,
                g = _.sh(f, b);
            if (2 & g || _.ph(g) || 16 & g) g === f || _.ph(g) || _.db(e, g), e = _.ob(e), f = 0, g = _.qh(g, b), _.$b(a, b, c, e, d);
            g &= -13;
            g !== f && _.db(e, g);
            return e
        };
        _.bk = function(a) {
            _.tc = a === void 0 ? "warn" : a
        };
        _.ck = function(a) {
            switch (a) {
                case "auto":
        ...
        _.dk = function(a) {
            var b = {};
            if (a)
                for (var c = _.u(Object.keys(a)), d = c.next(); !d.done; d = c.next()) d = d.value, a[d] !== void 0 && a[d] !== "" && (b[d] = a[d]);
            return b
        };
        _.fk = function(a, b) {
            a = new _.Nc(a);
            b && _.Qc(a, _.ek(_.dk(b)));
            return a.toString()
        };
        _.gk = function() {
            var a;
            if (!(a = _.Ja() || (_.y("iPad") || _.y("iPhone")) && !_.Ja() && !_.Ia() && !(_.Ca() ? 0 : _.y("Coast")) && !_.Ha() && _.y("AppleWebKit")) && (a = _.Qa())) {
                a = _.wa();
                var b = "";
                (_.Na() ? _.za.platform === "Windows" : _.y("Windows")) ? (b = /Windows (?:NT|Phone) ([0-9.]+)/, b = (a = b.exec(a)) ? a[1] : "0.0") : _.Qa() ? (b = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, b = (a = b.exec(a)) && a[1].replace(/_/g, ".")) : _.Ra() ? (b = /Mac OS X ([0-9_.]+)/, b = (a = b.exec(a)) ? a[1].replace(/_/g, ".") : "10") : _.wa().toLowerCase().indexOf("kaios") != -1 ? (b = /(?:KaiOS)\/(\S+)/i,
                    b = (a = b.exec(a)) && a[1]) : _.Oa() ? (b = /Android\s+([^\);]+)(\)|;)/, b = (a = b.exec(a)) && a[1]) : _.Sa() && (b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, b = (a = b.exec(a)) && a[1]);
                a = _.Yj(b || "", "14.4") >= 0
            }
            return a || _.Ha() && _.Yj(_.Zj(), "100") >= 0
        };
        _.hk = function(a, b) {
            return _.tb(_.L(a, b))
        };
        ...
        ok = function(a, b) {
            if (a.G) {
                a.Da && (clearTimeout(a.Da), a.Da = null);
                var c = a.G;
                a.G = null;
        ...
        rk = function(a) {
            if (a.sa && typeof _.ta != "undefined")
                if (a.sb && qk(a) == 4) setTimeout(a.gd.bind(a), 0);
                else if (a.dispatchEvent("readystatechange"), qk(a) == 4) {
                a.sa = !1;
                try {
                    var b = a.Tc();
                    a: switch (b) {
                    ...
                    if (!(d = c)) {
                        var e;
                        if (e = b === 0) {
                            var f = String(a.Ub).match(_.Kc)[1] || null;
                            !f && _.w.self && _.w.self.location && (f = _.w.self.location.protocol.slice(0, -1));
                            e = !kk.test(f ? f.toLowerCase() : "")
                        }
                        d = e
                    }
                    d ? (a.dispatchEvent("complete"), a.dispatchEvent("success")) :
                        nk(a)
                } finally {
                    ok(a)
                }
        ...
        tk = function() {
            ...
            this.G = null;
            this.Ub = "";
            this.Aa = this.Rb = this.sb = this.Mb = !1;
            this.ld = 0;
            this.Da = null;
            this.kd = "";
            this.re = this.jc = !1;
            this.Fb = this.hc = null
        };
        _.Dd(tk, _.jd);
        _.l = tk.prototype;
        _.l.Jd = function() {
        ...
        _.l.send = function(a, b, c, d) {
            if (this.G) throw Error("Q`" + this.Ub + "`" + a);
            b = b ? b.toUpperCase() : "GET";
            this.Ub = a;
            this.Mb = !1;
            this.sa = !0;
            this.G = new XMLHttpRequest;
            this.G.onreadystatechange = (0, _.kf)((0, _.kd)(this.gd, this));
            this.re && "onprogress" in this.G && (this.G.onprogress = (0, _.kf)((0, _.kd)(function(g) {
                this.fd(g, !0)
            }, this)), this.G.upload && (this.G.upload.onprogress = (0, _.kf)((0, _.kd)(this.fd, this))));
            try {
                this.Rb = !0, this.G.open(b, String(a), !0), this.Rb = !1
            } catch (g) {
                pk(this);
                return
            }
            ...
            } else throw Error("R`" + String(d));
            d = Array.from(c.keys()).find(function(g) {
                return "content-type" == g.toLowerCase()
            });
            e = _.w.FormData && a instanceof _.w.FormData;
            !((0, _.Ta)(lk, b) >= 0) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
            b = _.u(c);
            for (d = b.next(); !d.done; d =
                b.next()) c = _.u(d.value), d = c.next().value, c = c.next().value, this.G.setRequestHeader(d, c);
            this.kd && (this.G.responseType = this.kd);
            "withCredentials" in this.G && this.G.withCredentials !== this.jc && (this.G.withCredentials = this.jc);
            if ("setTrustToken" in this.G && this.hc) try {
                this.G.setTrustToken(this.hc)
            } catch (g) {}
            if ("setAttributionReporting" in this.G && this.Fb) try {
                this.G.setAttributionReporting(this.Fb)
            } catch (g) {}
            try {
                this.Da && (clearTimeout(this.Da), this.Da = null), this.ld > 0 && (this.Da = setTimeout(this.De.bind(this),
                    this.ld)), this.sb = !0, this.G.send(a), this.sb = !1
            } catch (g) {
                pk(this)
            }
        };
        _.l.De = function() {
            typeof _.ta != "undefined" && this.G && (this.dispatchEvent("timeout"), this.abort(8))
        };
        _.l.abort = function() {
            this.G && this.sa && (this.sa = !1, this.Aa = !0, this.G.abort(), this.Aa = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), ok(this))
        };
        _.l.ia = function() {
            this.G && (this.sa && (this.sa = !1, this.Aa = !0, this.G.abort(), this.Aa = !1), ok(this, !0));
            tk.wa.ia.call(this)
        };
        _.l.gd = function() {
            this.Yc() || (this.Rb || this.sb || this.Aa ? rk(this) : this.pe())
        };
        _.l.pe = function() {
            rk(this)
        };
        _.l.fd = function(a, b) {
            this.dispatchEvent(sk(a, "progress"));
            this.dispatchEvent(sk(a, b ? "downloadprogress" : "uploadprogress"))
        };
        ...
        _.l.Tc = function() {
            try {
                return qk(this) > 2 ? this.G.status : -1
            } catch (a) {
                return -1
            }
        };
        _.l.getResponseHeader = function(a) {
            if (this.G && qk(this) == 4) return a = this.G.getResponseHeader(a), a === null ? void 0 : a
        };
        _.l.getAllResponseHeaders = function() {
            return this.G && qk(this) >= 2 ? this.G.getAllResponseHeaders() || "" : ""
        };
        _.uk = function(a) {
            try {
        ...
        _.vk = function(a, b) {
            return _.pb(_.L(a, b, void 0, _.Ce))
        };
        _.wk = function(a, b) {
            return _.R(a, 1, b)
        };
        ...
        _.ek = function(a) {
            var b = jk(a);
            if (typeof b == "undefined") throw Error("N");
            var c = new _.Tc(null);
            a = ik(a);
            for (var d = 0; d < b.length; d++) {
                var e = b[d],
                    f = a[d];
                Array.isArray(f) ? _.jf(c, e, f) : c.add(e, f)
            }
            return c
        };
        ...
        _.J(_.Ak, _.D);
        _.Bk = function(a, b) {
            return _.sb(_.L(a, b, void 0, _.Ce))
        };
        Ck = new _.fc(function(a, b, c) {
            if (a.h !== 2) return !1;
            a = a.o();
            _.ak(b, b[_.z] | 0, c).push(a);
            return !0
        }, function(a, b, c) {
            if (Array.isArray(b)) {
                var d = b[_.z] | 0;
            ...
            if (b != null)
                for (d = 0; d < b.length; d++) a.l(c, b[d])
        }, _.He);
        Dk = [0, _.Me];
        _.Ek = [0, _.Me, -2];
        _.Fk = function(a) {
        ...
        _.Gk = [0, _.Me, -5, _.Le, Dk, Ck, _.Me, _.Le, Ck, _.Le, -1, Ck];
    } catch (e) {
        _._DumpException(e)
    }
    try {
        ...
        */
        ...
        _.Lk = function(a) {
            return "function" == typeof _.Kk && a instanceof _.Kk
        };
        _.Mk = function(a) {
            if (_.Lk(a)) return a.g;
            throw Error("G");
        };
        Ok = function(a) {
            var b = _.Jk();
        ...
        _.Pk = function(a) {
            if (a instanceof Nk) return a.g;
            throw Error("G");
        };
        Qk = function(a) {
            return a instanceof Nk ? a : Ok(String(a).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&apos;"))
        };
        Tk = function(a, b) {
                ...
                switch (e) {
                    case 0:
                        ...
                        if (n < 0) {
                            ...
                            k = d
                        } else c.push(a.substring(k, n)), h = n, k = n + 1, Rk ? (Sk.lastIndex = k, n = Sk.exec(a)) : (Sk.lastIndex = 0, n = Sk.exec(a.substring(k))), n ? (f = ["<", n[0]], g = n[1], e = 1, k += n[0].length) : c.push("<");
                        break;
                    case 1:
                        n = a.charAt(k++);
                        switch (n) {
                            ...
                            case '"':
                                var m = a.indexOf(n, k);
                                m < 0 ? k = d : (f.push(n, a.substring(k, m + 1)), k = m + 1);
                                break;
                            case ">":
                                f.push(n);
                                c.push(b(f.join(""),
        ...
        Vk = function(a, b) {
            ...
            return (a | 0) == 1 && b.Ge == 0 ? "one" : "other"
        };
        _.Yk = function(a, b, c, d) {
            (b = b(c || Wk, d)) && b.i && a ? b.i(a) : (b = _.Xk(b), a.innerHTML = _.Pk(b))
        };
        _.Xk = function(a) {
            return _.zd(a) ? a.md && (a = a.md(), a instanceof Nk) ? a : Qk("zSoyz") : Qk(String(a))
        };
        _.Zk = function(a) {
            var b, c, d, e;
            return {
                id: (b = a.Pb()) != null ? b : null,
                givenName: (c = a.Rd()) != null ? c : null,
                displayName: (d = a.Qd()) != null ? d : null,
                profilePicture: (e = a.Sd()) != null ? e : null
            }
        };
        Nk = function(a) {
            this.g = a
        ...
        _.fl.prototype.appendChild = function(a, b) {
            a.appendChild(b)
        };
        _.fl.prototype.h = _.dl;
        _.fl.prototype.contains = _.el;
        var jl;
        _.gl = {};
        _.hl = {};
        _.il = {};
        ...
        jl.prototype.md = function() {
            if (this.Hc !== _.gl) throw Error("ta");
        ...
        _.Dd(kl, jl);
        kl.prototype.Hc = _.gl;
        var ql, Rk, Sk, xl, yl, ol, zl, nl, Al, vl, pl;
        _.ll = function(a) {
            if (a != null) switch (a.Gc) {
                case 1:
                    return 1;
                case -1:
                    return -1;
        ...
        _.V = function(a) {
            return _.ml(a, _.gl) ? a : a instanceof Nk ? (0, _.U)(_.Pk(a).toString()) : (0, _.U)(String(String(a)).replace(nl, ol), _.ll(a))
        };
        _.U = function(a) {
            function b(c) {
                this.content = c
        ...
        ql = function(a) {
            return Tk(String(a), function() {
                return ""
            }).replace(pl, "&lt;")
        };
        Rk = RegExp.prototype.hasOwnProperty("sticky");
        Sk = new RegExp((Rk ? "" : "^") + "(?:!|/?([a-zA-Z][a-zA-Z0-9:-]*))", Rk ? "gy" : "g");
        _.W = function(a) {
            return _.ml(a, _.gl) ? _.rl(ql(a.Sa())) : String(a).replace(nl, ol)
        };
        _.ul = function(a) {
            return String(a).replace(_.sl, _.tl)
        };
        _.wl = function(a) {
            _.ml(a, _.hl) || _.ml(a, _.il) ? a = String(a).replace(_.sl, _.tl) : a instanceof _.wc ? a = _.ul(_.xc(a)) : "function" == typeof _.Kk && a instanceof _.Kk ? a = _.ul(_.Mk(a).toString()) : (a = String(a), a = vl.test(a) ? a.replace(_.sl, _.tl) : "about:invalid#zSoyz");
            return a
        };
        _.ml = function(a, b) {
            return a != null && a.Hc === b
        };
        xl = function() {
            jl.call(this)
        };
        ...
        _.Y = function(a, b) {
            a.g !== void 0 ? a.g.push(b) : b instanceof xl ? b.content !== void 0 ? a.content += b.Sa() : (a.g = [a.content, b], a.content = void 0) : a.content += b;
            return a
        };
        xl.prototype.Sa = function() {
            if (this.content !== void 0) return this.content;
            for (var a = "", b = _.u(this.g), c = b.next(); !c.done; c = b.next()) a += c.value;
            return a
        };
        ...
        nl = /[\x00\x22\x26\x27\x3c\x3e]/g;
        Al = /[\x00\x22\x27\x3c\x3e]/g;
        _.sl = /[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g;
        vl = /^[^&:\/?#]*(?:[\/?#]|$)|^https?:|^ftp:|^data:image\/[a-z0-9+-]+;base64,[a-z0-9+\/]+=*$|^blob:/i;
        _.rl = function(a) {
            return String(a).replace(Al, ol)
        };
        pl = /</g;
        _.Bl = "0".codePointAt(0);
        var Cl;
        _.Dl = Cl = Cl = Uk;
        var El;
        _.Fl = El = El = Vk;
    ...
    try {
        var Nl, Rl, Sl, Tl, Ul;
        _.Kl = function() {
            return ![_.Ia() && !_.bd() && !_.ad(), _.Ia() && _.Oa(), _.Fa()].some(function(a) {
                return a
            })
        };
        _.Ol = function(a, b, c) {
            ...
            if (b && _.O(b, 7) === 2) {
                ...
                _.Yk(a, Ll, d)
            } else b && _.O(b, 10) === 2 && !_.I("disable_personalized_button") ? (c = c === void 0 ? !0 : c, b && _.De(b, _.Fk, 8) ? (d = {}, b && (d = {
                shape: _.O(b, 3),
                text: _.O(b, 5),
                theme: _.O(b, 2),
                width: _.Bk(b, 4),
                we: _.Zk(_.M(b, _.Fk, 8)),
                xe: _.Bk(b, 9),
                Ra: c
        ...
        Tl = function(a) {
            return _.ml(a, Rl) ? Sl(a.Sa(), !1) : a == null ? "" : Sl(String(a), !0)
        };
        Ul = function() {
        ...
        _.l = _.Vl.prototype;
        _.l.sd = function() {
            return _.rb(_.L(this, 1))
        };
        _.l.ud = function() {
            return _.rb(_.L(this, 2))
        };
        _.l.rd = function() {
            return _.rb(_.L(this, 3))
        };
        _.l.wd = function() {
            return _.sb(_.L(this, 4))
        };
        _.l.td = function() {
            return _.rb(_.L(this, 5))
        };
        _.l.pd = function() {
            return _.rb(_.L(this, 6))
        };
        _.l.vd = function() {
            return _.rb(_.L(this, 7))
        };
        _.l.qd = function() {
            return _.sb(_.L(this, 9))
        };
        var $l = function(a, b, c, d, e, f, g, h) {
                var k = g === void 0 ? !0 : g;
                h = h === void 0 ? !1 : h;
                g = e && e !== 1 ? _.V(Wl(e)) : _.V(Wl(2));
                var n = _.Z();
                ...
                a = _.X(_.Y(_.X(n, k + _.W(m) + " " + _.W(Xl(c)) + " " + _.W(Yl(d)) + '"' + (f && !h ? ' style="width:' + _.W(Tl(f)) + 'px; max-width:400px; min-width:min-content;"' :
                    "") + '><div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-MJoBVe") + '"></div><div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") + " " + (a === 2 ? _.W("oXtfBe-l4eHX") : "") + '">'), Zl(c === 2 || c === 3)), (h ? "" : '<span class="' + _.W("nsm7Bb-HzV7m-LgbsSe-BPrWId") + '">' + _.V(Wl(e)) + "</span>") + '<span class="' + _.W("L6cTce") + '" id="button-label">' + g);
                _.Y(a, ". Opens in new tab");
                _.X(a, "</span></div></div>");
                return a
            },
            Xl = function(a) {
            ...
            Zl = function(a) {
                a = a === void 0 ?
                    !1 : a;
                return _.Y(_.Z(), a ? _.X(_.Y(_.X(_.Z(), '<div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-Bz112c-haAclf") + '"><div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">'), Ul()), "</div></div>") : _.X(_.Y(_.X(_.Z(), '<div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-Bz112c") + '">'), Ul()), "</div>"))
            };
        var Pl = function(a) {
                a = a || {};
                var b = a.Ra,
                ...
                a = a.width;
                b = b === void 0 ? !0 : b;
                return _.Y(_.Z(), $l(c, e, g, d, f, a, b))
            },
            Ll = function(a) {
                a = a || {};
                var b = a.Ra,
                ...
                a = a.theme;
                b = b === void 0 ? !0 : b;
                return _.Y(_.Z(), $l(void 0, d, a, c, e, void 0, b, !0))
            },
            Ml = function(a) {
                var b = a.Ra,
                    c = a.we,
                ...
                b = _.Z();
                h = h === void 0 ? !0 : h;
                e = _.X(_.Z(), "<div" + (h ? ' tabindex="0"' : "") + ' role="button" aria-labelledby="button-label" class="' +
                    _.W("nsm7Bb-HzV7m-LgbsSe") + " " + _.W("jVeSEe") + " " + _.W(Xl(g)) + " " + _.W(Yl(e)) + '" style="max-width:400px; min-width:200px;' + (a ? "width:" + _.W(Tl(a)) + "px;" : "") + '"><div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-MJoBVe") + '"></div><div class="' + _.W("nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb") + '">');
                a = c.givenName ? c.givenName : c.displayName;
                c.profilePicture ? (_.X(e, '<img class="' + _.W("n1UuX-DkfjY") + '" src="' + _.W(_.wl(c.profilePicture)) + '" alt="'), h = _.W(a ? a : c.id) + "'s profile image", _.Y(e, _.rl(h)), _.X(e, '">')) : _.Y(e, _.Jl());
                _.X(_.Y(_.X(_.Y(_.X(e,
                    ...
                    _.W("L6cTce") + '">' + _.V(am(f, a)) + ", " + _.V(c.id));
                _.Y(e, ". Opens in new tab");
                _.X(e, "</div></div>");
                return _.Y(b, e)
            };
    } catch (e) {
    ...
    try {
        var ug, vg, yg, Bg, Dg, Fg, Hg, Ig, Ng, Og, Pg, Rg, Ug, Yg, Zg, xg, wg, Eg, Cg, Tg, ah, Vg, eh, gh, fh, Mg, Lg, Jg, Kg;
        ug = function() {
            throw Error("r");
        };
        vg = function(a, b) {
            ...
            function c(k) {
                for (; d < a.length;) {
                    var n = a.charAt(d++),
                        m = wg[n];
                    if (m != null) return m;
                    if (!/^[\s\xa0]*$/.test(n)) throw Error("u`" + n);
                }
                return k
            }
            yg();
        ...
        Fg = function(a) {
            if (!_.le) return Bg(a);
            a = Eg.test(a) ? a.replace(Eg, Dg) : a;
            a = atob(a);
            for (var b = new Uint8Array(a.length), c = 0; c < a.length; c++) b[c] = a.charCodeAt(c);
            return b
        };
        Hg = function(a, b) {
            if (typeof a === "string") return new Gg(Fg(a), b);
            if (Array.isArray(a)) return new Gg(new Uint8Array(a), b);
            if (a.constructor === Uint8Array) return new Gg(a, !1);
            if (a.constructor === ArrayBuffer) return a = new Uint8Array(a), new Gg(a, !1);
            if (a.constructor === _.Kb) return b = a.h() || new Uint8Array(0), new Gg(b, !0, a);
            if (a instanceof Uint8Array) return a = a.constructor === Uint8Array ? a : new Uint8Array(a.buffer, a.byteOffset, a.byteLength), new Gg(a, !1);
            throw Error();
        };
        Ig = function(a, b, c, d) {
            var e = c.g;
            ...
            if (h) {
                ...
                if (n) {
                    e = function(x, A, C) {
                        if (C.length !== 0)
                            if (n[A])
                                for (x = _.u(C), A = x.next(); !A.done; A = x.next()) {
                                    A = Lg(A.value);
                                    try {
                                        k = !0, f(g, A)
                                    } finally {
                    ...
                    if (k) {
                        var p = a[_.z] | 0;
                        if (p & 2 && p & 2048 && (c == null || !c.ve)) throw Error();
                        var q = p & 128 ? _.qc : void 0,
                            r = function(x, A) {
                                if (_.ac(a, x, q) != null) switch (c == null ? void 0 : c.af) {
                                    case 1:
                                        return;
                                    default:
                                        throw Error();
                                }
                                A != null && (p = _.$b(a, p, x, A, q));
                                delete h[x]
                            };
                        b == null ? _.gb(g, g[_.z] | 0, function(x, A) {
                            r(x, A)
                        }) : r(b, _.ac(g, b, q))
                    }
                }
        ...
        Og = function(a, b, c, d, e) {
            var f = c.g,
                g, h;
            a[b] = function(k, n, m) {
                return f(k, n, m, h || (h = _.mc(Jg, Ig, Og, d).Xa), g || (g = Pg(d)), e)
            }
        };
        Pg = function(a) {
            var b = a[Kg];
            if (b != null) return b;
            var c = _.mc(Jg, Ig, Og, a);
            b = c.ad ? function(d, e) {
                return (0, _.jc)(d, e, c)
            } : function(d, e) {
                for (; Qg(e) && e.h != 4;) {
                    ...
                    if (g == null || !g(e, d, f)) {
                        ...
                        Sg(g);
                        var k = g;
                        if (k.Jb) var n = void 0;
                        else g = k.g.g - h, k.g.g = h, k = k.g, g == 0 ? g = Tg || (Tg = new _.Kb(null, Ug)) : (h = Vg(k, g), k.kb && k.l ? g = k.h.subarray(h, h + g) : (k = k.h, g = h + g, g = h === g ? new Uint8Array(0) : _.xe ? k.slice(h, g) : new Uint8Array(k.subarray(h, g))), g = g.length ==
                            0 ? Tg || (Tg = new _.Kb(null, Ug)) : new _.Kb(g, Ug)), n = g;
                        k = h = g = void 0;
                        var m = d;
                        n && ((g = (h = (k = m[_.zb]) != null ? k : m[_.zb] = new _.Fb)[f]) != null ? g : h[f] = []).push(n)
                    }
                }
                if (d = _.Ab(d)) d.cc = c.Gd[_.Ke];
                return !0
            };
            a[Kg] = b;
            a[_.Ke] = Ng.bind(a);
        ...
        _.Kb = function(a, b) {
            if (b !== Ug) throw Error("w");
            this.g = a;
            if (a != null && a.length === 0) throw Error("v");
        };
        _.Kb.prototype.i = function() {
            var a = this.g;
            if (a == null) a = "";
        ...
        _.Kb.prototype.tb = function() {
            return this.g == null
        };
        _.Kb.prototype.h = function() {
            if (Ug !== Ug) throw Error("w");
            var a = this.g;
            a = a == null || _.ke && a != null && a instanceof Uint8Array ? a : typeof a === "string" ? Fg(a) : null;
            return a == null ? a : this.g = a
        };
        _.Fb = function() {};
        _.Fb.prototype.qb = function(a) {
            for (var b in this) !isNaN(b) && a(this, +b, this[b])
        };
        ...
        var Gg = function(a, b, c) {
            ...
            bh = function(a) {
                for (var b = 0, c = a.g, d = c + 10, e = a.h; c < d;) {
                    var f = e[c++];
                    b |= f;
                    if ((f & 128) === 0) return ah(a, c), !!(b & 127)
                }
                throw Error();
            },
            ch = function(a, b, c, d) {
        ...
        ch.prototype.init = function(a, b, c, d) {
            ...
            this.kb = d;
            this.xb = e;
            a && (a = Hg(a, this.xb), this.h = a.buffer, this.l = a.g, this.j = b || 0, this.i = c !== void 0 ? this.j + c : this.h.length, this.g = this.j)
        };
        ...
        gh.prototype.l = function(a, b) {
            ...
            d = this.g.g + d;
            var e = d - c;
            e <= 0 && (this.g.i = d, b(a, this, void 0, void 0, void 0), e = d - this.g.g);
            if (e) throw Error();
            this.g.g = d;
            this.g.i = c
        };
        ...
        gh.prototype.o = function() {
            ...
            if (_.Ed) {
                var d = b,
                    e;
                (e = Zg) || (e = Zg = new TextDecoder("utf-8", {
                    fatal: !0
                }));
                b = c + a;
                ...
                try {
                    ...
                    if (Yg === void 0) {
                        ...
                        try {
                            e.decode(new Uint8Array([97])), Yg = !0
                        } catch (m) {
                            Yg = !1
                        }
                    }!Yg && (Zg = void 0);
                ...
                a = c + a;
                f = [];
                for (var g = null, h, k; c < a;) h = b[c++], h < 128 ? f.push(h) : h < 224 ? c >= a ? ug() : (k = b[c++], h < 194 || (k & 192) !== 128 ? (c--, ug()) : f.push((h & 31) <<
                    6 | k & 63)) : h < 240 ? c >= a - 1 ? ug() : (k = b[c++], (k & 192) !== 128 || h === 224 && k < 160 || h === 237 && k >= 160 || ((e = b[c++]) & 192) !== 128 ? (c--, ug()) : f.push((h & 15) << 12 | (k & 63) << 6 | e & 63)) : h <= 244 ? c >= a - 2 ? ug() : (k = b[c++], (k & 192) !== 128 || (h << 28) + (k - 144) >> 30 !== 0 || ((e = b[c++]) & 192) !== 128 || ((d = b[c++]) & 192) !== 128 ? (c--, ug()) : (h = (h & 7) << 18 | (k & 63) << 12 | (e & 63) << 6 | d & 63, h -= 65536, f.push((h >> 10 & 1023) + 55296, (h & 1023) + 56320))) : ug(), f.length >= 8192 && (g = vg(g, f), f.length = 0);
                f = vg(g, f)
            }
            return f
        };
        ...
        _.J(_.hh, _.D);
        _.ih = function() {};
        _.ih.prototype.J = function(a) {
            var b = this;
            this.S && window.setTimeout(function() {
                b.S && b.S(a)
            }, 100)
        };
        _.jh = function(a, b, c) {
    ...
    try {
        var Oq;
        _.Qq = function(a) {
            if (Oq && a.dataset) return a.dataset;
            var b = {};
            a = a.attributes;
            for (var c = 0; c < a.length; ++c) {
                var d = a[c];
                if (d.name.lastIndexOf("data-", 0) == 0) {
                    var e = _.Pq(d.name.slice(5));
                    b[e] = d.value
                }
            }
            return b
    ...
    try {
        var Vq, Xq, cr, Zq, gr, ir;
        _.Uq = function(a) {
            _.Sq(window.parent, a, _.Tq)
        };
        Vq = function() {
            this.g = void 0;
            this.O = {}
        ...
        _.br = function(a, b, c) {
            Wq ? _.G("A previous attempt has been made to verify the parent origin and is still being processed.") : _.Tq ? (_.E("Parent origin has already been verified."), b && b()) : Xq(a) ? (Yq = a, Zq(), a = _.$c(), _.Sq(window.parent, {
                command: "intermediate_iframe_ready",
                nonce: a
            }, "*"), Wq = a, $q = b, ar = c) : _.H("Invalid origin provided. Please provide a valid and secure (https) origin. If providing a list of origins, make sure all origins are valid and secure.")
        };
        Xq = function(a) {
            if (typeof a === "function") return !0;
            if (typeof a === "string") return cr(a);
            if (Array.isArray(a)) {
                for (var b = 0; b < a.length; b++)
                    if (typeof a[b] !== "string" || !cr(a[b])) return !1;
                return !0
            }
            return !1
        };
        cr = function(a) {
            try {
                ...
                if (!c.startsWith("*.")) return _.H("Invalid origin pattern. Valid patterns should start with '*.'"), !1;
                a = c;
                b = "Tb";
                if (dr.Tb && dr.hasOwnProperty(b)) var d = dr.Tb;
                else {
                    var e = new dr;
                    d = dr.Tb = e
                }
                ...
                if (c.indexOf("." + k) < 2) return _.H("Invalid origin pattern. Patterns cannot be composed of a wildcard and a top level domain."), !1
            } catch (n) {
                return !1
            }
            return !0
        ...
        var mr = function(a, b, c, d) {
            ...
            if (d && a.g !== void 0) throw Error("Oa`" + b);
            a.g = c
        };
        ...
        var nr = function(a, b) {
            ...
            for (var c in a.O) nr(a.O[c], b)
        };
        Vq.prototype.Ta = function(a) {
            var b = [];
            if (a) {
        ...
        var or = function(a, b, c) {
            a.g !== void 0 && c.push(b);
            for (var d in a.O) or(a.O[d], b + d, c)
        };
        ...
        Vq.prototype.remove = function(a) {
            for (var b = this, c = [], d = 0; d < a.length; d++) {
                var e = a.charAt(d);
                if (!b.O[e]) throw Error("Pa`" + a);
                c.push([b, e]);
                b = b.O[e]
            }
            a = b.g;
            for (delete b.g; c.length > 0;)
                if (d = c.pop(), b = d[0], d = d[1], b.O[d].tb()) delete b.O[d];
                else break;
            return a
        };
        Vq.prototype.tb = function() {
            var a;
        ...
        var dr = function() {
            ...
            qr = function(a, b, c) {
                ...
                a++;
                if (d == "?" || d == ",") return a;
                do a = qr(a, b, c), d = b.charAt(a); while (d != "?" && d != ",");
                return a + 1
            };
        var Yq, fr, Wq, $q, ar;
        _.K("google.accounts.id.intermediate.verifyParentOrigin", _.br);
        _.K("google.accounts.id.intermediate.notifyParentResize", _.jr);
        _.K("google.accounts.id.intermediate.notifyParentClose", _.kr);
        ...
        _.K("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.lr);
    } catch (e) {
        _._DumpException(e)
    }
    try {
        var rr = function(a) {
            ...
            sr = function(a) {
                var b = b === void 0 ? _.Qe : b;
                a: if (b = b === void 0 ? _.Qe : b, !(a instanceof _.wc)) {
                    for (var c = 0; c < b.length; ++c) {
                        var d = b[c];
                        if (d instanceof _.yc && d.Zd(a)) {
                            a = new _.wc(a);
                            break a
                        }
                    }
            ...
            ur = function(a, b) {
                if (_.Lk(b)) a.href = _.Mk(b).toString(), a.rel = "stylesheet";
                else {
                    if (tr.indexOf("stylesheet") === -1) throw Error("I`stylesheet");
                    b = _.Bc(b);
            ...
            vr = function(a) {
                if (_.Fc.includes(a)) {
                    var b =
                        parseInt(_.Gc.get("ge_" + a), 10);
                    if (b) return b
                }
                b = _.Ec;
                b.g[a] ? (a = b.g[a], a = typeof a === "number" ? a : 1) : a = 0;
                return a
            },
            wr = function() {
                var a = vr("enable_itp_optimization");
                switch (a === void 0 ? 0 : a) {
                    case 1:
                        return 1;
                    case 2:
            ...
            Br = function(a, b, c, d) {
                xr = a ? a + "/gsi/log" : "https://accounts.google.com/gsi/log";
                yr = b;
                zr = c;
                Ar = d || []
            },
            Dr = function(a, b) {
                if (!(_.Hf >= (b === void 0 ? 100 : b))) {
                    b = new _.Nc(xr);
                    a = _.ek({
                        client_id: yr,
                        as: zr,
                    ...
                    for (var c = _.u(Ar), d = c.next(); !d.done; d = c.next()) d = d.value, a.add(d.Nd, d.Od.toString());
                    _.Qc(b, a);
                    _.zk(b.toString(), void 0, "POST", void 0, void 0, xr !== "https://accounts.google.com/gsi/log")
                }
            },
            Gr = function(a) {
                var b = new(Function.prototype.bind.apply(Er, [null, "onetap", a, "prompt"].concat(_.rd(Fr.apply(1, arguments)))));
                Dr(b)
            },
            Hr = function() {
                var a = new(Function.prototype.bind.apply(Er, [null, "onetap", void 0, "closed"].concat(_.rd(Fr.apply(0, arguments)))));
                Dr(a)
            },
            Ir = function() {
                var a =
                    new(Function.prototype.bind.apply(Er, [null, "id", void 0, "init"].concat(_.rd(Fr.apply(0, arguments)))));
                Dr(a)
            },
            Jr = function() {
                var a = new(Function.prototype.bind.apply(Er, [null, "onetap", void 0, "policy"].concat(_.rd(Fr.apply(0, arguments)))));
                Dr(a)
            },
            Kr = function() {
                var a = new Uint8Array(32);
                (window.crypto || _.Zc.msCrypto).getRandomValues(a);
                return btoa(String.fromCharCode.apply(String, _.rd(a))).replace(/=+$/, "")
            },
            Lr = function() {
                var a = _.$c().toString(),
                    b = {
                    ...
                    c;
                if (c = _.Ia()) c = _.Yj(_.Mf, 80) >=
                    0;
                c && (b.dc = "none");
                c = _.df(location.origin);
                c.h === "http" && c.g === "localhost" && (b.ec = void 0, b.dc = void 0);
                _.Gc.set("g_csrf_token", a, b);
                return a
            },
            Mr = function(a, b) {
                _.zk(a, function(c) {
            ...
            Nr = function(a, b, c, d) {
                _.zk(a, function(e) {
                    d(_.uk(e.target))
                }, "POST", b ? _.ek(_.dk(b)).toString() : null, void 0, c)
            },
            Or = function(a, b, c) {
                Nr(a, b, !0, c)
            },
            ...
            Qr = function(a, b) {
                return function(c) {
                    c && c.credential ? Pr(a, b || {}, c.credential) :
                        _.F("No credential found in the response.")
                }
            },
            Sr = function(a) {
                var b = _.df(a);
                b.g || (_.Oc(b, location.protocol), b.g = location.hostname, _.Pc(b, location.port), Ir("relativeLoginUri", a), _.G("Relative login_uri was provided. Use absolute url instead. Relative login_uri may be considered invalid in the future."));
                if (b.h !== "https" && b.g !== "localhost") throw Ir("unsecuredLoginUri", a), new Rr("Unsecured login_uri provided.");
                return b.toString()
            },
            Tr = function(a) {
                try {
            ...
            Ur = function() {
                for (var a = _.u(document.getElementsByTagName("META")), b = a.next(); !b.done; b = a.next())
                    if (b = b.value, b.getAttribute("name") === "google-signin-client_id") return b.getAttribute("content");
                a = _.u(document.getElementsByTagName("IFRAME"));
                for (b = a.next(); !b.done; b = a.next())
                    if ((b = b.value.getAttribute("src")) && b.startsWith("https://accounts.google.com/o/oauth2/iframe")) return _.df(b).j.get("client_id") || null;
                return null
            },
            Vr = function(a) {
                if (!a) return null;
            ...
            Wr = function(a, b) {
                var c = [];
                c.push(_.wf(a, "click", b));
                c.push(_.wf(a, "keydown", function(d) {
                    var e = d.key;
                    e !== "Enter" && e !== " " || b(d)
                }))
            },
            Xr = function() {
                return !_.Sa() || _.Yj(_.Zj(), "118") >= 0 ? _.cd() && (_.Oa() || !_.bd() && !_.ad()) && _.Yj(_.Zj(), "108") >= 0 : !1
            },
            Yr = function() {
                try {
            ...
            Zr = function() {
                var a = document;
                return a.location.ancestorOrigins ? a.location.ancestorOrigins[a.location.ancestorOrigins.length -
                    1] : a.location.origin
            },
            $r = function() {
                var a = document;
                return a.location.ancestorOrigins ? a.location.protocol + "//" + a.location.host !== Zr() : !1
            },
            as = function(a) {
                a = Object.entries(a).filter(function(c) {
                    ...
                    else if (Array.isArray(d)) d = d.map(function(e) {
                        return '"' + e + '"'
                    }).join(" "), d = "(" + d + ")";
                    else {
                        if (d === null || d ===
                ...
                b || (b = document.createElement("meta"), b.httpEquiv = "Web-Identity-Authenticate", document.getElementsByTagName("head")[0].appendChild(b));
                b.content = a.join(", ")
            },
            bs = function(a, b, c) {
            ...
            cs = function(a, b, c) {
                ...
                if (a === "code") {
                    ...
                    if (c.claims !== void 0) var k = c.claims
                } else c.prompt === void 0 ? h = "select_account" : c.prompt && (h = c.prompt);
                a = c.redirect_uri;
                if (c.login_hint) var n = c.login_hint;
                ...
                if (c.trigger_onepick !== void 0) var x = c.trigger_onepick;
                if (c.allow_multiple !== void 0) var A = c.allow_multiple;
                if (c.file_ids !== void 0) var C = c.file_ids;
                if (c.mimetypes !== void 0) var oa =
                    c.mimetypes;
                c = [];
                bs(c, "gsiwebsdk", "3");
                bs(c, "client_id", d);
                ...
                bs(c, "access_type", g);
                bs(c, "hd", p);
                bs(c, "response_type", f);
                bs(c, "include_granted_scopes", q === !1 ? "false" : "true");
                bs(c, "enable_granular_consent", r === !1 ? "false" : "true");
                x !== void 0 && bs(c, "trigger_onepick", x === !1 ? "false" : "true");
                A !== void 0 && bs(c, "allow_multiple", A === !1 ? "false" : "true");
                bs(c, "file_ids", C);
                bs(c, "mimetypes", oa);
                k !== void 0 && bs(c, "claims", k);
                return b + "?" + c.join("&")
            },
            ds = function(a) {
            ...
            fs = function(a) {
                ...
                if (!(document.getElementById(b) && es.get(b) && es.get(b))) {
                    var c = new _.$h,
            ...
            is = function(a, b, c, d) {
                ...
                e.classList.add("L5Fo6c-PQbLGe");
                e.allow = "identity-credentials-get";
                e.id = c;
                _.I("enable_aria_hidden_in_button_iframe") && d && e.setAttribute("aria-hidden", "true");
                ...
                if (d) {
                    ...
                    d = _.rl("Sign in with Google. Opens in new tab");
                    d = (0, _.U)(c + d + '" role="button" tabindex="0"></div>');
                    a: if (c = _.$k || (_.$k = new _.fl), d && d.h ? c = d.h() : (c = _.We(c.g, "DIV"), d = _.Xk(d), c.innerHTML = _.Pk(d)), c.childNodes.length == 1 && (d = c.firstChild, d.nodeType == 1)) {
                        c = d;
                        break a
                    }
                    e.tabIndex = -1;
            ...
            ms = function(a) {
                ...
                b || (b = _.We(document, "div"), b.id = "g_a11y_announcement", document.body.appendChild(b));
                var c = _.We(document, "span");
                ls(c, a);
                c.role = "alert";
                _.cl(b);
                b.appendChild(c);
            ...
            os = function() {
                switch (vr("enable_itp_optimization")) {
                    case 5:
                    case 6:
                    case 7:
                        return 9E4;
            ...
            ys = function() {
                ...
                if (a) {
                    ...
                    a.auto_prompt && a.skip_prompt_cookie && _.Gc.get(a.skip_prompt_cookie) && (a.auto_prompt = !1);
                    delete a.skip_prompt_cookie;
                    var c = {};
                    for (d in b) b.hasOwnProperty(d) && ws.indexOf(d.toLowerCase()) < 0 && (c[d] = b[d]);
                    a.state && (c.state = a.state);
                    if (a.login_uri) {
                        a.login_uri = Sr(a.login_uri);
                        var d = Qr(a.login_uri, c);
                        a.redirect_callback = d;
                        a.callback || (a.callback = d)
                    } else a.ux_mode === "redirect" &&
                        _.H("Missing required login_uri parameter for the redirect flow.");
                    d = a.native_login_uri;
                    delete a.native_login_uri;
                    d && a.native_callback ? _.H("Cannot set both data-native_login_uri and data-native_callback.") : d && (a.native_callback = xs(d, c, a.native_id_param || "email", a.native_password_param || "password"));
                    return a
                }
            },
            xs = function(a, b, c, d) {
                return function(e) {
                    e && e.type === "password" ? (b[c] = e.id, b[d] = e.password, _.Kh(a, b)) : _.F("No password credential returned.")
                }
            },
            As = function(a) {
                a = _.Qq(a);
            ...
            function(a) {
                if (_.I("enable_default_callback") && a && a.login_uri) {
                    a.login_uri = Sr(a.login_uri);
                    var b = Qr(a.login_uri);
                    a.redirect_callback = a.redirect_callback || b;
                    a.callback = a.callback || b
                }
                a = new Bs(a);
                Cs.__G_ID_CLIENT__ = a;
                fs(a.de);
                Ds(a);
                _.Gc.get("g_state");
                Es(a.v);
                if (_.I("enable_fedcm_bluedog_poc")) {
                    b = a.m;
                    var c = b.client_id,
                        d = a.R,
                        e = b.context || "signin",
                        f = b.hosted_domain === "*" ? "any" : b.hosted_domain,
                        g = b.hint,
                        h = b.nonce,
                        k = JSON,
                        n = k.stringify,
                        m = {
                            as: b.as,
                            top_origin: $r() ? Zr() : void 0,
                            library_name: b.library_name ? b.library_name : void 0
                        };
                    _.I("enable_unicorn_in_fedcm_onetap") && (m.response_type = "id_token", m.ss_domain = b.origin || location.origin, m.scope = "email profile openid", m.nonce = b.nonce ? b.nonce : "not_provided", m.state = b.state);
                    m.claims = b.claims;
                    b = {
                        client_id: c,
                        config_url: d,
            ...
            Is = function(a, b, c) {
                if (a && b) {
                    var d = Cs.__G_ID_CLIENT__;
                    d ? Hs(d, a, b, c) : _.G("Failed to render button before calling initialize().")
                } else _.G("Failed to render button because there is no parent or options set.")
            },
            Ks = function() {
                var a = Cs.__G_ID_CLIENT__;
                a || (Fs(), a = Cs.__G_ID_CLIENT__);
                Js(a.g)
            },
            Ls = function() {
                var a = a === void 0 ? document.readyState : a;
                for (var b = _.al("g_id_signout"), c = 0; c < b.length; c++) _.wf(b[c], "click", Ks);
                try {
                    var d = ys();
                    if (d) {
                        var e = d.auto_prompt;
                        ...
                        Fs(d);
                        e && (a === "complete" ? Gs(f) : _.wf(window,
                            "load",
                            function() {
                                Gs(f)
                            }, !1))
                    }
                    var g = _.al("g_id_signin");
            ...
            Ns = function() {
                ...
                a === "complete" ? setTimeout(function() {
                    Ms()
                }, 0) : _.wf(window, "load", function() {
                    Ms()
                }, !1)
            },
            Os = function() {
                var a = Fr.apply(0, arguments),
                    b = [];
                if (a) {
                    a = _.u(a);
                    for (var c = a.next(); !c.done; c = a.next()) {
                        var d = (c = c.value) &&
                            c.trim();
                        !d && d.indexOf(" ") >= 0 ? (_.G("In hasGrantedAllScopes() method: invalid scope [" + c + "]. Scope should be a non-empty string without space."), c = null) : c = d;
                        if (c === null) return _.G("Invalid scope found."), null;
                        c && b.push(c)
                    }
                }
                return b
            ...
            Ps = function(a) {
                return (a = a && a.scope && a.scope.trim()) ? Os.apply(null, _.rd(a.split(" "))) : null
            },
            Qs = function(a) {
                _.kh(a, "prompt_closed", {
                    Te: !1
                })
            },
            Rs = function(a, b, c) {
                ...
                c !== void 0 && (b.Ze = c);
                _.kh(a, "prompt_resized", b)
            },
            Fr = function() {
                for (var a = Number(this), b = [], c = a; c < arguments.length; c++) b[c -
                    a] = arguments[c];
                return b
            },
            Ss = _.Wg(_.Wh, _.Vh),
        ...
        var tr = "alternate author bookmark canonical cite help icon license modulepreload next prefetch dns-prefetch prerender preconnect preload prev search subresource".split(" "),
            ls = function(a, b) {
                ...
                } else _.cl(a), a.appendChild((a.nodeType == 9 ? a : a.ownerDocument || a.document).createTextNode(String(b)))
            },
            Er = function(a, b, c) {
                var d = Fr.apply(3, arguments);
                this.j = a;
                this.i = b;
                this.g = c;
                this.h = d
        ...
        Er.prototype.toString = function() {
            ...
            this.h && a.push.apply(a, _.rd(this.h));
            return a.join(".")
        };
        var xr = "https://accounts.google.com/gsi/log",
            yr, zr, Cr, Ar = [],
            Vs = ["debug", "info", "warn"],
            Ws = {};
        var Xs = function(a) {
        ...
        var at = function() {
            ...
            ct = function(a, b, c) {
                ...
                navigator.credentials.get(bt(a, b, c)).then(function(d) {
            ...
            bt = function(a, b, c) {
                ...
                _.I("enable_unicorn_in_fedcm_onetap") &&
                ...
                d = {
                    ...
                    providers: [d],
                    mode: _.Ma() >= 131 ? c === "button" ? "active" : "passive" : c
                };
                var e = {
                    signal: a.h.signal,
                    federated: d,
        ...
        at.prototype.ga = function(a, b, c) {
            c ? (_.E("Processing FedCM response. callId " + this.g), c.login ? c.login({
                ...
                a.ma(b, d)
            }) : a.ga(b, c, a.Qa)) : (_.E("FedCM credential is null. callId " + this.g), a.ma(b, Error("W")))
        };
        var dt = function() {
                this.h = !1
            },
        ...
        var ht = {
            ...
            nt = function(a, b, c) {
                ...
                this.g = !1;
                a = new _.Vl;
                if (b && (b.logo_alignment && _.S(a, 6, ht[b.logo_alignment]), b.shape && _.S(a, 3, it[b.shape]), b.size && _.S(a, 1, jt[b.size]), b.text && _.S(a, 5, kt[b.text]), b.theme && _.S(a, 2, lt[b.theme]), b.type && _.S(a, 7, mt[b.type]), b.width))
                    if (typeof b.width ===
                        "number" && !isNaN(b.width)) _.Qh(a, 4, Number(b.width));
                    else if (typeof b.width === "string") try {
                    var d = b.width;
                    _.Qh(a, 4, Number(d.endsWith("px") ? d.slice(0, -2) : d))
                } catch (e) {
            ...
            ot = function(a) {
                if (!a.g) {
                    _.Ol(a.container, a.Ia);
                    var b = _.bl("nsm7Bb-HzV7m-LgbsSe", a.container);
                    b && a.h && Wr(b, function() {
                        a.h && a.h.call(a)
                    });
                    a.i = performance.now()
        ...
        nt.prototype.dispose = function() {
            if (!this.g) {
                var a = _.bl("nsm7Bb-HzV7m-LgbsSe", this.container);
                a && _.dl(a);
                this.g = !0;
        ...
        var qt = [0, 7200, 86400, 604800, 2419200],
            rt = ["enable_itp_optimization"],
            st = function(a, b, c) {
                this.i = a;
            ...
            ut = function(a) {
                ...
                a = b[a.g + "e"];
                a !== void 0 && (c.experiment_values = a);
                return c
            },
            vt = function(a, b) {
                var c = a.g + "p",
                ...
                b.browsing_session_id === void 0 ? delete p[n] : p[n] = b.browsing_session_id;
                b.experiment_values === void 0 ? delete p[m] : p[m] = b.experiment_values;
                b = JSON.stringify(p);
                c = _.Oa() && _.Ia() && _.Yj(_.Zj(), "67") >= 0;
                _.Gc.set(a.h, b, {
                    Wb: 15552E3,
                    path: "/",
                    domain: a.i || void 0,
            ...
            wt = function(a, b) {
                ...
                if (b) {
                    ...
                    b = (new Date).getTime() + 18E5;
                    var d;
                    c.disable_auto_prompt = Math.max((d = c.disable_auto_prompt) != null ? d : 0, b)
                } else c.prompt_suppress_level = Math.min(c.prompt_suppress_level + 1, 4), c.disable_auto_prompt = (new Date).getTime() + qt[c.prompt_suppress_level] * 1E3, Dr(new Er("onetap", void 0, "startCooldown", c.prompt_suppress_level.toString()));
                vt(a, c)
            },
            xt = function(a) {
                a = ut(a).disable_auto_prompt;
        ...
        var yt = function(a) {
                ...
                delete b.experiment_values;
                _.E("Reset browsing session id.");
                vt(a, b)
            },
            zt = function() {
                for (var a = {}, b = _.u(rt), c = b.next(); !c.done; c = b.next()) c = c.value, a[c] = vr(c);
                return a
            };
        var At = RegExp("^((?!\\s)[a-zA-Z0-9\u0080-\u3001\u3003-\uff0d\uff0f-\uff60\uff62-\uffffFF-]+[\\.\\uFF0E\\u3002\\uFF61])+(?!\\s)[a-zA-Z0-9\u0080-\u3001\u3003-\uff0d\uff0f-\uff60\uff62-\uffffFF-]{2,63}$");
        ...
        var Ft = function(a) {
                if (a instanceof Ct || a instanceof Dt || a instanceof Et) return a;
                if (typeof a.next == "function") return new Ct(function() {
                    return a
                });
                if (typeof a[Symbol.iterator] == "function") return new Ct(function() {
                    return a[Symbol.iterator]()
                });
                if (typeof a.Ha == "function") return new Ct(function() {
                    return a.Ha()
                });
                throw Error("Qa");
            },
        ...
        var Jt = new _.Ve("g_credential_picker"),
            Lt = function(a, b) {
                b = b === void 0 ? "i_" : b;
                var c = new ts;
                this.K = Ht(c) ? new us(c, "g_state_id_") : null;
                this.he = b;
        ...
        _.J(Lt, _.ih);
        var Kt = function(a, b) {
            var c = a.K ? a.K.get("ll") || void 0 : void 0;
            if (c) Mt(a, c);
            else {
                if (c = b.log_level !== void 0) c = b.log_level, c = c === void 0 || (0, _.Ta)(Vs, c) >= 0;
                c && Mt(a, b.log_level)
            }
            a.ce = b.button_url || "https://accounts.google.com/gsi/button";
            a.Mc = b.picker_url || "https://accounts.google.com/gsi/select";
            a.qe = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
            a.bd = b.status_url || "https://accounts.google.com/gsi/status";
            a.H = _.Lc(a.bd);
            a.de = b.container_css_url || "https://accounts.google.com/gsi/style";
            a.se =
                b.revoke_url || "https://accounts.google.com/gsi/revoke";
            a.hb = b.fedcm_url || "https://accounts.google.com/gsi/";
            a.R = b.fedcm_config_url || "https://accounts.google.com/gsi/fedcm.json";
            _.I("enable_fedcm_config_split") && (a.gb = b.fedcm_passive_config_url || "https://accounts.google.com/gsi/fedcm/config/passive.json", a.ee = b.fedcm_active_config_url || "https://accounts.google.com/gsi/fedcm/config/active.json");
            a.Fa = b.oauth2_auth_url || "https://accounts.google.com/o/oauth2/v2/auth";
            a.callback = b.callback;
            a.Oc = b.redirect_callback;
            a.W = b.ux_mode === "redirect" ? "redirect" : "popup";
            c = b.ui_mode;
            c !== void 0 && Object.values(Us).includes(c) || (c = a.container === document.body, c = _.bd() && !_.ad() || (c === void 0 || c) && Yr() && window.innerWidth < 420 ? "bottom_sheet" : "card");
            a.L = c;
            a.fb = b.color_scheme;
            ...
            a.ie = 9E4;
            a.eb = b.cancel_on_tap_outside !== !1;
            a.yc = b.itp_support !== !1;
            a.Ga = b.use_fedcm_for_prompt === void 0 ? void 0 : !!b.use_fedcm_for_prompt;
            a.te = b.use_fedcm_for_button === void 0 ? void 0 : !!b.use_fedcm_for_button;
            if (b.library_name && b.library_name.length > 100) throw Error("Sa");
            a.zc = b.library_name ? b.library_name : void 0;
            c = b.state_cookie_domain;
            !c || c != null && At.test(c) || (c = void 0);
            a.g = new st(c, a.he, b.state_cookie_name);
            c = a.g;
            var d = ut(c),
                e = Date.now();
            d.last_library_load_time && d.browsing_session_id ? e - d.last_library_load_time > 18E5 && (d.browsing_session_id = Kr(), d.experiment_values = zt(), _.E("Session expired. Setting new browsing session id.")) : (d.browsing_session_id =
                Kr(), d.experiment_values = zt(), _.E("Setting new browsing session id."));
            d.last_library_load_time = e;
            vt(c, d);
            if (_.I("enable_browsing_session_id") && (Cr = ut(a.g).browsing_session_id, c = ut(a.g).experiment_values))
                for (c = _.u(Object.entries(c)), d = c.next(); !d.done; d = c.next()) e = _.u(d.value), d = e.next().value, e = e.next().value, _.Te(d, e);
            Br(a.H, b.client_id, a.l, [{
                Nd: "enable_itp_optimization",
                Od: vr("enable_itp_optimization")
            }]);
            a.Lc(b);
            c = {};
            b.client_id !== void 0 && (c.client_id = b.client_id);
            b.origin !== void 0 && (c.origin =
                b.origin);
            ...
            c.ui_mode = a.L;
            a.fb !== void 0 && (c.color_scheme = a.fb);
            b.context !== void 0 && Object.values(Ts).includes(b.context) && (c.context = b.context);
            ...
            if (b.essential_claims !== void 0) {
                ...
                if (e) {
                    e = e.split(",");
                    for (var f = 0; f < e.length; f++) d[e[f].trim()] = {
                        essential: !0
                    }
                }
                b.id_token = d;
        ...
        Lt.prototype.Lc = function() {};
        Lt.prototype.Kc = function() {};
        var Ds = function(a) {
                a.Bc || (a.Bc = !0, _.wf(window, "message", function(b) {
                    Nt(a, b.g)
                }, !1))
            },
            Rt = function(a) {
                setTimeout(function() {
                    a.ka = _.wf(document, "click", function() {
                        if (a.eb && Ot(a, !1)) {
                            Pt(a, "tap_outside");
                            Qt(a);
                            _.I("enable_itp_optimization") && Hr("tappedOutside");
                            a: switch (vr("enable_itp_optimization")) {
                                case 12:
                                    var b = !0;
                                    break a;
                                default:
            ...
            Qt = function(a) {
                a.ka && (_.Ef(a.ka), a.ka = void 0)
            },
            St = function(a) {
                if (_.I("disable_fedcm") || !Xr() || !_.dd()) return !1;
                if (_.I("enable_account_labels") && !Ws.accountLabelsToken) {
                    var b =
                    ...
                    Ws.accountLabelsToken = !0
                }
                if (Zr() === "https://meet.google.com") return !1;
                if (_.I("enable_fedcm_global_experiment")) return _.E("In FedCM global experiment group"), !0;
                if (_.I("enable_fedcm_global_control")) return _.E("In FedCM global control group"), !1;
                if (a.m.auto_select && !(_.Ma() >= 121)) return !1;
                if (_.I("disable_fedcm_opt_out") && _.Ma() >= 142) return !0;
            ...
            Tt = function(a) {
                return Xr() && a.v.h ? _.I("enable_fedcm_button_global_control") ? (_.E("In FedCM button global control group"), !1) : _.I("enable_fedcm_button_global_experiment") ? (_.E("In FedCM button global experiment group"), !0) : !!a.te : !1
            };
        Lt.prototype.ga = function(a, b, c) {
            if (b) {
                _.E("Processing FedCM credential");
                var d = null;
                if (_.I("enable_unicorn_in_fedcm_onetap")) try {
                ...
                a === "widget" ? (this.callback ? this.callback.call(this, d) : _.E("No callback found for FedCM widget flow"), Vt(this, "credential_returned")) : (c && c.state && (d.state = c.state), this.W === "popup" ? this.callback ? this.callback.call(this, d) : _.E("No callback found for FedCM button popup flow") :
                    c && c.login_uri ? (a = {}, c && c.state && (a.state = c.state), Pr(c.login_uri, a, d.credential)) : this.Oc ? this.Oc.call(this, d) : _.E("No callback found for FedCM button redirect flow."));
                yt(this.g)
            } else _.E("FedCM credential is null")
        };
        Lt.prototype.ma = function(a, b) {
            _.H("FedCM get() rejects with " + b);
            a === "widget" && Pt(this, "unknown_reason")
        };
        var Wt = function(a) {
            a.I = !0;
            var b = {
            ...
            _.I("enable_unicorn_in_fedcm_onetap") && (b.response_type = "id_token", b.ss_domain = a.m.origin || location.origin, b.scope = "email profile openid", b.nonce = a.m.nonce ? a.m.nonce : "not_provided", b.state = a.m.state);
            a.m.claims && (b.claims = a.m.claims);
            ft(a.v, {
                Nc: a.hb,
                pb: _.I("enable_fedcm_config_split") ? a.gb : a.R,
                m: a.m,
                Ja: !!a.m.auto_select,
                ga: a.ga.bind(a),
                ma: function(c, d) {
                    ...
                    d.message.indexOf("identity-credentials-get") >= 0 && Jr("failedWithIframeGetPermission", "iframeOrigin=" + f, "path=" + document.location.pathname, "topOrigin=" + e);
                    d.message.indexOf("Content Security Policy") >= 0 && Jr("failedWithCsp", "iframeOrigin=" + f, "path=" + document.location.pathname, "topOrigin=" + e);
                    a.ma(c,
                        d)
                },
                oe: function() {
        ...
        Lt.prototype.ca = function(a, b, c) {
            var d = this;
            b = Object.assign({}, this.i, b);
            Kt(this, b);
            b = this.m.ui_mode === "bottom_sheet" ? "bottomSheet" : "card";
            _.I("enable_itp_optimization") && Gr(b, "apiCall");
            ...
            if (window.location.href.startsWith("chrome-extension://")) _.G("Attempted to start sign in flow inside chrome extension."),
                Gr(b, "chromeExtension");
                    ...
                    this.xc = !0), this.o = a, this.ib = c, this.m.client_id)
                if (_.I("unsupported_browser")) _.F("One Tap is not supported in this User Agent."), this.j("browser_not_supported"), _.lh(this, "prompt_display_failed", {
                    cause: "Unsupported user agent for one tap."
                }), Gr(b, "unsupportedBrowser");
                else if (xt(this.g)) _.F("User has closed One Tap before. Still in the cool down period."), this.j("suppressed_by_user"), _.lh(this, "prompt_display_failed", {
                cause: "Prompt disabled by the user."
            }), Gr(b, "cooldown", (ut(this.g).prompt_suppress_level ||
                0).toString());
            else if (St(this)) _.I("enable_fedcm_config_split") ? Xt(this, function(f) {
                f && _.pb(_.L(f, 9)) ? (_.E("All accounts are opted out."), d.j("opt_out_or_no_session"), _.lh(d, "prompt_display_failed", {
                ...
                var e = _.gk() && this.yc;
                this.m.is_itp = e;
                _.gk() && this.L === "bottom_sheet" && (this.m.prompt_ui = wr(), this.m.auto_dismiss_duration_ms = os());
                Xt(this, function(f) {
                    delete d.m.is_itp;
                    if (f)
                        if (_.De(f, _.hh, 2)) _.Xg(_.M(f, _.hh, 2)), f = _.M(f, _.hh, 2), f = _.O(f, 1),
                            d.j(f === 2 ? "opt_out_or_no_session" : f === 7 ? "secure_http_required" : f === 5 ? "unregistered_origin" : f === 3 || f === 4 ? "invalid_client" : f === 9 ? "browser_not_supported" : f === 12 ? "web_view_not_supported" : "unknown_reason"), _.lh(d, "prompt_display_failed", {
                                cause: "Error while checking for the credential status."
                            });
                        else if (_.pb(_.L(f, 3))) _.M(f, _.Ak, 1) && (d.m.as = _.Ql(_.M(f, _.Ak, 1)) || d.m.as), Yt(d), ps() || Zt(d), $t(d, !0), Rt(d);
                    else {
                        var g = _.I("enable_itp_flag_on_check_credential_status");
                        g = !g || g && _.pb(_.L(f, 4));
                        e && g ? (_.M(f, _.Ak,
                            1) && (d.m.as = _.Ql(_.M(f, _.Ak, 1)) || d.m.as), d.m.is_itp = !0, Yt(d), ps() || Zt(d), $t(d, !0), Rt(d), delete d.m.is_itp) : (_.E("No sessions found in the browser."), d.j("opt_out_or_no_session"), _.lh(d, "prompt_display_failed", {
                            cause: "No signed in Google accounts available."
                        }))
                    } else _.E("Invalid response from check credential status."), d.j("unknown_reason"), _.lh(d, "prompt_display_failed", {
                        cause: "A network error was encountered while checking for the credential status."
                    })
                })
            } else _.H("Missing required parameter: client_id."),
                this.j("missing_client_id"), _.lh(this, "prompt_display_failed", {
        ...
        var Hs = function(a, b, c, d) {
                ...
                delete g.hd;
                g.is_fedcm_supported = Xr() && a.v.h;
                if (_.I("enable_fedcm_button_global_control") || _.I("enable_fedcm_button_global_experiment")) g.fedcm_button_experiment_arm = _.I("enable_fedcm_button_global_experiment") ? 1 : 0;
                d = _.ek(g);
                d.set("client_id", a.i.client_id);
                d.set("iframe_id", e);
                d.set("cas", a.l);
                g.locale && (d.set("hl", g.locale), d.remove("locale"));
                _.tc !== "warn" && d.set("log_level", _.tc);
                _.Qc(f, d);
                g = _.Kl();
                f = is(h, f.toString(), e, g);
                c.Wa = f.Wa;
                g && f.jd && Wr(f.jd, function(k) {
                    k.preventDefault();
                    k.stopPropagation();
                    bu(a, e)
                })
                ...
                if (c && c.Sb) {
                    ...
                    requestAnimationFrame(function() {
                        requestAnimationFrame(function() {
                            ...
                            e && Dr(new Er("button", void 0, "rendered", "latency", Math.floor(d.i - e).toString(), Math.floor(d.j - e).toString(), Math.floor(d.startTime - e).toString()), 1)
                        })
                    })
                }
            },
            bu = function(a, b) {
                ...
                if (b) {
                    ...
                    d ? d.ya ? (d.ya(d.data), _.E("Custom handler called for button: " + b + ".")) : (b = {}, d.data.nonce && (b.nonce = d.data.nonce), d.data.state && (b.state = d.data.state), du(a, b, d.data ? d.data.sessionId : void 0), d.Ec && d.Ec(Object.assign({}, d.data))) : _.H("A button entry was not found for the given id.")
                }
            },
            du = function(a, b, c) {
                Ot(a, !0) && (Vt(a, "flow_restarted"), Hr("buttonFlowStarted"));
                ...
                }, _.I("enable_unicorn_in_fedcm_onetap") && (c.response_type =
                    "id_token", c.ss_domain = a.m.origin || location.origin, c.scope = "email profile openid", c.nonce = a.m.nonce ? a.m.nonce : "not_provided", c.state = a.m.state), gt(a.v, {
                    Nc: a.hb,
                    pb: _.I("enable_fedcm_config_split") ? a.ee : a.R,
                    m: a.m,
            ...
            eu = function(a, b) {
                ...
                if (_.I("enable_gis_oauth_button_flow_redirect")) {
                    ...
                    a.m.claims && (b.claims = a.m.claims);
                    var c = _.yk(new _.Wh, _.ck("btn"));
                    c = _.R(c,
                        4, a.m.g_csrf_token);
                    c = _.R(c, 5, a.m.as);
                    c = _.S(c, 7, 2);
                    c = _.R(c, 11, window.location.href);
                    _.I("enable_not_setting_client_id_in_transform_layer_payload") || _.xk(_.wk(_.R(c, 6, a.m.client_id), a.m.origin), a.m.login_uri);
                    a.m.state && _.R(c, 10, a.m.state);
                    a.m.library_name && (_.R(c, 12, a.m.library_name), b.library_name = a.m.library_name);
                    b.gis_params = _.zg(c.h(), 4);
                    _.Ch(sr(_.fk(a.Fa, b)))
                } else _.Ch(sr(_.fk(a.Mc, a.m)))
            },
            fu = function(a, b) {
                a.u = _.$c();
                a.m.as = b || a.l;
                a.m.channel_id = _.Jh(a.u);
                a.m.origin = a.m.origin || location.origin;
                if (_.I("enable_gis_oauth_button_flow_popup")) {
                    ...
                    _.I("enable_not_setting_client_id_in_transform_layer_payload") || _.xk(_.wk(_.R(c, 6, a.m.client_id), a.m.origin), b.redirect_uri);
                    a.m.state && _.R(c, 10, a.m.state);
                    a.m.library_name && (_.R(c, 12, a.m.library_name), b.library_name = a.m.library_name);
                    b.gis_params = _.zg(c.h(), 4);
                    c = a.m.client_id;
                    var d = a.m.channel_id,
                        ...
                        f = a.m.g_csrf_token,
                        g = a.m.as;
                    var h = rr(b.gis_params);
                    try {
                        var k = Ss(h);
                        var n = k ? _.Fe(k, 1) === (e ? e : "") && _.Xh(k) ===
                            (f ? f : "") && _.Fe(k, 5) === (g ? g : "") && _.Fe(k, 6) === (c ? c : "") && _.Ph(k, 7) === 1 && _.Fe(k, 8) === (d ? d : "") : !1
                    } catch (m) {
                        _.G("validateTransformLayerPayload failed"), n = !1
                    }
                    n || Dr(new Er("button", "popup", "clicked", "base64_gis_params_validation_failed", "origin=" + a.m.origin, "clientId=" + a.m.client_id, "gisParams=" + b.gis_params));
                    if (_.od(_.fk(a.Fa, b), Jt, _.md())) return;
                    Dr(new Er("button", "popup", "clicked", "oauthPopupNotOpened"))
                }
                _.od(_.fk(a.Mc, a.m), Jt, _.md()) || Dr(new Er("button", "popup", "clicked", "popupNotOpened"))
            },
            Ot = function(a,
                b) {
                if (a.I) return b = a.v, _.E("Aborting current FedCM flow."), b.g ? (b = b.g, _.E("Aborting FedCM flow. callId " + b.g), b.h ? (b.h.abort(), _.E("FedCM flow aborted. callId " + b.g), b.h = void 0, b = !0) : (_.E("No FedCM flow to abort. callId " + b.g), b = !1)) : (_.E("No FedCM flow to abort."), b = !1), b ? (Qt(a), !0) : !1;
                if (ns(a.container)) var c = !a.D;
                else c = a.container, c = !(document.getElementById("credential_picker_iframe") || c && document.getElementById("credential_picker_container"));
                if (c) return !1;
                if (!b && a.C) return _.F("Cancel prompt request ignored. The prompt is in a protected state."), !1;
                ns(a.container) ? ((b = a.D) && b.parentElement ? (b.parentElement.id === "credential_picker_container" && b.parentElement.parentElement ? b.parentElement.parentElement.removeChild(b.parentElement) : b.parentElement.removeChild(b), b = !0) : b = !1, b = !b) : b = !gs(a.container);
                if (b) return _.F("Failed to remove prompt iframe."), !1;
                Qs(a);
                a.C = !0;
                a.D = void 0;
                Qt(a);
        ...
        var $t = function(a, b, c) {
            ...
            Xt = function(a, b) {
                ...
                a.m.as && (c.cas = a.m.as);
                a.m.bs && (c.bs = a.m.bs);
                a.Ga !== void 0 && (c.has_opted_out_fedcm = !a.Ga);
                a.m.is_itp !== void 0 && (c.is_itp = a.m.is_itp);
                a.m.prompt_ui !== void 0 && (c.prompt_ui = a.m.prompt_ui);
                c = _.fk(a.bd, c);
                Mr(c, function(d) {
                    d && d !== "null" ? (d = Ys(JSON.stringify(_.Wj(d))), b(d)) : (_.H("Check credential status returns invalid response."), a.j("unknown_reason"), _.lh(a, "network", {
            ...
            Yt = function(a) {
                ...
                if (c = a.m.auto_select) {
                    c = a.g;
                    var d = ut(c);
                    d.disable_auto_select_to && Date.now() >=
                        d.disable_auto_select_to && (c.Ja(), d = ut(c));
                    c = !(d.disable_auto_select_to && Date.now() < d.disable_auto_select_to)
                }
                b.auto_select = c;
                _.gk() && a.L === "bottom_sheet" && (a.m.prompt_ui = wr(), a.m.auto_dismiss_duration_ms = os());
                a.u = _.$c();
                a.m.channel_id = _.Jh(a.u);
                a.m.origin = a.m.origin || location.origin;
                a.m.oauth2_auth_url = a.Fa;
                a.zc && (a.m.library_name = a.zc);
                b = _.fk(a.qe, a.m);
                a.C = !0;
                a.Wc(b);
                _.kh(a, "prompt_displayed")
            };
        Lt.prototype.Wc = function(a) {
            this.D = hs(this.container, a, this.L === "bottom_sheet")
        };
        var Zt = function(a) {
                a.L === "bottom_sheet" && window.setTimeout(function() {
                    Ot(a, !1) && (Pt(a, "auto_cancel"), _.I("enable_itp_optimization") && Hr("autoDismissed"))
                }, a.ie)
            },
            Nt = function(a, b) {
                if (b.origin === a.H && b.data && b.data.type === "readyForConnect")
                    if (_.E("Setup message received: " + JSON.stringify(b.data)), b.source) {
                            ...
                            if (c = a.B.get(c)) {
                                ...
                                c.port1.onmessage = function(e) {
                                    if (e.data && e.data.type) {
                                        _.E("Message received in button channel: " +
                                            JSON.stringify(e.data));
                                        var f = e.data.type;
                                        if (f !== "command") _.G("Unknown event type (" + f + ") received in the button channel.");
                                            ...
                                            case "resize":
                                                ...
                                                if (f) {
                                                    ...
                                                    if (g && g.Wa && js(h) && js(k)) {
                                                        ...
                                                        typeof g !== "number" || isNaN(g) || typeof e !== "number" || isNaN(e) || (n.style.marginTop = g + "px", n.style.marginBottom = g + "px", n.style.marginLeft = e + "px", n.style.marginRight = e + "px", cu(a, f));
                                                        Rs(a, k, h)
                                                    } else n ? _.G("Unable to resize iframe. Invalid dimensions.") : _.G("Unable to resize iframe. No iframe found with id: " + (f + "."))
                                                }
                                                break;
                                            default:
                                ...
                                try {
                                    ...
                                    _.H("Failed to send postmessage to button iframe: " +
                                        e.message)
                                }
                            }
                        } else if (b.data.channelId && a.u && (a.u && _.Jh(a.u)) === b.data.channelId) {
                            c = new MessageChannel;
                            c.port1.onmessage = function(e) {
                                a.ra(e)
                            };
                    ...
                    } else _.E("Source invalid. Iframe was closed during setup.")
            };
        Lt.prototype.ra = function(a) {
            if (a.data && a.data.type) switch (_.E("Message received: " + JSON.stringify(a.data)), a.data.type) {
                case "response":
                    var b = Ot(this, !0),
                        c = a.data.response,
                        d = c && c.credential;
                    if (d) {
                        ...
                        f.prompt_suppress_level && Dr(new Er("onetap", void 0, "resetCooldown", f.prompt_suppress_level.toString()));
                        f.prompt_suppress_level = 0;
                        vt(e, f);
                        e.Ja();
                        yt(e);
                        this.callback && (this.callback.call(this, c), _.E("Response received: " + JSON.stringify(c)));
                        c = this.m.client_id;
                        e = Ur();
                        if (c && e) {
                            f = Vr(c);
                    ...
                    b && (d ? Vt(this, "credential_returned") : (Pt(this, "issuing_failed"), Hr("issuingFailed")), Qs(this));
                    Ut(a);
                    break;
                case "activity":
                    a.data.activity && this.J(a.data.activity);
                    break;
                case "command":
                    if (b = a.data.command) switch (b) {
                        case "close":
                            a.data.suppress && wt(this.g);
                            Ot(this, !0) && (Pt(this, "user_cancel"),
                                Qs(this), _.I("enable_itp_optimization") && Hr("userCancelled"));
                            break;
                        case "auto_dismiss":
                            a: switch (vr("enable_itp_optimization")) {
                                case 7:
                            ...
                            a && wt(this.g, !0);
                            Ot(this, !0) && (Pt(this, "auto_cancel"), Qs(this), _.I("enable_itp_optimization") && Hr("autoDismissed"));
                            break;
                        case "resize":
                            a = a.data.height;
                            if (js(a)) {
                                if (this.container !== document.body && ns(this.container))(b = this.D) ? (d = b.clientHeight, b.parentElement && b.parentElement !== document.body && (b.parentElement.style.height =
                                    a + "px"), b.style.border = "none", b.style.height = a + "px", b.style.display = "", b = d) : b = void 0;
                                else a: {
                        ...
                        case "start_auto_select":
                            gu(this, "auto_select_started");
                            break;
                        case "cancel_auto_select":
                            Js(this.g), gu(this, "auto_select_canceled")
                    }
            }
        };
        var Ut = function(a) {
            a.data.announcement && ms(a.data.announcement)
        };
        Lt.prototype.revoke = function(a, b) {
            var c = {
                    successful: !1
                },
                d = this.m.client_id;
            d ? "IdentityCredential" in window && _.Ma() >= 123 ? (a = {
                configURL: _.I("enable_fedcm_config_split") ? this.gb : this.R,
                clientId: d,
                accountHint: a
                ...
                this.l && (a.as = this.l), Or(this.se, a, function(e) {
                    if (e && e !== "null") {
                        if (e = $s(JSON.stringify(_.Wj(e))), c.successful = !!_.vk(e, 3), _.F("Revoke XHR status: " + !!c.successful), !c.successful)
                            if (_.De(e, _.hh, 2)) {
                                e = _.M(e, _.hh, 2);
                                _.Xg(e);
                                switch (_.O(e, 1)) {
                    ...
                    } else _.H("Invalid response is returned for revoke request."), c.error = "invalid_response";
                    b && b(c)
                })) : (_.H("Failed to revoke. Missing config parameter client_id."), b && (c.error = "missing_client_id", b(c)))
        };
        var Mt = function(a, b, c) {
            (c === void 0 ? 0 : c) && a.K && (b ? a.K.set("ll", b) : a.K.remove("ll"));
            _.bk(b)
        };
        var vs = {
                client_id: "str",
        ...
        var Bs = function(a) {
            ...
            if (this.h && this.h)
                if (typeof this.h === "string") {
                    if (!Tr(this.h)) throw Error("Ta");
                } else if (Array.isArray(this.h))
                for (a = 0; a < this.h.length; a++)
                    if (typeof this.h[a] !== "string" || !Tr(this.h[a])) throw Error("Ua");
        };
        _.J(Bs, Lt);
        Bs.prototype.Lc = function(a) {
            this.V = a.native_callback
        };
        Bs.prototype.j = function(a) {
            _.E("Prompt will not be displayed");
            this.V && hu(this);
            Lt.prototype.j.call(this, a)
        };
        var hu = function(a) {
            a.Dc || (a.Dc = !0, "credentials" in navigator && navigator.credentials.get({
                password: !0,
                mediation: "required"
            }).then(function(b) {
                a.V && a.V(b)
        ...
        Bs.prototype.ca = function(a, b, c) {
            var d = this;
            this.Z && this.h ? (_.E("Verifying parent origin."), _.br(this.h, function() {
                _.Tq ? _.Uq({
                    command: "set_ui_mode",
                    mode: d.L
                ...
                _.lr(!1);
                d.Vc = !1;
                Lt.prototype.ca.call(d, a, b, c)
            })) : Lt.prototype.ca.call(this, a, b, c)
        };
        Bs.prototype.ra = function(a) {
            Lt.prototype.ra.call(this, a);
            if (this.Z && a.data && a.data.type) switch (a.data.type) {
                case "response":
                    a.data.response && a.data.response.credential && (this.Vc = !0, _.jr(0));
                    break;
                case "command":
                    switch (a.data.command) {
                        case "close":
                            this.Vc ? _.jr(0) : this.wc ? (_.jr(0), this.wc()) : _.kr();
                            break;
                        case "resize":
                            a = a.data.height;
                            typeof a === "number" && !isNaN(a) && a > 0 && _.jr(a);
                            break;
                        case "cancel_protect_start":
                            _.lr(!1);
                            break;
        ...
        Bs.prototype.Wc = function(a) {
            this.D = hs(this.container, a, this.L === "bottom_sheet", this.Z)
        };
        Bs.prototype.Kc = function(a) {
            if (this.Z) switch (_.hr) {
        ...
        (function(a) {
            ...
            a !== "loading" ? (Ls(), Ns()) : _.wf(document, "DOMContentLoaded", function() {
                Ls();
                Ns()
            }, !1)
        })();
        _.K("google.accounts.id.cancel", function() {
            var a = Cs.__G_ID_CLIENT__;
            a && Ot(a, !0) && (Vt(a, "cancel_called"), _.I("enable_itp_optimization") && Hr("flowCancelled"))
        });
        _.K("google.accounts.id.disableAutoSelect", Ks);
        _.K("google.accounts.id.initialize", Fs);
        _.K("google.accounts.id.prompt", Gs);
        _.K("google.accounts.id.PromptMomentNotification", pt);
        _.K("google.accounts.id.renderButton", Is);
        _.K("google.accounts.id.revoke", function(a, b) {
            var c = Cs.__G_ID_CLIENT__;
        ...
        _.K("google.accounts.id.setLogLevel", function(a) {
            var b = Cs.__G_ID_CLIENT__;
            b || (Fs(), b = Cs.__G_ID_CLIENT__);
            a = a ? a.toLowerCase() : void 0;
            a === void 0 || (0, _.Ta)(Vs, a) >= 0 ? Mt(b, a, !0) : (_.H("Log level is invalid. Supported log levels are: info, warn, error. Log level set to warn by default"), Mt(b, void 0, !0))
        });
        var iu = new _.Ve("g_auth_code_window"),
            ju = function(a) {
                _.Rf.call(this, "code", a);
                this.callback = a.callback;
                this.W = _.ed(a);
                _.F("Instantiated.", "CODE_CLIENT")
            };
        _.J(ju, _.Rf);
        ju.prototype.i = function(a) {
            _.F("Handling response. " + JSON.stringify(a), "CODE_CLIENT");
            _.Rf.prototype.i.call(this, a);
            this.callback && this.callback.call(this, a)
        };
        ju.prototype.requestCode = function() {
            var a = this.u;
            this.W === "redirect" ? (_.F("Starting redirect flow.", "CODE_CLIENT"), a = cs(this.j, this.l, a), _.Cc(a)) : (_.F("Starting popup flow.", "CODE_CLIENT"), _.Sf(this), _.Tf(this, a), this.g = _.od(cs(this.j, this.l, a), iu, _.md()), !this.g && this.error_callback ? this.error_callback(new _.fd("Failed to open popup window", "popup_failed_to_open")) : _.Uf(this))
        };
        var ku = new _.Ve("g_auth_token_window"),
            lu = window,
            mu = function(a) {
                _.Rf.call(this, "token", a);
                this.callback = a.callback;
        ...
        mu.prototype.i = function(a) {
            ...
            if (a.access_token)
                if (lu.gapi && lu.gapi.client && lu.gapi.client.setToken) try {
                    lu.gapi.client.setToken.call(this, a)
                } catch (b) {
                    _.H("Set token failed. Exception encountered.", "TOKEN_CLIENT"), console.Nb(b)
                } else _.F("The OAuth token was not passed to gapi.client, since the gapi.client library is not loaded in your page.", "TOKEN_CLIENT");
                else _.G("Set token failed. No access token in response.", "TOKEN_CLIENT");
            this.callback && this.callback.call(this, a)
        };
        mu.prototype.requestAccessToken = function(a) {
            var b = this.u;
            a = a || {};
            ...
            _.Sf(this);
            _.Tf(this, b);
            this.g = _.od(cs(this.j, this.l, b), ku, _.md());
            !this.g && this.error_callback ? this.error_callback(new _.fd("Failed to open popup window", "popup_failed_to_open")) : _.Uf(this)
        };
        _.K("google.accounts.oauth2.GoogleIdentityServicesError", _.fd);
        _.K("google.accounts.oauth2.GoogleIdentityServicesErrorType", {
            Qe: "unknown",
            Le: "missing_required_parameter",
            Ne: "popup_failed_to_open",
            Me: "popup_closed"
        });
        _.K("google.accounts.oauth2.initCodeClient", function(a) {
            return new ju(a)
        });
        _.K("google.accounts.oauth2.CodeClient", ju);
        _.K("google.accounts.oauth2.initTokenClient", function(a) {
            return new mu(a)
        });
        _.K("google.accounts.oauth2.TokenClient", mu);
        _.K("google.accounts.oauth2.hasGrantedAllScopes", function(a) {
            var b = Fr.apply(1, arguments),
                c = Ps(a);
            return c && c.length ? (b = Os.apply(null, _.rd(b))) && b.length ? (0, _.Sd)(b, function(d) {
                return (0, _.Ta)(c, d) >= 0
            }) : !1 : !1
        });
        _.K("google.accounts.oauth2.hasGrantedAnyScope", function(a) {
            var b = Fr.apply(1, arguments),
                c = Ps(a);
            return c && c.length ? (b = Os.apply(null, _.rd(b))) && b.length ? (0, _.Rd)(b, function(d) {
                return (0, _.Ta)(c, d) >= 0
            }) : !1 : !1
        });
        _.K("google.accounts.oauth2.revoke", function(a, b) {
            ...
            Nr("https://oauth2.googleapis.com/revoke", a, !1, function(c) {
                b && (_.F("callback with response: " + c), c = c ? JSON.parse(c) : {}, c.successful = !c.error, b(c))
            })
        });
    } catch (e) {
        _._DumpException(e)
